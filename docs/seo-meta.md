...
| `/chi-siamo/` | брендовая — фокус-ключ не задавать, оценку RM игнорировать | — | — |
| `/casi-studio/` · `/en/case-studies/` | portfolio siti web | web design portfolio | ✅ (H1, intro, alt, chip-фильтр) — см. «Casi studio» ниже |
...
## Casi studio — IT/EN (docs/copy-casi-studio.md §1.2–1.3)

### `/casi-studio/`

- **Focus Keyword:** `portfolio siti web`
- **Title:** `Portfolio e casi studio — progetti del gruppo | Remarka`
- **Description:** `I progetti che il gruppo Remarka ha costruito per sé: siti, web app, SEO e localizzazione in più lingue. Ogni caso con link al progetto vivo, dal 2001.`
...
## Blog · Batch 2 — IT/EN (5 статей: деньги и решения владельца)

> 5 статей блога с фирменными SVG (`assets/img/blog/`). Опубликованы в IT + EN
> (RU-блог — отдельный батч, не перевод, см. `piano-blog.md`). Фокус-ключ у
> каждой статьи в лиде, одном H2 и одном alt. Слаги — `build-tools/lang.py`
> (`BLOG_SLUGS`, `BLOG_IT_EN_ONLY`).

| Страница IT · EN | Focus Keyword IT | Focus Keyword EN |
|---|---|---|
| `/blog/preventivo-sito-web-come-leggerlo/` · `/en/blog/website-quote-how-to-read-it/` | preventivo sito web | website quote |
| `/blog/sito-web-in-3-settimane/` · `/en/blog/website-in-3-weeks/` | sito web in 3 settimane | website in 3 weeks |
| `/blog/restyling-o-sito-nuovo-5-domande/` · `/en/blog/redesign-or-new-website-5-questions/` | restyling sito web | website redesign |
| `/blog/impatto-ambientale-sito-web/` · `/en/blog/website-environmental-impact/` | impatto ambientale sito web | website environmental impact |
| `/blog/dichiarazione-di-accessibilita-guida-2026/` · `/en/blog/accessibility-statement-guide-2026/` | dichiarazione di accessibilità | accessibility statement |

### 6 — Preventivo sito web

- **IT Title:** `Preventivo sito web: leggerlo senza sorprese | Remarka`
- **IT Description:** `Preventivo sito web: come leggerlo riga per riga, le voci che spostano il prezzo, prezzo chiuso o indicativo e le 5 domande da fare prima di firmare.`
- **EN Title:** `Website quote: how to read it without surprises | Remarka`
- **EN Description:** `How to read a website quote line by line: the items that move the price, fixed vs indicative pricing, and the five questions to ask before signing.`

### 7 — Sito web in 3 settimane

- **IT Title:** `Sito web in 3 settimane: com’è possibile | Remarka`
- **IT Description:** `Sito web in 3 settimane, davvero: il metodo che toglie i tempi morti, cosa succede in ogni settimana e la penale dell’1% al giorno se sforiamo.`
- **EN Title:** `A website in 3 weeks: how it’s possible | Remarka`
- **EN Description:** `A website in 3 weeks for real: the method that removes dead time, what happens each week, and the 1%-a-day penalty if we overrun. No shortcuts.`

### 8 — Restyling o sito nuovo

- **IT Title:** `Restyling o sito nuovo? Il test delle 5 domande | Remarka`
- **IT Description:** `Restyling sito web o rifacimento? Cinque domande per decidere con i numeri se al vostro sito basta un restyling o serve ripartire da zero.`
- **EN Title:** `Redesign or new website? The 5-question test | Remarka`
- **EN Description:** `Website redesign or a full rebuild? Five questions to decide with numbers whether your site needs a redesign or a fresh start, without losing Google.`

### 9 — Impatto ambientale del sito

- **IT Title:** `Impatto ambientale del sito web: quanto pesa | Remarka`
- **IT Description:** `Impatto ambientale di un sito web: come si stimano i grammi di CO₂ per visita, perché leggero è veloce ed economico e cosa c’entra la CSRD.`
- **EN Title:** `Website environmental impact: how much it weighs | Remarka`
- **EN Description:** `A website’s environmental impact: how CO₂ per visit is estimated, why light means fast and cheap, and what the CSRD has to do with it.`

### 10 — Dichiarazione di accessibilità

- **IT Title:** `Dichiarazione di accessibilità: guida 2026 | Remarka`
- **IT Description:** `Dichiarazione di accessibilità: cos’è, perché è obbligatoria con l’EAA, cosa deve contenere e gli errori da evitare. Guida pratica 2026.`
- **EN Title:** `Accessibility statement: a practical 2026 guide | Remarka`
- **EN Description:** `Accessibility statement: what it is, why the EAA makes it mandatory, what it must contain and the mistakes to avoid. A practical 2026 guide.`

**Проверка длин.** Title (IT/EN): 54/57 · 50/49 · 57/54 · 54/58 · 52/57 — все ≤60.
Description (IT/EN): 149/147 · 143/143 · 138/149 · 139/134 · 136/140 — все ≤160.

---

## Blog · Batch 3 — IT/EN (5 статей: технологии, которые продают)
...
| Страница IT · EN | Focus Keyword IT | Focus Keyword EN |
|---|---|---|
| `/blog/telegram-mini-app-business/` · `/en/blog/telegram-mini-app-for-business/` | telegram mini app business | telegram mini app business |
| `/blog/gestionale-su-misura-vs-excel/` · `/en/blog/custom-management-software-vs-excel/` | gestionale su misura | custom management software |
| `/blog/dati-strutturati-schema-org/` · `/en/blog/schema-org-structured-data-for-smes/` | dati strutturati schema.org | schema.org structured data |
| `/blog/gamification-b2b/` · `/en/blog/gamification-in-b2b/` | gamification marketing b2b | gamification b2b marketing |
| `/blog/hosting-sito-web-italia/` · `/en/blog/website-hosting-italy-vs-cloud/` | hosting sito web italia | website hosting italy |

### 11 — Telegram Mini App

- **IT Title:** `Telegram Mini App per il business | Remarka`
- **IT Description:** `Cos’è una Telegram Mini App per il business, quando conviene e perché in Italia è un canale ancora quasi vuoto. Con un caso reale e i numeri.`
- **EN Title:** `Telegram Mini Apps for business | Remarka`
- **EN Description:** `What a Telegram Mini App for business is, when it pays off and why in Italy it’s still an almost empty channel. With a real case and numbers.`

### 12 — Gestionale su misura vs Excel

- **IT Title:** `Gestionale su misura vs Excel: il salto | Remarka`
- **IT Description:** `Gestionale su misura o Excel? Quando conviene il salto: i costi nascosti dei fogli, i sintomi da guardare e un caso reale con i numeri.`
- **EN Title:** `Custom management software vs Excel | Remarka`
- **EN Description:** `Custom software or Excel? When the leap pays off: the hidden costs of spreadsheets, the symptoms to watch and a real case with numbers.`

### 13 — Schema.org / dati strutturati

- **IT Title:** `Schema.org per le PMI: i dati strutturati | Remarka`
- **IT Description:** `Dati strutturati schema.org: cosa sono, come funziona il JSON-LD e quali risultati ricchi su Google potete ottenere. Guida per le PMI.`
- **EN Title:** `Schema.org for SMEs: structured data | Remarka`
- **EN Description:** `Schema.org structured data: what it is, how JSON-LD works and which rich results on Google you can earn. A practical guide for SMEs.`

### 14 — Gamification B2B

- **IT Title:** `Gamification nel B2B: quando un gioco vende | Remarka`
- **IT Description:** `Gamification e marketing B2B: quando un gioco vende servizi seri, come funziona e quando è solo un costo. Con un caso reale e i numeri.`
- **EN Title:** `Gamification in B2B: when a game sells | Remarka`
- **EN Description:** `Gamification and B2B marketing: when a game sells serious services, how it works and when it’s just a cost. With a real case and numbers.`

### 15 — Hosting Italia o cloud

- **IT Title:** `Hosting sito web in Italia o in cloud | Remarka`
- **IT Description:** `Hosting di un sito web in Italia o in cloud: cosa cambia per velocità e GDPR e come scegliere tra Italia, UE ed extra-UE. Guida pratica.`
- **EN Title:** `Website hosting in Italy or the cloud | Remarka`
- **EN Description:** `Website hosting in Italy or the cloud: what changes for speed and GDPR, and how to choose between Italy, the EU and beyond. A guide.`

**Проверка длин.** Title (IT/EN): 43/41 · 49/45 · 51/46 · 53/48 · 47/47 — все ≤60.
Description (IT/EN): 141/141 · 135/135 · 134/132 · 135/137 · 136/132 — все ≤160.
...
| `/ru/kejsy/` | портфолио веб-студии | ✅ (H1, hero-sub, нарратив) — см. «Кейсы» ниже |
...
### `/ru/kejsy/` (docs/copy-casi-studio.md §1.4/§4)

- **Focus Keyword:** `портфолио веб-студии`
- **Title:** `Кейсы: как мы сами вышли на рынок Европы | Studio Remarka`
- **Description:** `Мы сами прошли путь на рынок Италии и Европы: свои проекты от бюро переводов с 2001 года до веб-приложений. Портфолио с живыми ссылками, а не логотипами.`

## Blog · Batch 5 — RU (5 статей: свой путь, руками по-русски)

> RU-only статьи (без IT/EN зеркал, `translate_pages.py ru` запрещён навсегда).
> Фирменные SVG в `assets/img/blog/` (обложка + схема на статью). Фокус-ключ —
> в первом абзаце, в H2 и в одном alt. Формат Title — `<фраза> | Studio Remarka`.
> hreflang RU-only решён `lang.BLOG_RU_ONLY` (IT/EN → индексы `/blog/`,
> `/en/blog/`, без 404). JSON-LD BlogPosting — через `blog-schema-map`.

| Страница | Focus Keyword RU |
|---|---|
| `/ru/blog/sajt-dlya-vyhoda-na-rynok-italii/` | сайт для рынка италии |
| `/ru/blog/seo-v-italii-po-russki/` | seo в италии |
| `/ru/blog/gdpr-dlya-russkoyazychnogo-biznesa-v-es/` | gdpr для бизнеса |
| `/ru/blog/perevesti-ili-lokalizovat-sajt/` | локализация сайта |
| `/ru/blog/cena-sajta-v-italii/` | сколько стоит сайт в италии |

### `/ru/blog/sajt-dlya-vyhoda-na-rynok-italii/`

- **Title:** `Сайт для рынка Италии: с чего начать | Studio Remarka`
- **Description:** `С чего начать сайт для рынка Италии: местная основа, тексты носителей, право ЕС и продвижение — по порядку. Русскоязычная студия внутри Италии.`

### `/ru/blog/seo-v-italii-po-russki/`

- **Title:** `SEO в Италии по-русски, не зная языка | Studio Remarka`
- **Description:** `Как продвигать сайт в Google Италии, не зная итальянского: структура, скорость и ссылки — руками, тексты — носителем. Прозрачно, с отчётом.`

### `/ru/blog/gdpr-dlya-russkoyazychnogo-biznesa-v-es/`

- **Title:** `GDPR для бизнеса в ЕС: без паники | Studio Remarka`
- **Description:** `GDPR действует по местонахождению клиентов, а не бизнеса. Шесть шагов, которые закрывают почти весь риск для сайта, — без штата юристов и паники.`

### `/ru/blog/perevesti-ili-lokalizovat-sajt/`

- **Title:** `Локализация сайта: не то же, что перевод | Studio Remarka`
- **Description:** `«Перевести» и «локализовать» — разные работы: валюта, формат, местные примеры и оплата. 40% не купят на чужом языке. Локализация сайта носителями.`

### `/ru/blog/cena-sajta-v-italii/`

- **Title:** `Сколько стоит сайт в Италии: цифры | Studio Remarka`
- **Description:** `Сколько стоит сайт в Италии: визитка от € 1 900, корпоративный от € 3 900, магазин от € 7 500. Три диапазона, скрытые расходы и вопросы до подписи.`

## Blog · Batch 6 — RU (5 статей: продукты и доверие, руками по-русски)
...
| Страница | Focus Keyword RU |
|---|---|
| `/ru/blog/telegram-prilozhenie-dlya-biznesa-v-evrope/` | телеграм мини-приложение |
| `/ru/blog/kak-proverit-veb-studiyu/` | как проверить веб-студию |
| `/ru/blog/zakon-o-dostupnosti-sajtov/` | закон о доступности сайтов |
| `/ru/blog/sajt-v-chatgpt/` | сайт в chatgpt |
| `/ru/blog/russkoyazychnaya-auditoriya-v-evrope/` | русскоязычная аудитория европы |

### `/ru/blog/telegram-prilozhenie-dlya-biznesa-v-evrope/`

- **Title:** `Телеграм-приложение для бизнеса в Европе | Studio Remarka`
- **Description:** `Телеграм мини-приложение для бизнеса в ЕС: заказ и оплата прямо в чате, без установки. Канал с готовой аудиторией и наш опыт — Mini App за две недели.`

### `/ru/blog/kak-proverit-veb-studiyu/`

- **Title:** `Как проверить веб-студию: 8 сигналов | Studio Remarka`
- **Description:** `8 сигналов доверия, по которым видно надёжную веб-студию до подписи договора: портфолио, скорость, гарантии, права на код, GDPR и доступность.`

### `/ru/blog/zakon-o-dostupnosti-sajtov/`

- **Title:** `Закон о доступности сайтов в ЕС | Studio Remarka`
- **Description:** `Европейский закон о доступности сайтов действует с 28 июня 2025 — срок уже прошёл. Кого он касается, где исключения и что делать, если вы в зоне.`

### `/ru/blog/sajt-v-chatgpt/`

- **Title:** `Ваш сайт глазами ChatGPT: видимость | Studio Remarka`
- **Description:** `Сайт в ChatGPT — новая видимость: ИИ читает текст и структуру, а не дизайн. Почему он цитирует одних, и четыре шага, чтобы попадать в ответ. Без магии.`

### `/ru/blog/russkoyazychnaya-auditoriya-v-evrope/`

- **Title:** `Русскоязычная аудитория Европы в поиске | Studio Remarka`
- **Description:** `Русскоязычная аудитория Европы — большой тёплый рынок с пустой конкуренцией. Как эти люди ищут, почему их не находят и три шага, чтобы находили вас.`

## Blog · Batch 11 — RU (5 статей: продажи и доверие, руками по-русски)
...
| Страница | Focus Keyword RU |
|---|---|
| `/ru/blog/pochemu-sajt-ne-prinosit-zayavok/` | почему сайт не приносит клиентов |
| `/ru/blog/otzyvy-i-reputaciya-v-italii/` | отзывы на сайте |
| `/ru/blog/whatsapp-dlya-biznesa-v-evrope/` | whatsapp для бизнеса |
| `/ru/blog/reklama-ili-seo-s-chego-nachat/` | seo или реклама |
| `/ru/blog/kak-prinyat-oplatu-na-sajte/` | приём оплаты на сайте |

### `/ru/blog/pochemu-sajt-ne-prinosit-zayavok/`

- **Title:** `Почему сайт не приносит клиентов | Remarka`
- **Description:** `Почему сайт не приносит клиентов, хотя трафик есть: семь тихих утечек, из-за которых теряются заявки, и три, что чинятся за вечер без редизайна.`

### `/ru/blog/otzyvy-i-reputaciya-v-italii/`

- **Title:** `Отзывы на сайте: как собирать честно | Remarka`
- **Description:** `Отзывы на сайте: как собирать честно, строить репутацию в Италии и не попасть под закон ЕС о поддельных отзывах. Четыре шага без единой накрутки.`

### `/ru/blog/whatsapp-dlya-biznesa-v-evrope/`

- **Title:** `WhatsApp для бизнеса в Европе | Studio Remarka`
- **Description:** `WhatsApp для бизнеса в Европе: когда чат работает лучше формы, что умеет WhatsApp Business и как не нарушить GDPR. Плюс где чат точно не подходит.`

### `/ru/blog/reklama-ili-seo-s-chego-nachat/`

- **Title:** `SEO или реклама: с чего начать в Италии | Remarka`
- **Description:** `SEO или реклама: с чего начать русскоязычному бизнесу в Италии. Чем отличаются каналы, что дешевле для старта и почему это не «или», а «сначала».`

### `/ru/blog/kak-prinyat-oplatu-na-sajte/`

- **Title:** `Приём оплаты на сайте в Италии и ЕС | Remarka`
- **Description:** `Приём оплаты на сайте в Италии и ЕС: способы, комиссии, обязательная аутентификация SCA и электронный счёт. Без юридических выдумок, со ссылками.`

## Blog · Batch 12 — RU (5 статей: рынки и рост, руками по-русски, последний батч волны 2)
...
| Страница | Focus Keyword RU |
|---|---|
| `/ru/blog/sajt-dlya-nemeckogo-rynka/` | сайт для немецкого рынка |
| `/ru/blog/google-business-profile-v-italii/` | google business profile в италии |
| `/ru/blog/analitika-i-privatnost-ga4/` | ga4 и закон ес о данных |
| `/ru/blog/elektronnyj-schet-i-sajt/` | электронный счёт и сайт |
| `/ru/blog/mobilnaya-versiya-sajta/` | мобильная версия сайта |

### `/ru/blog/sajt-dlya-nemeckogo-rynka/`

- **Title:** `Сайт для немецкого рынка: что учесть | Remarka` (46)
- **Description:** `Сайт для немецкого рынка: юридический Impressum, тексты носителя, местные способы оплаты и налог. Что действительно учесть при выходе в Германию.` (145)

### `/ru/blog/google-business-profile-v-italii/`

- **Title:** `Google Business Profile в Италии | Remarka` (42)
- **Description:** `Google Business Profile в Италии: как оформить карточку, попасть в локальный топ на Картах и получать звонки раньше, чем откроют сайт.` (134)

### `/ru/blog/analitika-i-privatnost-ga4/`

- **Title:** `GA4 и закон ЕС о данных | Studio Remarka` (40)
- **Description:** `Google Analytics и закон ЕС: как настроить GA4 без нарушения GDPR — согласие, минимизация данных, Consent Mode. Обзор, а не юридическая консультация.` (149)

### `/ru/blog/elektronnyj-schet-i-sajt/`

- **Title:** `Электронный счёт и сайт в Италии | Remarka` (42)
- **Description:** `Электронный счёт (fattura elettronica) и сайт: что такое SdI, кому счёт обязателен и какие данные должен собрать чекаут, чтобы он прошёл проверку.` (146)

### `/ru/blog/mobilnaya-versiya-sajta/`

- **Title:** `Мобильная версия сайта решает | Remarka` (39)
- **Description:** `Мобильная версия сайта: почему клиенты уходят с телефона и как mobile-first indexing Google влияет на позиции. Где теряются клиенты на экране.` (142)

## Area clienti — IT/EN/RU (промо кабинета cab.remarka.biz, docs/piano-promo-cabinet-lab.md)

> Страница трастовая, не трафиковая: низкие частоты, конверсионная роль при
> сравнении подрядчиков. Focus Keyword задавать НЕ обязательно (как chi-siamo);
> если задавать — IT `area clienti agenzia web`, EN `web agency client portal`,
> RU `кабинет клиента веб-студии`. Оценку Rank Math без ключа игнорировать.

### `/area-clienti/`

- **Title:** `Area clienti — il progetto, nero su bianco | Remarka` (52)
- **Description:** `Fasi del progetto visibili ogni giorno, approvazioni e fatture in un posto solo. Senza password, dati in UE, in 3 lingue. Inclusa in ogni progetto.` (150)

### `/en/client-area/`

- **Title:** `Client area — the project, in black and white | Remarka` (55)
- **Description:** `Project stages visible every day, approvals and invoices in one place. Passwordless, EU-hosted, in 3 languages. Included in every project.` (139)

### `/ru/kabinet-klienta/`

- **Title:** `Кабинет клиента — проект как на ладони | Studio Remarka` (55)
- **Description:** `Стадии проекта видны каждый день, согласования и счета в одном месте. Без паролей, данные в ЕС, 3 языка. Входит в каждый проект Remarka.` (136)

## Blog · Спутники area clienti + Lab Monitor — IT/EN (2 статьи, 19.07.2026)

> Спутники промо-кампании кабинета и Monitor (docs/piano-promo-cabinet-lab.md
> §3.9). IT + EN (RU-блог — отдельный батч). Фокус-ключ в лиде, H2 и alt.
> Перелинковка: статья 1 ← страница /area-clienti/ (секция «Perché») и →
> segnali-eeat + preventivo-статья; статья 2 ← секция /strumenti/#monitor и →
> check-up-completo + core-web-vitals-статья.

| Страница IT · EN | Focus Keyword IT | Focus Keyword EN |
|---|---|---|
| `/blog/area-clienti-agenzia-web/` · `/en/blog/web-agency-client-portal/` | area clienti agenzia web | web agency client portal |
| `/blog/monitoraggio-sito-dopo-lancio/` · `/en/blog/website-monitoring-after-launch/` | monitoraggio sito web | website monitoring |

### Area clienti agenzia web

- **IT Title:** `Area clienti di un’agenzia web: cosa pretendere | Remarka` (58)
- **IT Description:** `I sei segni di un fornitore trasparente, le tre domande di sicurezza e perché l’area clienti non deve costarvi un euro in più. Con la checklist.` (144)
- **EN Title:** `Web agency client portal: what to demand | Remarka` (50)
- **EN Description:** `The six signs of a transparent vendor, the three security questions to ask before signing — and why a client portal shouldn’t cost you extra.` (141)

### Monitoraggio sito dopo il lancio

- **IT Title:** `Monitoraggio sito web: cosa misurare ogni mese | Remarka` (56)
- **IT Description:** `Uptime, Core Web Vitals reali, funzioni critiche e visibilità: le 4 misure del monitoraggio, il rituale mensile in 20 minuti e quando delegare.` (143)
- **EN Title:** `Website monitoring: what to measure monthly | Remarka` (53)
- **EN Description:** `Uptime, real-user Core Web Vitals, critical functions and visibility: the 4 measures, a 20-minute monthly ritual, and when to delegate.` (135)

---

## Blog · Batch 7 — IT/EN (5 статей: конверсия и доверие, вторая волна)

> Вторая волна блога (piano-blog-2.md, статьи 31–35). IT + EN (RU-блог —
...
> Перелинковка: услуга + инструмент Lab + соседняя статья батча; статья 33
> ссылается на уже опубликованную google-business-profile-guida.

| Страница IT · EN | Focus Keyword IT | Focus Keyword EN |
|---|---|---|
| `/blog/perche-il-sito-non-converte/` · `/en/blog/why-your-website-doesnt-convert/` | perché il sito non converte | why your website doesn't convert |
| `/blog/landing-page-che-converte/` · `/en/blog/landing-page-that-converts/` | landing page che converte | landing page that converts |
| `/blog/recensioni-riprova-sociale-onesta/` · `/en/blog/reviews-social-proof-done-right/` | recensioni sito web | website reviews |
| `/blog/whatsapp-business-pmi/` · `/en/blog/whatsapp-business-for-smes/` | whatsapp business pmi | whatsapp business for smes |
| `/blog/copywriting-sito-web-prima-del-design/` · `/en/blog/website-copywriting-before-design/` | copywriting sito web | website copywriting |

### 31 — Perché il sito non converte

- **IT Title:** `Perché il sito non converte: 7 fughe | Remarka` (46)
- **IT Description:** `Perché il vostro sito non converte: le 7 fughe silenziose che svuotano le visite prima che diventino richieste, e come tapparle una a una.` (138)
- **EN Title:** `Why your website doesn't convert: 7 leaks | Remarka` (51)
- **EN Description:** `Why your website doesn't convert: the 7 silent leaks that drain your visits before they become enquiries, and how to seal them.` (127)

### 32 — Landing page che converte

- **IT Title:** `Landing page che converte: l'anatomia | Remarka` (47)
- **IT Description:** `Una landing page che converte non è una home più corta: ha un solo scopo. L'anatomia, sezione per sezione, di una pagina che porta contatti.` (140)
- **EN Title:** `Landing page that converts: the anatomy | Remarka` (49)
- **EN Description:** `A landing page that converts isn't a shorter home page: it has one purpose. The anatomy, section by section, of a page that brings enquiries.` (141)

### 33 — Recensioni e riprova sociale

- **IT Title:** `Recensioni sito web: usarle senza inventarle | Remarka` (54)
- **IT Description:** `Le recensioni vendono, ma solo se vere: inventarle è illegale in UE e si nota. Come raccogliere riprova sociale onesta e metterla dove conta.` (141)
- **EN Title:** `Website reviews: use them without inventing them | Remarka` (58)
- **EN Description:** `Reviews sell, but only if real: inventing them is illegal in the EU and shows. How to collect honest social proof and put it where it counts.` (141)

### 34 — WhatsApp Business per le PMI

- **IT Title:** `WhatsApp Business per le PMI: quando conviene | Remarka` (55)
- **IT Description:** `Quando un contatto via chat batte il modulo. WhatsApp Business per le PMI: cosa fa, quando conviene davvero e come restare a norma GDPR.` (136)
- **EN Title:** `WhatsApp Business for SMEs: when it wins | Remarka` (50)
- **EN Description:** `When a chat contact beats the form. WhatsApp Business for SMEs: what it does, when it's really worth it, and how to stay GDPR-compliant.` (136)

### 35 — Il testo prima del design

- **IT Title:** `Copywriting sito web: il testo prima del design | Remarka` (57)
- **IT Description:** `Perché il copy decide la conversione più della grafica. Sul web il testo viene prima del design: come scrivere per chi legge (e per Google).` (140)
- **EN Title:** `Website copywriting: copy before design | Remarka` (49)
- **EN Description:** `Why copy decides conversion more than graphics. On the web the words come before the design: how to write for readers (and for Google).` (135)

...
## Статус выполнения
- Батч 7 — 🟨 черновик написан и запушен (коммит 29fa97c), но агент прерван
  лимитом сессии ДО приёмки. НЕ выполнен: финальная вычитка 5 текстов,
  фикс « →» на EN-лейблах ссылок/CTA, рендер 2 статей 390/1440, проверка
  источников/внутренних ссылок, валидность JSON-LD. НЕ деплоить, НЕ
  продвигаться к батчу 8, пока батч 7 не принят (после сброса лимита 8:00 UTC).
- Батч 8 — ⬜ очередь.
- Батч 9 — ⬜ очередь.
- Батч 10 — ⬜ очередь.

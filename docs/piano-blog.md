...
- **Ретрофит для батча 2 (обязательная часть задания)**: довести 5 статей
  батча 1 до новых правил владельца — добавить недостающие внешние
  авторитетные источники (до ≥3 на статью, блок «Fonti») и JSON-LD
  BlogPosting всем статьям блога (новым и восьми старым).

...
| T4 | QA: функциональные прогоны, линк-аудит, регрессия, локализованные title 8 старых EN/RU записей `page_map`, SEO-мета 3 новых инструментов, документация | текущий коммит (см. `git log`) |

...
- 17.07 (вечер): **Отзывы на 5 старых городских страницах** (Milano/Monza/
  Bergamo/Brescia/Como, блок «Recensioni Google verificate · 4,9 · 47»):
  оркестратор поднял вопрос подлинности (риски: Omnibus/AGCM + собственное
  E-E-A-T-позиционирование), **решение владельца — оставить как есть**.
  На новые страницы (Roma/Torino + G1b) такие блоки не добавляются
  (правило честности §2 действует для всего нового контента).

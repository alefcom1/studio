...
$page_map = array(
	...
	'caso-remarka-ai'                      => array( 'remarka-ai', 'casi-studio', 'Remarka AI' ),
	...
	'caso-perevod4-catalogo'                             => array( 'perevod4-catalogo', 'casi-studio', 'perevod4.ru' ),
	'caso-moscowtrans-techperevod'                             => array( 'moscowtrans-techperevod', 'casi-studio', 'moscowtrans.ru · techperevod.com' ),
	'caso-ukrinitsy'                             => array( 'ukrinitsy', 'casi-studio', 'ukrinitsy.ru' ),
	'caso-gioco'                             => array( 'gioco', 'casi-studio', 'L\'Impero delle Traduzioni' ),
	'caso-test-traduttori'                             => array( 'test-traduttori', 'casi-studio', 'Sistema di test dei traduttori' ),
	...
	'blog-piattaforma-ecommerce-quale-scegliere' => array( 'piattaforma-ecommerce-quale-scegliere', 'blog', null ),
	'blog-ecommerce-checklist-prima-del-lancio' => array( 'ecommerce-checklist-prima-del-lancio', 'blog', null ),
	'blog-cosa-include-sito-aziendale' => array( 'cosa-include-sito-aziendale', 'blog', null ),
	...
	'blog-consent-mode-v2-cosa-cambia'          => array( 'consent-mode-v2-cosa-cambia', 'blog', null ),
	'blog-google-analytics-4-privacy-ue'        => array( 'google-analytics-4-privacy-ue', 'blog', null ),
	'blog-alternative-google-analytics-privacy' => array( 'alternative-google-analytics-privacy', 'blog', null ),
	'blog-cookie-policy-o-privacy-policy'       => array( 'cookie-policy-o-privacy-policy', 'blog', null ),
	'blog-backup-e-sicurezza-sito-web'          => array( 'backup-e-sicurezza-sito-web', 'blog', null ),
	'blog-ai-overviews-google-restare-visibili' => array( 'ai-overviews-google-restare-visibili', 'blog', null ),
	'blog-inp-metrica-core-web-vitals'          => array( 'inp-metrica-core-web-vitals', 'blog', null ),
	'blog-autorevolezza-tematica-batte-keyword' => array( 'autorevolezza-tematica-batte-keyword', 'blog', null ),
	'blog-link-interni-seo-gratis'              => array( 'link-interni-seo-gratis', 'blog', null ),
	'blog-immagini-velocita-webp-lazy-load'     => array( 'immagini-velocita-webp-lazy-load', 'blog', null ),
	'blog-seo-locale-roma'                      => array( 'seo-locale-roma', 'blog', null ),
	'blog-seo-locale-torino'                    => array( 'seo-locale-torino', 'blog', null ),
	'blog-napoli-turismo-sito-multilingue'      => array( 'napoli-turismo-sito-multilingue', 'blog', null ),
	'blog-traduzione-madrelingua-vs-ai'         => array( 'traduzione-madrelingua-vs-ai', 'blog', null ),
	'blog-roi-localizzazione-sito'              => array( 'roi-localizzazione-sito', 'blog', null ),
	...
	'en-caso-remarka-ai'                           => array( 'remarka-ai', 'en/case-studies', 'Remarka AI' ),
	...
	'en-caso-perevod4-catalogo'                          => array( 'perevod4-catalogo', 'en/case-studies', 'perevod4.ru' ),
	'en-caso-moscowtrans-techperevod'                          => array( 'moscowtrans-techperevod', 'en/case-studies', 'moscowtrans.ru · techperevod.com' ),
	'en-caso-ukrinitsy'                          => array( 'ukrinitsy', 'en/case-studies', 'ukrinitsy.ru' ),
	'en-caso-gioco'                          => array( 'gioco', 'en/case-studies', 'L\'Impero delle Traduzioni' ),
	'en-caso-test-traduttori'                          => array( 'test-traduttori', 'en/case-studies', 'Sistema di test dei traduttori' ),
	'en-strumenti-index'                           => array( 'tools', 'en', 'Tools' ),
	'en-blog-index'                                => array( 'blog', 'en', 'Blog' ),
	'en-blog-piattaforma-ecommerce-quale-scegliere' => array( 'which-ecommerce-platform', 'en/blog', 'E-commerce platform: how to choose between Shopify, WooCommerce and custom-built' ),
	'en-blog-ecommerce-checklist-prima-del-lancio' => array( 'ecommerce-pre-launch-checklist', 'en/blog', 'E-commerce that sells: the checklist before launch' ),
	'en-blog-cosa-include-sito-aziendale' => array( 'what-a-business-website-includes', 'en/blog', 'What a well-built business website includes: the checklist' ),
	'en-servizio-siti-aziendali'                   => array( 'business-websites', 'en/services', 'The business website that loads in one second.' ),
	'en-servizio-e-commerce'                       => array( 'e-commerce', 'en/services', 'The online store that doesn’t lose customers at checkout.' ),
	'en-servizio-siti-pwa'                         => array( 'progressive-web-apps', 'en/services', 'A website that opens like an app, without going through the app stores.' ),
	'en-servizio-restyling-migrazione'             => array( 'redesign-migration', 'en/services', 'Your website, rebuilt: same content, three times the speed.' ),
	'en-servizio-seo-tecnica'                      => array( 'technical-seo', 'en/services', 'Structure and data in order, before a word of content is written.' ),
	'en-servizio-siti-multilingue'                 => array( 'multilingual-websites', 'en/services', 'Four languages translated by native speakers, not by a plugin.' ),
	'en-servizio-export-ready'                     => array( 'export-ready', 'en/services', 'Your website works in German too. Measured, guaranteed, signed.' ),
	'en-servizio-web-app'                          => array( 'custom-web-apps', 'en/services', 'When a website isn’t enough: web apps, client areas, configurators.' ),
	...
	'en-blog-sito-quattro-lingue-costi-tempi'      => array( 'website-four-languages-costs', 'en/blog', 'A website in four languages: costs, timelines, and the mistakes to avoid' ),
	'en-blog-cookie-banner-checklist-garante-2026' => array( 'cookie-banner-compliance-italy-2026', 'en/blog', 'Compliant cookie banners: the Garante’s 2026 checklist' ),
	'en-blog-migrare-wordpress-senza-perdere-seo'  => array( 'migrate-wordpress-without-losing-seo', 'en/blog', 'Migrating off WordPress without losing your Google rankings' ),
	'en-blog-pwa-per-pmi-quando-app-non-serve'     => array( 'pwa-for-smbs', 'en/blog', 'PWAs for SMBs: when you don’t need an app' ),
	'en-blog-quanto-costa-sito-aziendale-italia'   => array( 'business-website-cost-italy', 'en/blog', 'What a business website costs in Italy: the real prices' ),
	'en-blog-core-web-vitals-2026'                 => array( 'core-web-vitals-2026', 'en/blog', 'Core Web Vitals in 2026: what Google actually measures' ),
	'en-blog-quanto-costa-ecommerce-italia'        => array( 'ecommerce-cost-italy-2026', 'en/blog', 'What an e-commerce site costs in Italy in 2026: the real numbers' ),
	'en-blog-sito-lento-cause-costi'               => array( 'slow-website-causes-fixes', 'en/blog', 'Slow website: the 7 real causes (and what fixing them costs)' ),
	'en-blog-european-accessibility-act-ecommerce' => array( 'eaa-ecommerce-risks', 'en/blog', 'EAA 2026: what your e-commerce site really risks' ),
	'en-blog-llms-txt-cos-e'                       => array( 'llms-txt-explained', 'en/blog', 'llms.txt: what it is, and does your site actually need it?' ),
	'en-blog-farsi-trovare-da-chatgpt-geo'         => array( 'get-cited-by-chatgpt-geo', 'en/blog', 'How to get found (and cited) by ChatGPT: a GEO guide' ),
	'en-blog-check-up-sito-web-7-misure'           => array( 'website-checkup-7-metrics', 'en/blog', 'Website check-up: the 7 metrics that matter' ),
	'en-blog-eeat-come-google-giudica-credibilita' => array( 'eeat-how-google-judges-credibility', 'en/blog', 'E-E-A-T: how Google judges your credibility' ),
	'en-blog-preventivo-sito-web-come-leggerlo'    => array( 'website-quote-how-to-read-it', 'en/blog', 'Website quote: how to read it without surprises' ),
	'en-blog-sito-web-in-3-settimane'              => array( 'website-in-3-weeks', 'en/blog', 'A website in 3 weeks: how it’s (really) possible' ),
	'en-blog-restyling-o-sito-nuovo-5-domande'     => array( 'redesign-or-new-website-5-questions', 'en/blog', 'Redesign or new website? The test of 5 questions' ),
	'en-blog-impatto-ambientale-sito-web'          => array( 'website-environmental-impact', 'en/blog', 'How much your site weighs on the environment (and on your wallet)' ),
	'en-blog-dichiarazione-di-accessibilita-guida-2026' => array( 'accessibility-statement-guide-2026', 'en/blog', 'Accessibility statement: a practical 2026 guide' ),
	'en-blog-telegram-mini-app-business'           => array( 'telegram-mini-app-for-business', 'en/blog', 'Telegram Mini Apps for business: the channel Italy is ignoring' ),
	'en-blog-gestionale-su-misura-vs-excel'        => array( 'custom-management-software-vs-excel', 'en/blog', 'Custom management software vs Excel: when the leap pays off' ),
	'en-blog-dati-strutturati-schema-org'          => array( 'schema-org-structured-data-for-smes', 'en/blog', 'Schema.org for SMEs: the structured data Google rewards' ),
	'en-blog-gamification-b2b'                      => array( 'gamification-in-b2b', 'en/blog', 'Gamification in B2B: when a game sells serious services' ),
	'en-blog-hosting-sito-web-italia'              => array( 'website-hosting-italy-vs-cloud', 'en/blog', 'Website hosting in Italy or the cloud: what changes for speed and GDPR' ),
	'en-blog-seo-locale-milano'                    => array( 'local-seo-milan', 'en/blog', 'Local SEO in Milan: how to stand out in Italy’s most competitive city' ),
	'en-blog-google-business-profile-guida'        => array( 'google-business-profile-guide', 'en/blog', 'Google Business Profile: the free storefront nobody tends' ),
	'en-blog-hreflang-sito-multilingue'            => array( 'hreflang-multilingual-website', 'en/blog', 'Multilingual website: hreflang without the headache' ),
	'en-blog-sito-per-export'                      => array( 'website-for-export', 'en/blog', 'Selling abroad online: where to start' ),
	'en-blog-manutenzione-wordpress'               => array( 'wordpress-maintenance', 'en/blog', 'WordPress maintenance: what happens if you skip it' ),
	'en-blog-area-clienti-agenzia-web'             => array( 'web-agency-client-portal', 'en/blog', 'A web agency’s client portal: what you should demand' ),
	'en-blog-monitoraggio-sito-dopo-lancio'        => array( 'website-monitoring-after-launch', 'en/blog', 'Website monitoring after launch: what to measure every month' ),
	'en-blog-perche-il-sito-non-converte'          => array( 'why-your-website-doesnt-convert', 'en/blog', 'Why your website doesn’t convert: 7 silent leaks' ),
	'en-blog-landing-page-che-converte'            => array( 'landing-page-that-converts', 'en/blog', 'A landing page that converts: anatomy of a page that brings enquiries' ),
	'en-blog-recensioni-riprova-sociale-onesta'    => array( 'reviews-social-proof-done-right', 'en/blog', 'Reviews and social proof: using them without inventing them' ),
	'en-blog-whatsapp-business-pmi'                => array( 'whatsapp-business-for-smes', 'en/blog', 'WhatsApp Business for SMEs: when the chat beats the form' ),
	'en-blog-copywriting-sito-web-prima-del-design' => array( 'website-copywriting-before-design', 'en/blog', 'Copy before design: why the words decide conversion' ),
	'en-blog-consent-mode-v2-cosa-cambia'          => array( 'consent-mode-v2-what-changes', 'en/blog', 'Google Consent Mode v2: what changes for ads and analytics' ),
	'en-blog-google-analytics-4-privacy-ue'        => array( 'google-analytics-4-gdpr-eu', 'en/blog', 'Google Analytics 4 and privacy in the EU: are you really compliant?' ),
	'en-blog-alternative-google-analytics-privacy' => array( 'privacy-first-google-analytics-alternatives', 'en/blog', 'Privacy-first alternatives to Google Analytics: Matomo and Plausible' ),
	'en-blog-cookie-policy-o-privacy-policy'       => array( 'cookie-policy-vs-privacy-policy', 'en/blog', 'Cookie policy and privacy policy: what you really need and who for' ),
	'en-blog-backup-e-sicurezza-sito-web'          => array( 'website-backup-and-security', 'en/blog', 'Backup and site security: what you lose if it disappears tomorrow' ),
	'en-blog-ai-overviews-google-restare-visibili' => array( 'google-ai-overviews-stay-visible', 'en/blog', 'Google’s AI Overviews: how to stay visible when AI answers' ),
	'en-blog-inp-metrica-core-web-vitals'          => array( 'inp-core-web-vitals-metric', 'en/blog', 'INP, the new Core Web Vitals metric: what it measures and how to fix it' ),
	'en-blog-autorevolezza-tematica-batte-keyword' => array( 'topical-authority-beats-keywords', 'en/blog', 'Topical authority: why a blog beats 100 scattered keywords' ),
	'en-blog-link-interni-seo-gratis'              => array( 'internal-links-free-seo', 'en/blog', 'Internal links: the free SEO almost nobody looks after' ),
	'en-blog-immagini-velocita-webp-lazy-load'     => array( 'image-optimization-webp-lazy-load', 'en/blog', 'Images and speed: WebP, lazy-load and Core Web Vitals' ),
	'en-blog-seo-locale-roma'                      => array( 'local-seo-rome', 'en/blog', 'Local SEO in Rome: how to stand out in the capital of services' ),
	'en-blog-seo-locale-torino'                    => array( 'local-seo-turin', 'en/blog', 'Local SEO in Turin: getting found between industry and export' ),
	'en-blog-napoli-turismo-sito-multilingue'      => array( 'naples-tourism-multilingual-website', 'en/blog', 'Naples and tourism: a multilingual website that gets bookings' ),
	'en-blog-traduzione-madrelingua-vs-ai'         => array( 'native-translation-vs-ai', 'en/blog', 'Native translation or AI: the difference the customer feels' ),
	'en-blog-roi-localizzazione-sito'              => array( 'localization-roi', 'en/blog', 'Localization ROI: how much translating your site really pays' ),
	'en-prezzi'                                    => array( 'pricing', 'en', 'Transparent prices. No surprises mid-project.' ),
	'en-brief'                                     => array( 'brief', 'en', 'Brief' ),
	'en-citta-milano'                              => array( 'milan', 'en', 'Website development in Milan.' ),
	'en-area-clienti'                              => array( 'client-area', 'en', 'Client area' ),
	'en-chi-siamo'                                 => array( 'about', 'en', 'A group working with languages and the web since 2001.' ),
	'en-privacy'                                   => array( 'privacy', 'en', 'Privacy policy.' ),
	'en-cookie-policy'                             => array( 'cookie-policy', 'en', 'Cookie policy.' ),
	'en-cookie-preferenze'                         => array( 'cookie-preferences', 'en', 'Cookie preferences.' ),
	...
	'ru-caso-remarka-ai'                           => array( 'remarka-ai', 'ru/kejsy', 'Remarka AI' ),
	...
	'ru-caso-perevod4-catalogo'                          => array( 'perevod4-catalogo', 'ru/kejsy', 'perevod4.ru' ),
	'ru-caso-moscowtrans-techperevod'                          => array( 'moscowtrans-techperevod', 'ru/kejsy', 'moscowtrans.ru · techperevod.com' ),
	'ru-caso-ukrinitsy'                          => array( 'ukrinitsy', 'ru/kejsy', 'ukrinitsy.ru' ),
	'ru-caso-gioco'                          => array( 'gioco', 'ru/kejsy', 'L\'Impero delle Traduzioni' ),
	'ru-caso-test-traduttori'                          => array( 'test-traduttori', 'ru/kejsy', 'Sistema di test dei traduttori' ),
	'ru-strumenti-index'                           => array( 'instrumenty', 'ru', 'Инструменты' ),
	'ru-blog-index'                                => array( 'blog', 'ru', 'Блог' ),
	'ru-servizio-siti-aziendali'                   => array( 'korporativnye-sajty', 'ru/uslugi', 'Корпоративный сайт, который загружается за секунду.' ),
	'ru-servizio-e-commerce'                       => array( 'internet-magaziny', 'ru/uslugi', 'Интернет-магазин, который не теряет клиентов на оформлении заказа.' ),
	'ru-servizio-siti-pwa'                         => array( 'pwa-sajty', 'ru/uslugi', 'Сайт, который открывается как приложение — минуя магазины приложений.' ),
	'ru-servizio-restyling-migrazione'             => array( 'redizajn-i-migracija', 'ru/uslugi', 'Ваш сайт, собранный заново: тот же контент, втрое выше скорость.' ),
	'ru-servizio-seo-tecnica'                      => array( 'tehnicheskoe-seo', 'ru/uslugi', 'Структура и данные в порядке — ещё до того, как писать тексты.' ),
	'ru-servizio-siti-multilingue'                 => array( 'mnogojazychnye-sajty', 'ru/uslugi', 'Четыре языка в переводе носителей, а не плагина.' ),
	'ru-servizio-export-ready'                     => array( 'export-ready', 'ru/uslugi', 'Ваш сайт работает и на немецком. Измерено, гарантировано, подписано.' ),
	'ru-servizio-web-app'                          => array( 'veb-prilozhenija', 'ru/uslugi', 'Когда сайта мало: веб-приложения, личные кабинеты, конфигураторы.' ),
	...
	'ru-blog-sito-quattro-lingue-costi-tempi'      => array( 'sajt-na-4-jazykah', 'ru/blog', 'Сайт на четырёх языках: цены, сроки и ошибки, которых стоит избегать' ),
	'ru-blog-cookie-banner-checklist-garante-2026' => array( 'cookie-banner-trebovanija-2026', 'ru/blog', 'Cookie-баннер по правилам: чек-лист регулятора Garante на 2026 год' ),
	'ru-blog-migrare-wordpress-senza-perdere-seo'  => array( 'migracija-wordpress-bez-poteri-seo', 'ru/blog', 'Переезд с WordPress без потери позиций в Google' ),
	'ru-blog-pwa-per-pmi-quando-app-non-serve'     => array( 'pwa-dlja-biznesa', 'ru/blog', 'PWA для малого и среднего бизнеса: когда приложение не нужно' ),
	'ru-blog-quanto-costa-sito-aziendale-italia'   => array( 'skolko-stoit-sajt-v-italii', 'ru/blog', 'Сколько стоит корпоративный сайт в Италии: настоящие цены' ),
	'ru-blog-core-web-vitals-2026'                 => array( 'core-web-vitals-2026', 'ru/blog', 'Core Web Vitals в 2026 году: что на самом деле измеряет Google' ),
	'ru-blog-quanto-costa-ecommerce-italia'        => array( 'skolko-stoit-internet-magazin', 'ru/blog', 'Сколько стоит интернет-магазин в Италии в 2026 году: настоящие цифры' ),
	'ru-blog-sito-lento-cause-costi'               => array( 'medlennyj-sajt-prichiny', 'ru/blog', 'Медленный сайт: 7 настоящих причин (и сколько стоит их устранить)' ),
	...
	'ru-blog-sajt-dlya-vyhoda-na-rynok-italii'     => array( 'sajt-dlya-vyhoda-na-rynok-italii', 'ru/blog', 'Сайт для выхода на рынок Италии: с чего начать' ),
	'ru-blog-seo-v-italii-po-russki'               => array( 'seo-v-italii-po-russki', 'ru/blog', 'SEO в Италии по-русски: как продвигаться, не зная языка' ),
	'ru-blog-gdpr-dlya-russkoyazychnogo-biznesa-v-es' => array( 'gdpr-dlya-russkoyazychnogo-biznesa-v-es', 'ru/blog', 'GDPR для русскоязычного бизнеса в ЕС: без паники' ),
	'ru-blog-perevesti-ili-lokalizovat-sajt'       => array( 'perevesti-ili-lokalizovat-sajt', 'ru/blog', 'Почему «перевести сайт» ≠ «локализовать сайт»' ),
	'ru-blog-cena-sajta-v-italii'                  => array( 'cena-sajta-v-italii', 'ru/blog', 'Сколько стоит сайт в Италии: честные цифры' ),
	// Blog · Batch 6 — RU-only (scritti a mano, senza specchio IT/EN).
	'ru-blog-telegram-prilozhenie-dlya-biznesa-v-evrope' => array( 'telegram-prilozhenie-dlya-biznesa-v-evrope', 'ru/blog', 'Телеграм-приложение для бизнеса в Европе' ),
	'ru-blog-kak-proverit-veb-studiyu'             => array( 'kak-proverit-veb-studiyu', 'ru/blog', 'Как проверить подрядчика по сайту: 8 сигналов доверия' ),
	'ru-blog-zakon-o-dostupnosti-sajtov'           => array( 'zakon-o-dostupnosti-sajtov', 'ru/blog', 'Европейский закон о доступности: касается ли вас' ),
	'ru-blog-sajt-v-chatgpt'                       => array( 'sajt-v-chatgpt', 'ru/blog', 'Ваш сайт глазами ChatGPT: новая видимость' ),
	'ru-blog-russkoyazychnaya-auditoriya-v-evrope' => array( 'russkoyazychnaya-auditoriya-v-evrope', 'ru/blog', 'Русскоязычная аудитория в Европе: как её находят в поиске' ),
	// Blog · Batch 11 — RU-only (scritti a mano, senza specchio IT/EN).
	'ru-blog-pochemu-sajt-ne-prinosit-zayavok'     => array( 'pochemu-sajt-ne-prinosit-zayavok', 'ru/blog', 'Почему сайт не приносит заявок: 7 тихих утечек' ),
	'ru-blog-otzyvy-i-reputaciya-v-italii'         => array( 'otzyvy-i-reputaciya-v-italii', 'ru/blog', 'Отзывы и репутация в Италии: как собирать честно' ),
	'ru-blog-whatsapp-dlya-biznesa-v-evrope'       => array( 'whatsapp-dlya-biznesa-v-evrope', 'ru/blog', 'WhatsApp для бизнеса в Европе: когда чат лучше формы' ),
	'ru-blog-reklama-ili-seo-s-chego-nachat'       => array( 'reklama-ili-seo-s-chego-nachat', 'ru/blog', 'Реклама или SEO: с чего начать русскоязычному бизнесу в Италии' ),
	'ru-blog-kak-prinyat-oplatu-na-sajte'          => array( 'kak-prinyat-oplatu-na-sajte', 'ru/blog', 'Как принять оплату на сайте в Италии и ЕС: способы и нюансы' ),
	// Blog · Batch 12 — RU-only (scritti a mano, senza specchio IT/EN). Ultimo batch della volна 2.
	'ru-blog-sajt-dlya-nemeckogo-rynka'            => array( 'sajt-dlya-nemeckogo-rynka', 'ru/blog', 'Сайт для немецкого рынка: что нужно учесть при выходе в Германию' ),
	'ru-blog-google-business-profile-v-italii'     => array( 'google-business-profile-v-italii', 'ru/blog', 'Google Business Profile в Италии: как локальному бизнесу быть на виду' ),
	'ru-blog-analitika-i-privatnost-ga4'           => array( 'analitika-i-privatnost-ga4', 'ru/blog', 'Аналитика и приватность: GA4 и закон ЕС о данных' ),
	'ru-blog-elektronnyj-schet-i-sajt'             => array( 'elektronnyj-schet-i-sajt', 'ru/blog', 'Электронный счёт (fattura elettronica) и сайт: что учесть' ),
	'ru-blog-mobilnaya-versiya-sajta'              => array( 'mobilnaya-versiya-sajta', 'ru/blog', 'Мобильная версия решает: почему клиенты уходят с телефона' ),
	'ru-prezzi'                                    => array( 'ceny', 'ru', 'Прозрачные цены. Без сюрпризов по ходу проекта.' ),
	'ru-brief'                                     => array( 'brif', 'ru', 'Бриф' ),
	'ru-citta-milano'                              => array( 'milan', 'ru', 'Создание сайтов в Милане.' ),
	'ru-area-clienti'                              => array( 'kabinet-klienta', 'ru', 'Кабинет клиента' ),
	'ru-chi-siamo'                                 => array( 'o-studii', 'ru', 'Группа, которая работает с языками и вебом с 2001 года.' ),
	'ru-privacy'                                   => array( 'privacy', 'ru', 'Политика конфиденциальности.' ),
	'ru-cookie-policy'                             => array( 'cookie-policy', 'ru', 'Политика cookie.' ),
	'ru-cookie-preferenze'                         => array( 'cookie-preferences', 'ru', 'Настройки cookie.' ),
);
...
foreach ( $ordered as $pattern_slug ) {
	...
	// Guardia anti-regressione (bug trovato 24.07.2026: post_title di pagine
	// EN/RU senza override finiva in italiano, perché l'header «Title:» del
	// pattern è solo il nome interno del block-pattern — quasi mai tradotto
	// — e post_title è il fallback di default per il tag SEO <title> quando
	// non c'è un meta title impostato a mano. Ogni pattern en-/ru- DEVE avere
	// un $title_override in $page_map (di norma l'H1 della pagina, già
	// localizzato) — altrimenti si riproduce lo stesso bug su una pagina
	// nuova senza che nessuno se ne accorga finché non lo nota un cliente.
	if ( ! $title_override && ( str_starts_with( $pattern_slug, 'en-' ) || str_starts_with( $pattern_slug, 'ru-' ) ) ) {
		WP_CLI::warning( "  ⚠️ $pattern_slug: manca title_override in \$page_map — post_title rischia di restare in italiano (vedi H1 della pagina)." );
	}

	$title = $title_override ?: preg_replace( '/^Pagina — (RU Articolo: |Servizio: |Caso: |Città: |Articolo: |Strumento: )?/u', '', $pattern_title );

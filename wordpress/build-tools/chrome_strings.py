...
# CHROME_BLOG_GAP — coppie EN per le stringhe nuove/modificate dei 4 articoli blog
# (piattaforma e-commerce, checklist ecommerce, cosa include sito aziendale, sito-per-export)
# aggiunte 22.07.2026 per chiudere il gap del conveyor (translate_pages.py en).
CHROME_BLOG_GAP = {
    "Piattaforma e-commerce: quale scegliere tra Shopify, WooCommerce e su misura":
        {"en": "E-commerce platform: how to choose between Shopify, WooCommerce and custom-built"},
    "Avete deciso di aprire un negozio online e la prima domanda blocca tutto: quale piattaforma e-commerce scegliere? Bastano due minuti di ricerca per trovare pareri opposti — chi giura solo su Shopify, chi non si sposta da WordPress, chi vi dice che il su misura è l’unica scelta seria. La verità è meno comoda di una classifica: non esiste la piattaforma migliore in assoluto, esiste quella giusta per il vostro catalogo, il vostro budget mensile e quanto tempo volete dedicare alla manutenzione. In questo articolo confrontiamo onestamente Shopify, WooCommerce e lo sviluppo su misura, senza sconti a nessuno dei tre.":
        {"en": "You've decided to open an online shop, and the first question stops everything: which e-commerce platform should you choose? Two minutes of searching is enough to find opposite opinions — some swear by Shopify alone, some won't budge from WordPress, some tell you custom-built is the only serious choice. The truth is less tidy than a ranking: there's no single best platform, only the right one for your catalogue, your monthly budget and how much time you want to spend on maintenance. In this article we compare Shopify, WooCommerce and custom development honestly, without going easy on any of the three."},
    "Quale piattaforma e-commerce scegliere: la domanda che conta davvero":
        {"en": "Which e-commerce platform to choose: the question that actually matters"},
    "La domanda «quale piattaforma e-commerce scegliere» nasconde in realtà tre domande più piccole: quanti prodotti avete e quanto cambiano nel tempo, quanto budget potete sostenere ogni mese oltre allo sviluppo iniziale, e chi si occuperà degli aggiornamenti quando il negozio sarà online. Rispondere a queste tre cose prima di guardare un singolo prezzo vi risparmia mesi di lavoro rifatto da capo.":
        {"en": "The question “which e-commerce platform should I choose” actually hides three smaller questions: how many products you have and how much they change over time, how much budget you can sustain every month beyond the initial build, and who will handle the updates once the shop is online. Answering these three things before you look at a single price saves you months of work redone from scratch."},
    "Non è una scelta da fare a sensazione o copiando quello che usa il concorrente più grande di voi. Un negozio con quindici prodotti gestiti a mano ha esigenze opposte a chi vende migliaia di referenze su più depositi. Per questo, prima di mettervi a confrontare funzionalità e prezzi, vale la pena farsi accompagnare in una valutazione onesta di cosa serve davvero al vostro progetto.":
        {"en": "It's not a choice to make on a whim, or by copying whatever your biggest competitor uses. A shop with fifteen products managed by hand has opposite needs from one selling thousands of SKUs across several warehouses. That's why, before comparing features and prices, it's worth getting an honest assessment of what your project actually needs."},
    "C’è anche una domanda che quasi nessuno si fa in partenza, ed è la più importante: tra un anno, chi aggiornerà il negozio, aggiungerà prodotti, controllerà che tutto funzioni? Se la risposta è «nessuno in particolare», la scelta della piattaforma cambia parecchio rispetto al caso in cui avete già qualcuno — interno o esterno — che se ne occupa con continuità. Una piattaforma sulla carta perfetta ma lasciata a sé stessa, senza aggiornamenti né controlli, finisce per costare più di una più semplice ma seguita bene.":
        {"en": "There's also a question almost no one asks at the start, and it's the most important one: a year from now, who will update the shop, add products, check that everything still works? If the answer is “no one in particular,” the choice of platform changes considerably compared to a case where you already have someone — in-house or external — looking after it continuously. A platform that's perfect on paper but left to itself, with no updates or checks, ends up costing more than a simpler one that's properly looked after."},
    "Il nostro servizio e-commerce, dalla scelta della piattaforma alla messa online →":
        {"en": "Our e-commerce service, from choosing the platform to going live →"},
    "Shopify: online in un pomeriggio, canone ogni mese":
        {"en": "Shopify: online in an afternoon, a monthly fee forever"},
    "Shopify è una piattaforma SaaS: pagate un canone mensile e in cambio avete hosting, sicurezza di base e aggiornamenti gestiti dalla piattaforma, dentro un pannello pensato per chi non vuole toccare una riga di codice. Potete aprire un negozio funzionante — catalogo, carrello, pagamenti, spedizioni — in un pomeriggio, scegliendo un tema tra quelli disponibili e collegando le app che vi servono dal loro marketplace.":
        {"en": "Shopify is a SaaS platform: you pay a monthly fee and in return you get hosting, baseline security and updates managed by the platform, inside a dashboard built for people who don't want to touch a line of code. You can open a working shop — catalogue, cart, payments, shipping — in an afternoon, picking a theme from those available and connecting the apps you need from their marketplace."},
    "Il rovescio della medaglia è proprio quella comodità: siete dentro un ecosistema chiuso. Ogni funzione che esce dallo standard passa spesso da un’app di terzi a pagamento, e il canone continua ad arrivare ogni mese anche a negozio fermo. Va benissimo per chi vuole partire in fretta e non ha, né vuole avere, competenze tecniche interne; diventa più stretto quando il negozio cresce e servono personalizzazioni profonde che la piattaforma non prevede.":
        {"en": "The flip side of that convenience is that you're inside a closed ecosystem. Any feature outside the standard set often has to come from a paid third-party app, and the fee keeps arriving every month even when the shop is quiet. It's a great fit for anyone who wants to launch fast and has, or wants, no in-house technical skills; it gets tighter once the shop grows and needs deep customisation the platform doesn't offer."},
    "Vale anche per chi vende già altrove: Shopify si integra bene con i marketplace e i social più diffusi, e questo lo rende comodo per chi vuole gestire più canali di vendita da un unico pannello senza doverli collegare a mano uno per uno. Il compromesso resta lo stesso — meno lavoro tecnico, meno margine di manovra quando serve qualcosa di davvero diverso dallo standard.":
        {"en": "It's also worth it for anyone already selling elsewhere: Shopify integrates well with the most common marketplaces and social channels, which makes it convenient for managing several sales channels from a single dashboard without connecting them by hand one by one. The trade-off stays the same — less technical work, less room to manoeuvre when you need something genuinely different from the standard."},
    "WooCommerce: il negozio dentro WordPress":
        {"en": "WooCommerce: the shop built inside WordPress"},
    "WooCommerce è un plugin open source che trasforma un sito WordPress in un negozio a tutti gli effetti. Il software è gratuito, ma gratuito non vuol dire senza costi: serve un hosting adatto, un tema, e quasi sempre alcune estensioni a pagamento per pagamenti, spedizioni o fatturazione. In cambio avete libertà quasi totale sul codice, sul design e su come i contenuti — schede prodotto, blog, pagine informative — convivono nello stesso sito.":
        {"en": "WooCommerce is an open-source plugin that turns a WordPress site into a fully functioning shop. The software is free, but free doesn't mean cost-free: you need suitable hosting, a theme, and almost always some paid extensions for payments, shipping or invoicing. In exchange you get near-total freedom over the code, the design, and how content — product pages, a blog, informational pages — lives alongside the shop on the same site."},
    "La libertà ha un prezzo che non compare nello scontrino: la manutenzione è vostra. Aggiornare WordPress, il tema e i plugin, tenere sotto controllo la sicurezza e i backup non è un optional quando il negozio maneggia pagamenti e dati dei clienti — è la parte meno visibile del lavoro, quella che fa la differenza tra un negozio solido e uno fragile. Se avete già un sito WordPress che funziona bene, WooCommerce è spesso la strada più naturale; se partite da zero senza nessuno che se ne occupi, è un impegno da mettere in conto fin da subito.":
        {"en": "That freedom has a price that doesn't show up on the receipt: maintenance is on you. Updating WordPress, the theme and the plugins, keeping an eye on security and backups isn't optional once the shop is handling payments and customer data — it's the least visible part of the work, the one that makes the difference between a solid shop and a fragile one. If you already have a WordPress site that works well, WooCommerce is often the most natural path; if you're starting from zero with no one to look after it, it's a commitment to factor in from day one."},
    "Il vantaggio che si vede meno, ma conta parecchio, riguarda i contenuti: essendo WordPress a tutti gli effetti, un negozio WooCommerce può ospitare un blog, guide e pagine informative nello stesso ambiente del catalogo, con lo stesso sistema di gestione. Per chi punta a farsi trovare anche attraverso i contenuti — non solo con le campagne a pagamento — non è un dettaglio da poco.":
        {"en": "The advantage that's less obvious, but matters a lot, is about content: being WordPress through and through, a WooCommerce shop can host a blog, guides and informational pages in the same environment as the catalogue, with the same management system. For anyone aiming to be found through content too — not only through paid campaigns — that's no small detail."},
    "Su misura: quando conviene costruire da zero":
        {"en": "Custom-built: when it's worth building from scratch"},
    "Lo sviluppo su misura ha senso quando il negozio ha esigenze che nessuna piattaforma standard copre bene: logiche di prezzo complesse, integrazione stretta con un gestionale o un magazzino già esistente, un’esperienza d’acquisto molto diversa dal solito schema catalogo-carrello-checkout. È la strada con più controllo — ed è anche quella con l’investimento iniziale più alto e i tempi più lunghi.":
        {"en": "Custom development makes sense when the shop has needs no standard platform covers well: complex pricing logic, tight integration with an existing management system or warehouse, a buying experience very different from the usual catalogue-cart-checkout pattern. It's the path with the most control — and also the one with the highest upfront investment and the longest timeline."},
    "Casi tipici in cui vediamo davvero necessario il su misura: un catalogo B2B con listini e sconti diversi per ogni cliente, un negozio che deve dialogare in tempo reale con un gestionale di magazzino già in uso, oppure un modello di vendita — abbonamenti, configuratori di prodotto, marketplace multi-fornitore — che le piattaforme standard supportano solo con acrobazie di plugin su plugin. In questi casi il codice dedicato, alla lunga, costa meno dei compromessi.":
        {"en": "Typical cases where we genuinely see custom-built as necessary: a B2B catalogue with different price lists and discounts for each customer, a shop that has to talk in real time with a warehouse management system already in use, or a sales model — subscriptions, product configurators, multi-vendor marketplaces — that standard platforms can only support through plugin-on-plugin acrobatics. In these cases, dedicated code costs less than the compromises in the long run."},
    "Per la maggior parte delle piccole e medie imprese italiane, però, il su misura non è il punto di partenza: è un passaggio successivo, quando Shopify o WooCommerce iniziano davvero a stare stretti. Prima di orientarvi su questa strada vale la pena avere chiari i numeri — quanto costa realisticamente aprire e mantenere un e-commerce in Italia con ciascuna delle tre soluzioni, per confrontare non solo le funzionalità ma anche il conto a fine anno.":
        {"en": "For most Italian small and medium businesses, though, custom-built isn't the starting point: it's a later step, once Shopify or WooCommerce genuinely start feeling too tight. Before heading down this road it's worth having clear numbers — what it realistically costs to open and run an e-commerce business in Italy with each of the three solutions, to compare not just the features but the bill at the end of the year."},
    "Quanto costa un e-commerce in Italia: la spesa reale, non solo il preventivo →":
        {"en": "How much an e-commerce site costs in Italy: the real spend, not just the quote →"},
    "Quale piattaforma e-commerce scegliere in base al vostro negozio":
        {"en": "Which e-commerce platform to choose based on your shop"},
    "Se dovessimo ridurlo a una bussola: Shopify per chi vuole aprire in fretta, ha un catalogo semplice e preferisce pagare un canone piuttosto che pensare a hosting e sicurezza. WooCommerce per chi ha già, o vuole costruire, un sito WordPress solido, magari con un blog o contenuti editoriali accanto al negozio, ed è disposto a occuparsi — o a farsi seguire — della manutenzione. Su misura per chi ha processi che nessuna delle due piattaforme standard riesce a rappresentare senza acrobazie.":
        {"en": "If we had to boil it down to a compass: Shopify for those who want to launch fast, have a simple catalogue and would rather pay a fee than think about hosting and security. WooCommerce for those who already have, or want to build, a solid WordPress site, perhaps with a blog or editorial content alongside the shop, and are willing to handle — or have someone handle — the maintenance. Custom-built for those with processes neither standard platform can represent without acrobatics."},
    "Qualunque piattaforma scegliate, la velocità di caricamento e la cura del percorso d’acquisto restano decisive: ogni secondo di attesa in più è un cliente che chiude la scheda prodotto, piattaforma a parte. Non fatevi guidare solo dal prezzo del piano o dalla moda del momento: fatevi guidare da cosa dovrà fare il negozio tra un anno, non solo da cosa serve domani.":
        {"en": "Whichever platform you choose, loading speed and a well-cared-for buying journey remain decisive: every extra second of waiting is a customer closing the product page, whatever the platform. Don't let yourself be guided only by the plan's price or the trend of the moment: let yourself be guided by what the shop will need to do a year from now, not just what it needs tomorrow."},
    "Se avete ancora dubbi, il modo più concreto per scioglierli non è leggere un’altra classifica online, ma partire da come sta oggi il vostro sito o il vostro progetto: cosa c’è già, cosa manca, cosa rischia di rallentarvi non appena il negozio comincia a crescere davvero.":
        {"en": "If you still have doubts, the most concrete way to settle them isn't reading yet another ranking online, but starting from how your site or project stands today: what's already there, what's missing, what risks slowing you down as soon as the shop really starts to grow."},
    "Shopify, WooCommerce e sviluppo su misura a confronto: modello (SaaS, open source, codice dedicato), hosting, estensioni ed estensione dei tempi di avvio. La piattaforma giusta dipende dal catalogo, dal budget mensile e da chi la manterrà nel tempo.":
        {"en": "Shopify, WooCommerce and custom development compared: model (SaaS, open source, dedicated code), hosting, extensions and how long it takes to launch. The right platform depends on your catalogue, your monthly budget and who will maintain it over time."},
    "Misurate il vostro sito prima di scegliere la piattaforma — check-up gratuito →":
        {"en": "Measure your site before choosing a platform — free check-up →"},
    "Shopify — piattaforma ufficiale":
        {"en": "Shopify — official platform"},
    "La pagina ufficiale di Shopify: come funziona il modello SaaS in abbonamento, cosa include e come funzionano app e temi.":
        {"en": "Shopify's official page: how the subscription-based SaaS model works, what it includes and how apps and themes work."},
    "WooCommerce — plugin ufficiale per WordPress":
        {"en": "WooCommerce — official plugin for WordPress"},
    "Il sito ufficiale del plugin open source: documentazione, estensioni e requisiti di hosting per chi sceglie WordPress.":
        {"en": "The plugin's official open-source site: documentation, extensions and hosting requirements for those choosing WordPress."},
    "web.dev — Core Web Vitals":
        {"en": "web.dev — Core Web Vitals"},
    "Perché la velocità di caricamento pesa sulla conversione di ogni e-commerce, qualunque sia la piattaforma scelta.":
        {"en": "Why loading speed weighs on the conversion of every e-commerce site, whatever platform is chosen."},
    "Eurostat — statistiche sul commercio elettronico":
        {"en": "Eurostat — e-commerce statistics"},
    "Il quadro ufficiale UE sulla diffusione dell’e-commerce tra le imprese, per inquadrare il contesto in cui si sceglie una piattaforma.":
        {"en": "The official EU picture of e-commerce adoption among businesses, to frame the context in which a platform gets chosen."},
    "Quale piattaforma e-commerce scegliere: Shopify, WooCommerce o su misura a confronto":
        {"en": "Which e-commerce platform to choose: Shopify, WooCommerce or custom-built compared"},
    "Confronto tra Shopify, WooCommerce e sviluppo su misura: quale piattaforma e-commerce scegliere in base al vostro negozio":
        {"en": "Shopify, WooCommerce and custom development compared: which e-commerce platform to choose based on your shop"},
    "E-commerce che vende: la checklist prima del lancio":
        {"en": "E-commerce that sells: the checklist before launch"},
    "Aprire un e-commerce è facile, farlo vendere no. Ogni tanto incontriamo negozi online tecnicamente ineccepibili — belle foto, catalogo curato, dominio giusto — che il giorno del lancio non generano un solo ordine, perché è saltato qualcosa di semplice: un metodo di pagamento mancante, un costo di spedizione che spunta solo all'ultimo passo, un banner cookie assente. Ecco perché prima di premere «pubblica» serve una checklist prima di aprire un e-commerce che copra i punti che davvero decidono se un visitatore compra o abbandona il carrello: pagamenti, spedizioni, schede prodotto, ricerca e velocità, obblighi legali su privacy e consumatori. Non è un elenco teorico: sono i cinque blocchi di controllo che verifichiamo prima di ogni pubblicazione, uno per uno.":
        {"en": "Opening an e-commerce site is easy; making it sell isn't. Every so often we come across online shops that are technically flawless — nice photos, a curated catalogue, the right domain — that don't generate a single order on launch day, because something simple slipped through: a missing payment method, a shipping cost that only shows up at the very last step, no cookie banner. That's why, before you hit “publish,” you need a checklist before opening an e-commerce site that covers the points that genuinely decide whether a visitor buys or abandons the cart: payments, shipping, product pages, search and speed, legal obligations on privacy and consumer rights. It isn't a theoretical list: these are the five checks we run before every launch, one by one."},
    "Pagamenti: la prima voce della checklist, e la più decisiva":
        {"en": "Payments: the first item on the checklist, and the most decisive"},
    "Partiamo dal punto che decide la vendita al fotofinish: il pagamento. Se al momento di pagare il cliente non trova il metodo che usa abitualmente — carta, PayPal, un wallet come Satispay sempre più diffuso in Italia — il carrello resta pieno e il negozio incassa zero. La regola è semplice: più opzioni di pagamento offrite, meno persone abbandonano proprio sull'ultimo gradino. Non serve integrarle tutte dal primo giorno, ma almeno una carta, un wallet digitale e — se vendete a scontrino medio alto — un pagamento rateale sono ormai lo standard che i clienti si aspettano, non un lusso.":
        {"en": "Let's start with the point that decides the sale at the photo finish: payment. If, at the moment of paying, the customer doesn't find the method they usually use — card, PayPal, a wallet like Satispay, increasingly common in Italy — the cart stays full and the shop takes in nothing. The rule is simple: the more payment options you offer, the fewer people abandon right at the last step. You don't need to integrate them all from day one, but at least a card, a digital wallet and — if you sell at a higher average order value — instalment payment are by now the standard customers expect, not a luxury."},
    "Anche il numero di passaggi conta: un checkout compresso in una pagina sola, con i metodi di pagamento accettati mostrati già nel carrello e non scoperti solo all'ultimo clic, riduce le occasioni di ripensamento. Ogni schermata in più tra «voglio comprare» e «ho comprato» è un punto in cui il cliente può distrarsi, chiudere la scheda, rimandare a domani — e domani, si sa, spesso non arriva.":
        {"en": "The number of steps matters too: a checkout compressed into a single page, with the accepted payment methods already shown in the cart rather than discovered only at the last click, cuts down the chances of second thoughts. Every extra screen between “I want to buy” and “I've bought” is a point where the customer can get distracted, close the tab, put it off till tomorrow — and tomorrow, as we know, often doesn't come."},
    "La sicurezza percepita conta quanto quella reale: HTTPS su tutto il sito, non solo sul checkout, un lucchetto visibile nella barra degli indirizzi, e nessun dato di carta che passa o si salva sui vostri server — se ne occupa il gateway di pagamento, che deve essere certificato PCI-DSS. Ecco, in sintesi visiva, i cinque blocchi della checklist prima di aprire un e-commerce che affrontiamo in questo articolo, uno per uno.":
        {"en": "Perceived security matters as much as the real thing: HTTPS across the whole site, not just on checkout, a visible padlock in the address bar, and no card data that passes through or is stored on your servers — that's the payment gateway's job, and it must be PCI-DSS certified. Here, in a quick visual summary, are the five checklist items we cover in this article, one by one."},
    "La checklist in cinque mosse prima di aprire un e-commerce: metodi di pagamento multipli (1), spedizione e reso dichiarati prima del checkout (2), schede prodotto con prezzo e disponibilità reali (3), ricerca e velocità sotto controllo (4), cookie e GDPR in ordine (5). La voce più trascurata è la seconda: il costo scoperto solo alla fine.":
        {"en": "The five-step checklist before opening an e-commerce site: multiple payment methods (1), shipping and returns stated before checkout (2), product pages with real price and availability (3), search and speed under control (4), cookies and GDPR in order (5). The most neglected item is the second: the cost discovered only at the end."},
    "Spedizioni e resi: azzerare le sorprese al checkout":
        {"en": "Shipping and returns: clear away the surprises at checkout"},
    "La seconda voce è quella che silenziosamente affossa più carrelli di ogni altra: il costo di spedizione che compare solo all'ultimo passo del checkout. Il centro di ricerca Baymard, che da anni studia l'usabilità dei checkout dei maggiori e-commerce al mondo attraverso test utente ripetuti, indica proprio i costi extra scoperti troppo tardi — insieme all'obbligo di creare un account prima ancora di vedere il totale — tra le cause più ricorrenti di abbandono. La correzione è a costo zero: mostrare la spedizione, o almeno una stima, già nella scheda prodotto o nel carrello, non alla fine.":
        {"en": "The second item is the one that quietly sinks more carts than any other: the shipping cost that only appears at the very last step of checkout. The Baymard research centre, which has spent years studying the usability of the world's biggest e-commerce checkouts through repeated user testing, points to exactly these extra costs discovered too late — along with being forced to create an account before even seeing the total — as some of the most recurring causes of abandonment. The fix costs nothing: show the shipping cost, or at least an estimate, already on the product page or in the cart, not at the end."},
    "Stessa logica per i resi: in tutta l'Unione Europea chi acquista online ha 14 giorni di diritto di recesso, senza dover giustificare il motivo. Nasconderlo o scriverlo in un carattere minuscolo in fondo alla pagina non lo rende meno vostro obbligo — lo rende solo meno chiaro a chi compra, e un cliente che non trova la politica di reso prima di comprare spesso rinuncia proprio per questo. Tempi di consegna realistici, corriere dichiarato, costo del reso esplicito: tre righe che tolgono un dubbio enorme prima ancora che venga posto.":
        {"en": "The same logic applies to returns: across the whole European Union, anyone buying online has 14 days' right of withdrawal, with no need to justify the reason. Hiding it, or writing it in tiny print at the bottom of the page, doesn't make it any less your obligation — it just makes it less clear to the buyer, and a customer who can't find the returns policy before buying often gives up for exactly that reason. Realistic delivery times, a named courier, an explicit return cost: three lines that remove a huge doubt before it's even raised."},
    "Un accorgimento pratico che vale la pena aggiungere alla checklist: un calcolatore di spedizione visibile già nella pagina del carrello, con il CAP del cliente, invece di rimandare la cifra alla schermata finale del checkout. Costa poco da implementare e toglie di mezzo la sorpresa più citata da chi abbandona un acquisto online quasi concluso.":
        {"en": "One practical touch worth adding to the checklist: a shipping calculator visible right on the cart page, using the customer's postcode, instead of pushing the figure to the final checkout screen. It costs little to implement and removes the surprise most often cited by people who abandon an almost-finished online purchase."},
    "Schede prodotto che convincono, non solo belle foto":
        {"en": "Product pages that convince, not just nice photos"},
    "Foto curate aiutano, ma una scheda prodotto che vende risponde a domande pratiche prima che il cliente le faccia: il prezzo è comprensivo di IVA? è disponibile in magazzino o va ordinato? quanto ci mette ad arrivare? Ogni «contattateci per il prezzo» su un prodotto che potrebbe avere un prezzo pubblico è un ostacolo in più, non un tocco di eleganza — e chi cerca online, di solito, va dal concorrente che il prezzo lo scrive.":
        {"en": "Curated photos help, but a product page that sells answers practical questions before the customer even asks them: is the price VAT-inclusive? is it in stock or does it need to be ordered? how long will it take to arrive? Every “contact us for the price” on a product that could well have a public price is one more obstacle, not a touch of elegance — and people searching online usually go to the competitor who does write the price."},
    "Se pubblicate recensioni, che siano vere fino all'ultima virgola: nessun negozio nuovo di zecca ha già cento recensioni a cinque stelle, e chi legge se ne accorge. Meglio zero recensioni con una promessa chiara — spedizione tracciata, assistenza per email con un tempo di risposta dichiarato — che una vetrina di testimonianze inventate: basta un dubbio per far chiudere la scheda e non tornare più.":
        {"en": "If you publish reviews, make sure they're true down to the last comma: no brand-new shop already has a hundred five-star reviews, and readers notice. Better zero reviews with a clear promise — tracked shipping, email support with a stated response time — than a showcase of invented testimonials: it only takes one doubt to make someone close the page and never come back."},
    "Molto di questo dipende anche dalla piattaforma su cui costruite il negozio: alcune gestiscono varianti, magazzino e resi meglio di altre, e sceglierla è una decisione da prendere a mente lucida, non a metà progetto. Ne abbiamo scritto un confronto onesto, utile se questa casella della vostra checklist è ancora da spuntare.":
        {"en": "A lot of this also depends on the platform you build the shop on: some handle variants, stock and returns better than others, and choosing it is a decision to make with a clear head, not halfway through the project. We've written an honest comparison about it, useful if that box on your checklist still needs ticking."},
    "Piattaforma e-commerce: quale scegliere →":
        {"en": "E-commerce platform: which one to choose →"},
    "Ricerca, UX e velocità: il negozio deve anche funzionare bene":
        {"en": "Search, UX and speed: the shop also has to actually work"},
    "Un catalogo con più di una manciata di prodotti ha bisogno di una ricerca interna che funzioni davvero e di filtri — categoria, prezzo, taglia — che riducano concretamente le scelte, altrimenti il cliente scorre, si stanca ed esce. Da mobile, dove ormai arriva la maggior parte del traffico di un e-commerce, menù e filtri troppo piccoli o un carrello che si perde di vista sono la prima causa di un abbandono silenzioso, quello che nei report non si vede.":
        {"en": "A catalogue with more than a handful of products needs an internal search that genuinely works and filters — category, price, size — that concretely narrow down the choices, otherwise the customer scrolls, gets tired and leaves. On mobile, where most of an e-commerce site's traffic now comes from, menus and filters that are too small, or a cart that gets lost from view, are the leading cause of a silent abandonment that never shows up in the reports."},
    "Anche una ricerca interna tollerante agli errori di battitura, capace di suggerire il prodotto giusto anche se il cliente scrive «magliett» invece di «maglietta», vale più di un menù elegante ma rigido: chi arriva già sapendo cosa vuole non deve dimostrarlo a colpi di ortografia perfetta.":
        {"en": "An internal search that's forgiving of typos, able to suggest the right product even if the customer types “t-shrt” instead of “t-shirt,” is also worth more than an elegant but rigid menu: someone who already knows what they want shouldn't have to prove it with perfect spelling."},
    "La velocità di caricamento è parte della stessa checklist, non un capitolo a parte: Google la misura con i Core Web Vitals, e le soglie pubblicate da web.dev indicano, ad esempio, che il contenuto principale della pagina dovrebbe comparire entro 2,5 secondi per essere considerato «buono». Un e-commerce lento non perde solo posizionamento: perde chi ha già deciso di comprare e non aspetta.":
        {"en": "Loading speed is part of the same checklist, not a separate chapter: Google measures it with the Core Web Vitals, and the thresholds published by web.dev indicate, for example, that a page's main content should appear within 2.5 seconds to be considered “good.” A slow e-commerce site doesn't just lose ranking: it loses people who had already decided to buy and won't wait."},
    "Legale e privacy: cookie, GDPR e condizioni scritte chiare":
        {"en": "Legal and privacy: cookies, GDPR and clearly written terms"},
    "Un negozio online raccoglie dati personali a ogni ordine — nome, indirizzo, a volte dati di pagamento — e questo attiva tutti gli obblighi del GDPR fin dal primo cliente. Il principio guida è la minimizzazione dei dati previsto dal Regolamento: chiedete al checkout solo ciò che serve per evadere l'ordine, non un modulo lungo «per curiosità commerciale». E prima ancora del checkout arriva il banner cookie: le linee guida del Garante per la protezione dei dati personali chiedono che i cookie di profilazione e i pixel pubblicitari partano solo dopo un consenso esplicito, mai prima.":
        {"en": "An online shop collects personal data with every order — name, address, sometimes payment details — and that triggers all GDPR obligations from the very first customer. The guiding principle is the data minimisation the Regulation calls for: at checkout, ask only for what's needed to fulfil the order, not a long form “out of commercial curiosity.” And even before checkout comes the cookie banner: the guidelines from Italy's data protection authority (Garante) require that profiling cookies and advertising pixels only fire after explicit consent, never before."},
    "Condizioni di vendita, informativa privacy e politica di reso devono essere pagine vere, raggiungibili dal footer, non un link morto o un PDF dimenticato in un vecchio backup del sito. È l'ultima voce della checklist prima di aprire un e-commerce, ed è anche la più facile da verificare da soli, gratis, prima di andare online.":
        {"en": "Terms of sale, privacy notice and returns policy need to be real pages, reachable from the footer, not a dead link or a PDF forgotten in some old site backup. It's the last item on the checklist before opening an e-commerce site, and also the easiest to check yourself, for free, before going live."},
    "Verificate gratis la conformità GDPR del vostro sito →":
        {"en": "Check your site's GDPR compliance for free →"},
    "Cosa include il nostro servizio di realizzazione e-commerce →":
        {"en": "What our e-commerce build service includes →"},
    "Garante per la protezione dei dati personali — Linee guida cookie e altri strumenti di tracciamento":
        {"en": "Garante per la protezione dei dati personali (Italian data protection authority) — cookie and other tracking tools guidelines"},
    "Il consenso ai cookie di profilazione va raccolto prima che partano, non dopo: la regola alla base di ogni banner cookie conforme.":
        {"en": "Consent to profiling cookies must be collected before they fire, not after: the rule behind every compliant cookie banner."},
    "La minimizzazione dei dati raccolti al checkout, e in generale gli obblighi che scattano dal primo ordine con dati personali.":
        {"en": "Data minimisation at checkout, and more generally the obligations that kick in from the first order with personal data."},
    "Baymard Institute — Checkout Usability":
        {"en": "Baymard Institute — Checkout Usability"},
    "La ricerca sull’usabilità del checkout, basata su test utente ripetuti sui maggiori e-commerce: dove e perché si abbandona il carrello.":
        {"en": "Research on checkout usability, based on repeated user testing across the biggest e-commerce sites: where and why the cart gets abandoned."},
    "Le soglie ufficiali dei Core Web Vitals: perché un e-commerce lento perde clienti prima ancora di perdere posizionamento.":
        {"en": "The official Core Web Vitals thresholds: why a slow e-commerce site loses customers before it even loses rankings."},
    "Verificate gratis la conformità GDPR del vostro e-commerce prima del lancio →":
        {"en": "Check your e-commerce site's GDPR compliance for free before launch →"},
    "Checklist prima di aprire un e-commerce: cosa controllare prima del lancio":
        {"en": "Checklist before opening an e-commerce site: what to check before launch"},
    "La checklist in cinque mosse prima di aprire un e-commerce: pagamenti, spedizioni, schede prodotto, velocità, legale":
        {"en": "The five-step checklist before opening an e-commerce site: payments, shipping, product pages, speed, legal"},
    "Cosa include un sito aziendale fatto bene: la checklist":
        {"en": "What a well-built business website includes: the checklist"},
    "Quando si parla di cosa include un sito aziendale fatto bene, la mente corre quasi sempre al design: il logo, i colori, le foto professionali. Capita spesso, però, di trovare — dietro una grafica curatissima — un sito senza un hosting affidabile, senza cookie policy, senza un modo per sapere se sta davvero portando clienti. Un sito così è un guscio vuoto: bello da vedere, fragile da usare, e nel tempo anche fastidioso da tenere in piedi. In questo articolo vediamo davvero cosa deve contenere un sito aziendale per essere un investimento e non una scommessa: sei aree, dalla parte tecnica che nessuno vede a quella che si nota al primo sguardo, con quello che nella pratica capita più spesso di trovare mancante.":
        {"en": "When people talk about what a well-built business website includes, the mind almost always jumps to design: the logo, the colours, the professional photos. Yet it's common to find — behind very polished graphics — a site with no reliable hosting, no cookie policy, no way of knowing whether it's actually bringing in customers. A site like that is an empty shell: nice to look at, fragile to use, and over time a hassle to keep running. In this article we look at what a business website really needs to contain to be an investment rather than a gamble: six areas, from the technical side no one sees to the one that's noticed at first glance, with what's most often found missing in practice."},
    "Le fondamenta tecniche: hosting solido, HTTPS, prestazioni":
        {"en": "The technical foundations: solid hosting, HTTPS, performance"},
    "La parte che non si vede è quella che regge tutto il resto. Un hosting solido significa un sito che resta online quando arriva più visite del solito — una campagna che funziona, una menzione su un giornale locale — e che si riprende in fretta se qualcosa va storto. Serve poi HTTPS su ogni pagina, non solo sul modulo di contatto: senza, i browser moderni segnalano il sito come «non sicuro», ed è il primo dettaglio che allontana un visitatore diffidente.":
        {"en": "The part you don't see is the one holding up everything else. Solid hosting means a site that stays online when it gets more visits than usual — a campaign that works, a mention in a local paper — and that recovers quickly if something goes wrong. Then you need HTTPS on every page, not just the contact form: without it, modern browsers flag the site as “not secure,” and that's the first detail that pushes away a wary visitor."},
    "Poi ci sono le prestazioni, che si possono misurare, non solo intuire. web.dev, il sito di riferimento su questi temi, definisce le soglie dei Core Web Vitals: quanto tempo impiega a caricarsi il contenuto principale della pagina, quanto velocemente risponde al primo clic, se «salta» mentre si carica o resta stabile. Non sono dettagli per tecnici: sono la differenza tra un visitatore che aspetta e uno che chiude la scheda prima ancora di leggere una riga.":
        {"en": "Then there's performance, which can be measured, not just guessed at. web.dev, the reference site on these topics, defines the Core Web Vitals thresholds: how long it takes for a page's main content to load, how quickly it responds to the first click, whether it “jumps around” while loading or stays stable. These aren't details for techies: they're the difference between a visitor who waits and one who closes the tab before even reading a line."},
    "Cosa include un sito aziendale fatto bene, in sei aree: fondamenta tecniche, contenuti che convertono, parte legale, visibilità, misura e manutenzione. Mancano quasi sempre le ultime tre — le meno visibili al primo sguardo, ma quelle che nel tempo fanno la differenza.":
        {"en": "What a well-built business website includes, in six areas: technical foundations, content that converts, the legal side, visibility, measurement and maintenance. Almost always missing are the last three — the least visible at first glance, but the ones that make the difference over time."},
    "I contenuti che convertono, non solo che riempiono":
        {"en": "Content that converts, not just fills space"},
    "Un sito pieno di pagine non è un sito con contenuti utili. Quello che serve davvero è poco e mirato: una homepage che dice in una riga cosa fate e per chi, pagine di servizio con informazioni concrete — cosa include l'offerta, tempi indicativi, una fascia di prezzo quando è possibile darla — e una call to action chiara su ogni pagina, non nascosta in fondo dopo tre schermate. Una pagina «chi siamo» generica, senza un volto o una storia reale dietro, dice al visitatore che dall'altra parte non c'è nessuno con cui parlare davvero.":
        {"en": "A site full of pages isn't a site with useful content. What's actually needed is little and targeted: a homepage that says in one line what you do and for whom, service pages with concrete information — what the offer includes, rough timelines, a price range where possible — and a clear call to action on every page, not buried at the bottom after three screens. A generic “about us” page, with no real face or story behind it, tells the visitor there's no one on the other side to actually talk to."},
    "Le foto contano quanto i testi: meglio poche immagini vere del vostro lavoro che una galleria di stock anonimo scaricata ovunque, uguale a quella di dieci concorrenti. E se pubblicate testimonianze o casi reali, vanno raccontati con onestà — con nome, contesto, dettagli verificabili — perché un cliente riconosce a colpo d'occhio una recensione finta o troppo generica, e la fiducia persa qui è difficile da recuperare nel resto del sito. Meglio due casi concreti, raccontati per bene, che dieci frasi anonime senza volto.":
        {"en": "Photos matter as much as the copy: a few genuine images of your own work beat an anonymous stock gallery downloaded by everyone, identical to ten competitors'. And if you publish testimonials or real case studies, they need to be told honestly — with a name, context, verifiable details — because a customer spots a fake or overly generic review at a glance, and trust lost here is hard to win back on the rest of the site. Two concrete cases, told properly, beat ten anonymous, faceless lines."},
    "La parte legale: privacy, cookie, accessibilità":
        {"en": "The legal side: privacy, cookies, accessibility"},
    "Se il sito raccoglie anche un solo dato — un modulo di contatto, una newsletter — serve un'informativa privacy chiara su come lo usate, e una cookie policy vera, scritta sul vostro sito e non copiata da un altro: il Garante per la protezione dei dati personali pubblica indicazioni precise su come deve funzionare il consenso ai cookie prima che qualsiasi script non necessario parta. Un banner che finge di chiedere il consenso ma carica comunque tutto in background non è una formalità superata: è un rischio concreto.":
        {"en": "If the site collects even a single piece of data — a contact form, a newsletter — it needs a clear privacy notice explaining how you use it, and a genuine cookie policy, written for your own site rather than copied from someone else's: Italy's data protection authority (Garante) publishes precise guidance on how cookie consent must work before any non-essential script runs. A banner that pretends to ask for consent but loads everything in the background anyway isn't a formality you can skip: it's a real risk."},
    "C'è poi l'accessibilità: un sito leggibile anche da chi usa uno screen reader o naviga solo da tastiera, senza mouse. Il W3C, l'organizzazione che scrive gli standard tecnici del web, pubblica le linee guida WCAG — il riferimento internazionale per capire cosa rende un sito davvero accessibile: contrasti sufficienti, testo alternativo alle immagini, moduli che si possono compilare senza vedere lo schermo. Non è un dettaglio per pochi: è una parte della qualità di un sito che una fetta reale di visitatori nota, eccome, quando manca — e sempre più spesso è anche una richiesta di legge, non solo di buon senso.":
        {"en": "Then there's accessibility: a site readable even by someone using a screen reader or navigating by keyboard only, without a mouse. The W3C, the organisation that writes the web's technical standards, publishes the WCAG guidelines — the international reference for understanding what makes a site genuinely accessible: sufficient contrast, alt text on images, forms that can be filled in without seeing the screen. It isn't a niche detail: it's part of a site's quality that a real slice of visitors notices, very much so, when it's missing — and increasingly it's also a legal requirement, not just common sense."},
    "Misura privacy e accessibilità del vostro sito, gratis →":
        {"en": "Measure your site's privacy and accessibility for free →"},
    "La visibilità: la SEO tecnica di base":
        {"en": "Visibility: the technical SEO basics"},
    "Un sito può avere contenuti ottimi e restare invisibile su Google se manca la base tecnica della SEO: un titolo e una descrizione scritti per ogni pagina, una mappa del sito che aiuta i motori di ricerca a trovare tutte le pagine, indirizzi puliti e comprensibili, immagini con testo alternativo. Google raccoglie queste indicazioni nella propria documentazione ufficiale per chi lavora sulla ricerca, ed è la base da cui parte ogni posizionamento, prima ancora di scrivere il primo articolo di blog o di pensare a una parola chiave.":
        {"en": "A site can have excellent content and still stay invisible on Google if it's missing the technical basics of SEO: a title and description written for every page, a sitemap that helps search engines find every page, clean and understandable URLs, images with alt text. Google gathers this guidance in its own official documentation for people working on search, and it's the foundation every ranking starts from, well before writing a single blog post or thinking about a keyword."},
    "Non serve inseguire ogni tecnicismo: serve che queste basi ci siano fin dal lancio, non aggiunte mesi dopo quando l'indicizzazione persa non si recupera con un colpo di bacchetta. Un sito senza sitemap, senza titoli scritti con criterio, con indirizzi generati automaticamente e illeggibili, parte già in salita rispetto a un concorrente che questi dettagli li ha curati fin dal primo giorno. È uno dei motivi per cui, quando progettiamo un sito aziendale, la SEO tecnica entra nel lavoro dal primo giorno e non come voce extra aggiunta alla fine.":
        {"en": "There's no need to chase every technicality: what matters is having these foundations in place from launch, not added months later when lost indexing can't be recovered with a wave of a wand. A site with no sitemap, no titles written with any care, with automatically generated, unreadable URLs, already starts uphill against a competitor who took care of these details from day one. It's one of the reasons why, when we design a business website, technical SEO goes into the work from day one, not as an extra item tacked on at the end."},
    "La misura e la manutenzione, nel tempo":
        {"en": "Measurement and maintenance, over time"},
    "Un sito che non misura nulla non permette di capire cosa funziona: un analytics ben configurato — rispettoso della privacy, non un modulo lasciato di default — dice da dove arrivano le richieste e quali pagine le fanno perdere per strada. Ne abbiamo parlato più nel dettaglio a proposito delle alternative ad Analytics che rispettano i dati fin dall'inizio.":
        {"en": "A site that measures nothing doesn't let you understand what's working: a properly configured analytics setup — respectful of privacy, not a tool left on default — tells you where enquiries come from and which pages lose them along the way. We've covered this in more detail when talking about the alternatives to Analytics that respect data from the start."},
    "E un sito lanciato non è un sito finito: serve manutenzione — aggiornamenti regolari, backup testati davvero, un controllo periodico che tutto funzioni ancora come il primo giorno. Ne raccontiamo i dettagli quando parliamo di cosa serve dopo il lancio, e di cosa perdete se un giorno il sito sparisce e basta.":
        {"en": "And a launched site isn't a finished site: it needs maintenance — regular updates, genuinely tested backups, a periodic check that everything still works like day one. We go into the detail when we talk about what's needed after launch, and what you lose if one day the site simply disappears."},
    "Cosa include un sito aziendale fatto bene, quindi, non è una lista di preferenze estetiche: è questa combinazione — fondamenta tecniche, contenuti, parte legale, visibilità, misura e manutenzione — che deve reggere insieme e nel tempo. Manca anche solo una di queste aree e il sito resta un guscio ben verniciato: bello da guardare, fragile da usare.":
        {"en": "What a well-built business website includes, then, isn't a list of aesthetic preferences: it's this combination — technical foundations, content, the legal side, visibility, measurement and maintenance — that has to hold up together and over time. Miss even one of these areas and the site stays a nicely painted shell: good to look at, fragile to use."},
    "Cosa include un sito aziendale, il nostro approccio →":
        {"en": "What a business website includes, our approach →"},
    "Misura il vostro sito, gratis: check-up completo →":
        {"en": "Measure your site for free: full check-up →"},
    "Leggi anche: come leggere un preventivo per un sito web →":
        {"en": "Read also: how to read a website quote →"},
    "web.dev — prestazioni e Core Web Vitals":
        {"en": "web.dev — performance and Core Web Vitals"},
    "Il riferimento di Google su velocità e stabilità di una pagina: le soglie che rendono un sito davvero veloce.":
        {"en": "Google's reference on a page's speed and stability: the thresholds that make a site genuinely fast."},
    "L'autorità italiana con indicazioni su informative, cookie e diritti degli interessati.":
        {"en": "Italy's data protection authority, with guidance on notices, cookies and data subjects' rights."},
    "W3C WAI — accessibilità web (WCAG)":
        {"en": "W3C WAI — web accessibility (WCAG)"},
    "Le linee guida internazionali sull'accessibilità: il riferimento per capire cosa rende un sito usabile da tutti.":
        {"en": "The international accessibility guidelines: the reference for understanding what makes a site usable by everyone."},
    "Google — documentazione per la Ricerca":
        {"en": "Google — Search documentation"},
    "La base tecnica della SEO secondo Google: titoli, sitemap, indicizzazione, prima di ogni contenuto.":
        {"en": "Google's technical SEO basics: titles, sitemaps, indexing, before any content at all."},
    "Misura quante di queste sei aree copre il vostro sito, gratis →":
        {"en": "Measure how many of these six areas your site covers, for free →"},
    "Cosa include un sito aziendale fatto bene: la checklist in sei aree":
        {"en": "What a well-built business website includes: the checklist in six areas"},
    "Cosa include un sito aziendale fatto bene: le sei aree della checklist":
        {"en": "What a well-built business website includes: the six areas of the checklist"},
    "Vendere all’estero online: da dove iniziare":
        {"en": "Selling abroad online: where to start"},
    "Un’azienda manifatturiera bresciana fa il 40% del fatturato in Germania, ma il suo sito è solo in italiano — e i clienti tedeschi ordinano per telefono, quando va bene. Una guest house sul lago di Como riempie le stanze con ospiti stranieri, ma online si presenta in una lingua sola. È lo spreco silenzioso di tantissime PMI italiane: il prodotto è pronto per l’estero, il sito no. Vendere all’estero online non è tradurre la home con un plugin: serve uno strumento pensato per farsi trovare, capire e scegliere da chi vive in un altro mercato. Vediamo cosa serve davvero, e i casi reali del gruppo Remarka che l’hanno fatto — con numeri, non promesse.":
        {"en": "A manufacturing company near Brescia makes 40% of its revenue in Germany, but its site is only in Italian — and German customers order by phone, when things go well. A guest house on Lake Como fills its rooms with foreign guests, but presents itself online in a single language. It's the silent waste of so many Italian SMEs: the product is ready for export, the site isn't. Selling abroad online isn't translating the homepage with a plugin: it takes a tool built to be found, understood and chosen by someone living in another market. Let's look at what it really takes, and the real cases from the Remarka group that have done it — with numbers, not promises."},
    "Vendere all’estero online: cosa serve al sito — lingue native, SEO internazionale, pagamenti e fiducia oltre confine":
        {"en": "Selling abroad online: what a site needs — native languages, international SEO, payments and trust across borders"},
    "Shopify, WooCommerce o sviluppo su misura? Confronto onesto, senza classifiche di comodo, per capire quale piattaforma e-commerce scegliere in base al vostro negozio.":
        {"en": "Shopify, WooCommerce or custom development? An honest comparison, no convenient rankings, to work out which e-commerce platform to choose based on your shop."},
    "Una checklist prima di aprire un e-commerce, in cinque punti concreti: pagamenti, spedizioni, schede prodotto, velocità e obblighi legali. Cosa controllare prima di pubblicare il negozio.":
        {"en": "A checklist before opening an e-commerce site, in five concrete points: payments, shipping, product pages, speed and legal obligations. What to check before publishing the shop."},
    "Un sito bello non è per forza un sito che funziona. Cosa include davvero un sito aziendale fatto bene: sei aree, dalla parte tecnica invisibile a quella che si vede al primo sguardo.":
        {"en": "A good-looking site isn't automatically a site that works. What a well-built business website really includes: six areas, from the invisible technical side to the one you notice at first glance."},
    "Vendere all’estero online non è tradurre la home. Cosa serve davvero a un sito per l’export — lingue native, SEO internazionale, pagamenti e fiducia — e i casi reali che l’hanno fatto.":
        {"en": "Selling abroad online isn't translating the homepage. What a site really needs for export — native languages, international SEO, payments and trust — and the real cases that have done it."},
}
CHROME.update(CHROME_BLOG_GAP)
CHROME_BLOG_BATCH9 = {
    'In cima a Google ora c’è una risposta scritta dall’AI. Cosa sono gli AI Overviews di Google, perché cambiano i clic e come restare visibili quando a rispondere è la macchina.': {'en': 'At the top of Google there’s now an answer written by AI. What Google’s AI Overviews are, why they change clicks, and how to stay visible when a machine is the one answering.'},
    'Da marzo 2024 INP ha sostituito FID tra i Core Web Vitals. Cosa misura la nuova metrica, perché il vostro sito può «sembrare» veloce senza esserlo, e come si risolve.': {'en': 'Since March 2024, INP has replaced FID among the Core Web Vitals. What the new metric measures, why your site can “seem” fast without being fast, and how to fix it.'},
    'Inseguire 100 parole chiave diverse non funziona più. L’autorevolezza tematica (topical authority) — coprire bene un tema invece di spargersi — è ciò che Google premia. Come si costruisce.': {'en': 'Chasing 100 different keywords no longer works. Topical authority — covering a subject well instead of spreading yourself thin — is what Google rewards. Here’s how to build it.'},
    'I link interni sono la leva SEO più sottovalutata: gratis, sotto il vostro controllo, potente. Cosa fanno davvero, gli errori più comuni e come usarli per far salire le pagine giuste.': {'en': 'Internal links are the most underrated SEO lever: free, under your control, powerful. What they really do, the most common mistakes, and how to use them to push the right pages up.'},
    'Le immagini sono spesso il peso più grande di una pagina — e il primo freno alla velocità. Come ottimizzare le immagini del sito con WebP, lazy-load e le dimensioni giuste.': {'en': 'Images are often the biggest weight on a page — and the first brake on speed. How to optimize a site’s images with WebP, lazy-load and the right sizes.'},

    'Leggi anche: INP, la nuova metrica dei Core Web Vitals →': {'en': 'Read also: INP, the new Core Web Vitals metric →'},
    'Misura gratis peso e velocità del vostro sito →': {'en': 'Measure your site’s weight and speed for free →'},
    'Ottimizzare le immagini: WebP invece di JPEG, lazy-load sotto la piega, dimensioni giuste per LCP e CLS': {'en': 'Optimizing images: WebP instead of JPEG, lazy-load below the fold, correct sizes for LCP and CLS'},

    '23 LUG 2026': {'en': '23 JUL 2026'},

    # --- ai-overviews-google-restare-visibili ---
    'AI Overviews di Google: come restare visibili quando risponde l’AI': {'en': 'Google’s AI Overviews: how to stay visible when AI answers'},
    'AI Overviews di Google: come restare visibili quando a rispondere è l’AI': {'en': 'Google’s AI Overviews: how to stay visible when AI is the one answering'},
    'Fate una domanda su Google e, sempre più spesso, la prima cosa che leggete non è un link: è un paragrafo scritto dall’AI che riassume la risposta. Si chiamano AI Overviews, e stanno cambiando il modo in cui le persone trovano — o non trovano più — i siti. Per chi ha un sito la domanda è concreta e un po’ inquietante: se Google risponde da solo, qualcuno cliccherà ancora sul mio link? Vediamo cosa sono davvero gli AI Overviews di Google, cosa cambia per il traffico del vostro sito e, soprattutto, cosa potete fare per restare visibili quando in cima alla pagina risponde una macchina.': {'en': 'Ask Google a question and, more and more often, the first thing you read isn’t a link: it’s a paragraph written by AI that summarizes the answer. These are called AI Overviews, and they’re changing how people find — or no longer find — websites. If you run a website, the question is concrete and a little unsettling: if Google answers on its own, will anyone still click through to my link? Let’s look at what Google’s AI Overviews really are, what changes for your website’s traffic, and above all what you can do to stay visible when a machine answers at the top of the page.'},
    'Cosa sono gli AI Overviews di Google': {'en': 'What Google’s AI Overviews actually are'},
    'Gli AI Overviews sono i riquadri di risposta che Google genera automaticamente in cima ai risultati per molte domande. Al posto del solo elenco di link blu, compare un riassunto scritto dall’AI che mette insieme informazioni prese da più fonti, con qualche link di approfondimento a lato. Google li ha introdotti dopo una lunga fase di test — prima si chiamavano Search Generative Experience — e li sta estendendo a un numero crescente di lingue e Paesi.': {'en': 'AI Overviews are the answer boxes Google automatically generates at the top of results for many questions. Instead of just a list of blue links, an AI-written summary appears that pulls together information from multiple sources, with a few links to dig deeper alongside it. Google introduced them after a long testing phase — they used to be called Search Generative Experience — and is rolling them out to a growing number of languages and countries.'},
    'Non compaiono per tutte le ricerche. Google tende a mostrarli soprattutto per domande esplicative — «come funziona», «qual è la differenza tra», «perché» — dove un riassunto aiuta davvero, e molto meno per ricerche di navigazione o dichiaratamente commerciali. Capire quando compaiono è il primo passo: gli AI Overviews non sostituiscono la Ricerca, ne cambiano la parte alta per un certo tipo di domande.': {'en': 'They don’t show up for every search. Google tends to display them mainly for explanatory questions — “how does it work”, “what’s the difference between”, “why” — where a summary genuinely helps, and much less for navigational or clearly commercial searches. Understanding when they appear is the first step: AI Overviews don’t replace Search, they change the top of the page for a certain kind of question.'},
    'Cosa cambia per il traffico del vostro sito': {'en': 'What changes for your website’s traffic'},
    'Il timore legittimo si chiama «zero-click»: se la risposta è già lì, l’utente non clicca. Per certe domande semplici è vero, e una parte del traffico informativo più superficiale si assottiglierà. Ma è metà del quadro. L’altra metà è che chi vuole approfondire clicca proprio i link citati dentro l’Overview: essere una delle fonti citate diventa la nuova prima posizione. Il gioco non è più solo «arrivare primi», ma «essere la fonte che l’AI sceglie di riassumere e linkare».': {'en': 'The legitimate fear is called “zero-click”: if the answer is already there, the user doesn’t click. For certain simple questions that’s true, and some of the more superficial informational traffic will shrink. But that’s half the picture. The other half is that people who want to go deeper click exactly the links cited inside the Overview: being one of the cited sources becomes the new first position. The game is no longer just “arrive first” — it’s “be the source AI chooses to summarize and link”.'},
    'Cambia anche il tipo di visita. Chi arriva dopo aver letto un riassunto è più informato e più vicino alla decisione: meno clic, ma spesso più qualificati. Per questo ha poco senso inseguire il volume perso sulle domande banali; conviene puntare alle domande in cui la vostra competenza fa la differenza e dove una risposta automatica, da sola, non basta. Un test «sito pronto per l’AI» vi dice se le vostre pagine sono leggibili e citabili dai sistemi generativi.': {'en': 'The kind of visit changes too. Someone arriving after reading a summary is better informed and closer to a decision: fewer clicks, but often more qualified ones. That’s why it makes little sense to chase the lost volume on trivial questions; it’s worth aiming at the questions where your expertise makes the difference and where an automatic answer alone isn’t enough. An “AI-ready site” test tells you whether your pages are readable and citable by generative systems.'},
    'Verifica gratis se il vostro sito è leggibile e citabile dall’AI →': {'en': 'Check for free whether your site is readable and citable by AI →'},
    'Come restare visibili negli AI Overviews': {'en': 'How to stay visible in AI Overviews'},
    'La buona notizia è che non serve una SEO segreta per l’AI: Google stesso ha ripetuto che non esistono trucchi dedicati agli AI Overviews e che valgono le stesse regole dei contenuti di qualità. Un contenuto che risponde bene a una domanda reale, scritto da chi sa di cosa parla, ha le migliori probabilità di essere ripreso. Le solite fondamenta — contenuti utili e originali, esperienza dimostrata, chiarezza — contano più che mai, perché l’AI riassume ciò che trova affidabile.': {'en': 'The good news is that you don’t need secret AI-only SEO: Google itself has repeated that there are no dedicated tricks for AI Overviews, and that the same rules for quality content apply. Content that genuinely answers a real question, written by someone who knows the subject, has the best odds of being picked up. The usual fundamentals — helpful and original content, demonstrated experience, clarity — matter more than ever, because AI summarizes what it finds trustworthy.'},
    'In pratica: rispondete alla domanda presto e in modo diretto (una frase chiara nei primi paragrafi vale più di mille giri di parole), strutturate la pagina con titoli che ricalcano le domande vere e dimostrate competenza con dati, esempi e fonti verificabili. È l’approccio E-E-A-T: esperienza, competenza, autorevolezza, affidabilità. Non piacete all’AI fingendo; piacete essendo davvero la fonte migliore su quella domanda.': {'en': 'In practice: answer the question early and directly (one clear sentence in the opening paragraphs is worth more than a thousand roundabout words), structure the page with headings that mirror real questions, and back up your expertise with data, examples and verifiable sources. This is the E-E-A-T approach: experience, expertise, authoritativeness, trustworthiness. You don’t win AI over by faking it; you win by genuinely being the best source on that question.'},
    'La SEO tecnica che rende una pagina leggibile e citabile →': {'en': 'Technical SEO that makes a page readable and citable →'},
    'Dati strutturati e fonti: aiutare l’AI a fidarsi': {'en': 'Structured data and sources: helping AI trust you'},
    'Se volete che un sistema automatico capisca e citi correttamente la vostra pagina, aiutatelo a leggerla. I dati strutturati (Schema.org) descrivono in modo esplicito cosa c’è nella pagina — un articolo, un’azienda, un prodotto, una FAQ — e rendono più facile per Google collegare la vostra risposta alla domanda giusta. Non sono una scorciatoia magica verso l’Overview, ma tolgono ambiguità: la macchina lavora meglio quando il contenuto è pulito e ben etichettato.': {'en': 'If you want an automated system to understand and correctly cite your page, help it read it. Structured data (Schema.org) explicitly describes what’s on the page — an article, a company, a product, a FAQ — and makes it easier for Google to match your answer to the right question. It’s not a magic shortcut into the Overview, but it removes ambiguity: the machine works better when content is clean and well labeled.'},
    'Conta anche da dove viene ciò che scrivete. Un’affermazione con una fonte autorevole vicino pesa più di un’opinione buttata lì, per un lettore e per un sistema che deve decidere di chi fidarsi. Citare prime fonti, aggiornare le pagine e non gonfiare i testi con parole vuote è, allo stesso tempo, buona scrittura e buona SEO nell’era degli AI Overviews.': {'en': 'Where what you write comes from matters too. A claim backed by an authoritative source carries more weight than an opinion tossed out there — for a reader and for a system that has to decide whom to trust. Citing primary sources, keeping pages up to date and not padding text with empty words is, at the same time, good writing and good SEO in the age of AI Overviews.'},
    'L’anatomia di un risultato con AI Overview: in alto la risposta generata dall’AI, con le fonti citate a lato; sotto, i risultati organici di sempre. La nuova «prima posizione» è essere una delle fonti che l’AI sceglie di riassumere e linkare — non basta arrivare decimi, bisogna essere la risposta che merita di essere citata.': {'en': 'The anatomy of a result with an AI Overview: at the top, the AI-generated answer, with cited sources alongside it; below, the organic results as always. The new “first position” is being one of the sources AI chooses to summarize and link — finishing tenth isn’t enough, you have to be the answer that deserves to be cited.'},
    'Non è la fine della SEO, è un suo capitolo nuovo': {'en': 'This isn’t the end of SEO — it’s a new chapter of it'},
    'Gli AI Overviews spaventano perché mettono una risposta tra il vostro sito e chi cerca. Ma il meccanismo di fondo non cambia: Google premia chi risponde meglio a una domanda reale, e ora quella risposta può finire citata in cima. Chi ha costruito contenuti onesti e competenti parte avvantaggiato; chi campava di pagine sottili, ottimizzate per il motore e non per le persone, farà più fatica. Non è la fine della SEO: è la fine della SEO furba.': {'en': 'AI Overviews are unsettling because they put an answer between your site and the person searching. But the underlying mechanism hasn’t changed: Google rewards whoever answers a real question best, and now that answer can end up cited at the top. Whoever built honest, competent content starts ahead; whoever lived off thin pages optimized for the engine rather than for people will struggle more. This isn’t the end of SEO: it’s the end of clever SEO.'},
    'La nostra linea non è cambiata con l’arrivo dell’AI: costruiamo siti veloci, leggibili e onesti, dove ogni pagina risponde davvero a una domanda. È ciò che piace ai lettori, ai motori e — si scopre — anche alle macchine che ora riassumono il web. Il resto sono scorciatoie che invecchiano male.': {'en': 'Our approach hasn’t changed with the arrival of AI: we build fast, readable, honest websites, where every page genuinely answers a question. That’s what readers like, what engines like and — it turns out — what the machines that now summarize the web like too. Everything else is a shortcut that ages badly.'},
    'Leggi anche: autorevolezza tematica, perché un blog batte 100 keyword →': {'en': 'Read also: topical authority, why a blog beats 100 scattered keywords →'},
    'Google Search Central — funzioni AI nella Ricerca': {'en': 'Google Search Central — AI features in Search'},
    'La pagina ufficiale sulle funzioni generative: come Google usa l’AI nei risultati e cosa conta per comparirvi.': {'en': 'The official page on generative features: how Google uses AI in results and what matters for appearing in them.'},
    'Google Search Central — creare contenuti utili': {'en': 'Google Search Central — creating helpful content'},
    'Le stesse regole di sempre: contenuti utili, originali, fatti da chi sa. Google ribadisce che non ci sono trucchi per gli Overview.': {'en': 'The same rules as always: helpful, original content made by people who know the subject. Google reiterates there are no tricks for Overviews.'},
    'Google Search Essentials': {'en': 'Google Search Essentials'},
    'Le regole di base per essere trovati su Google: tecniche, di qualità e di spam. Il punto di partenza per ogni sito.': {'en': 'The basic rules for being found on Google: technical, quality and spam policies. The starting point for any website.'},
    'Google — Come funziona la Ricerca': {'en': 'Google — How Search Works'},
    'La spiegazione ufficiale di come Google trova, ordina e presenta le risposte: utile per capire dove nascono gli Overview.': {'en': 'The official explanation of how Google finds, ranks and presents answers: useful for understanding where Overviews come from.'},
    'Anatomia di un risultato Google con AI Overview: risposta AI in alto, fonti citate a lato, link organici sotto': {'en': 'Anatomy of a Google result with an AI Overview: AI answer at the top, cited sources alongside, organic links below'},

    # --- inp-metrica-core-web-vitals ---
    'INP, la nuova metrica dei Core Web Vitals: cosa misura e come si risolve': {'en': 'INP, the new Core Web Vitals metric: what it measures and how to fix it'},
    'INP, la nuova metrica dei Core Web Vitals: cosa misura la reattività di un sito': {'en': 'INP, the new Core Web Vitals metric: what it measures about a site’s responsiveness'},
    'Da marzo 2024 c’è una sigla in più da tenere d’occhio: INP. Ha preso il posto di un’altra metrica, FID, tra i Core Web Vitals di Google — i tre parametri con cui il motore misura l’esperienza reale di chi naviga. Il cambio non è cosmetico: molti siti che passavano l’esame con FID si ritrovano ora in difficoltà con INP, perché la nuova metrica è più severa e cattura problemi che prima restavano invisibili. Vediamo cosa misura davvero INP, perché il vostro sito può sembrare veloce e non superarla, e le mosse concrete per rientrare nei valori buoni.': {'en': 'Since March 2024 there’s one more acronym to keep an eye on: INP. It has taken the place of another metric, FID, among Google’s Core Web Vitals — the three parameters the engine uses to measure the real experience of people browsing. The change isn’t cosmetic: many sites that passed the test with FID now find themselves struggling with INP, because the new metric is stricter and catches problems that used to stay invisible. Let’s look at what INP actually measures, why your site can seem fast and still fail it, and the concrete steps to get back into good values.'},
    'Cos’è INP e perché ha sostituito FID': {'en': 'What INP is and why it replaced FID'},
    'INP sta per Interaction to Next Paint, «interazione fino al prossimo disegno». In parole semplici misura la reattività: quando toccate un pulsante, aprite un menu o scrivete in un campo, quanto tempo passa prima che lo schermo risponda mostrando il risultato. È una delle tre metriche dei Core Web Vitals, insieme a LCP (velocità di caricamento) e CLS (stabilità visiva).': {'en': 'INP stands for Interaction to Next Paint. In plain terms, it measures responsiveness: when you tap a button, open a menu or type in a field, how long it takes before the screen responds by showing the result. It’s one of the three Core Web Vitals metrics, alongside LCP (loading speed) and CLS (visual stability).'},
    'Fino al marzo 2024 la reattività si misurava con FID, che però guardava solo il ritardo della primissima interazione — e per giunta solo l’attesa iniziale, non l’intera risposta. INP è più onesta: osserva tutte le interazioni durante la visita e considera la più lenta, dall’inizio del tocco fino a quando la pagina mostra davvero il cambiamento. Per questo molti siti «promossi» con FID si scoprono ora lenti con INP: la nuova metrica misura ciò che l’utente sente davvero.': {'en': 'Until March 2024, responsiveness was measured with FID, which however only looked at the delay of the very first interaction — and, worse, only the initial wait, not the full response. INP is more honest: it looks at every interaction during the visit and takes the slowest one, from the start of the tap to when the page actually shows the change. That’s why many sites “passed” by FID now find themselves slow under INP: the new metric measures what the user actually feels.'},
    'Cosa misura davvero, e le soglie di Google': {'en': 'What it really measures, and Google’s thresholds'},
    'Le soglie sono chiare. Un INP sotto i 200 millisecondi è considerato buono: la pagina risponde in modo che l’utente percepisce come immediato. Tra 200 e 500 millisecondi c’è margine di miglioramento; sopra i 500 millisecondi l’esperienza è scadente e si nota, quel micro-ritardo fastidioso tra il clic e la reazione. Google valuta il 75° percentile: non basta che sia veloce «in media», deve esserlo per la grande maggioranza delle interazioni reali.': {'en': 'The thresholds are clear. An INP under 200 milliseconds is considered good: the page responds in a way the user perceives as instant. Between 200 and 500 milliseconds there’s room for improvement; above 500 milliseconds the experience is poor and noticeable — that annoying micro-delay between the click and the reaction. Google evaluates the 75th percentile: it’s not enough to be fast “on average”, it has to be fast for the vast majority of real interactions.'},
    'E qui sta il punto: reali. Google giudica i Core Web Vitals sui dati «sul campo», raccolti dagli utenti veri di Chrome (il Chrome UX Report), non sulle prove di laboratorio fatte una volta sola dal vostro computer nuovo su una connessione ottima. Ecco perché un test onesto guarda ai numeri del campo: è l’esperienza dei vostri visitatori con i loro telefoni e le loro reti, non quella ideale.': {'en': 'And here’s the point: real. Google judges Core Web Vitals on “field” data, collected from real Chrome users (the Chrome UX Report), not on one-off lab tests run from your brand-new computer on a great connection. That’s why an honest test looks at field numbers: it’s the experience of your visitors with their phones and their networks, not the ideal one.'},
    'Misura gratis i Core Web Vitals reali del vostro sito →': {'en': 'Measure your site’s real Core Web Vitals for free →'},
    'Perché un sito «sembra» veloce ma fallisce INP': {'en': 'Why a site can “seem” fast and still fail INP'},
    'Un sito può caricarsi in un lampo e poi impuntarsi al primo tocco. Il colpevole quasi sempre è lo stesso: troppo JavaScript che tiene occupato il «thread principale» del browser, quello che deve anche rispondere ai vostri clic. Se un pezzo di codice lavora a lungo senza pause, l’interazione resta in coda ad aspettare — e quel millisecondo di attesa è esattamente ciò che INP misura. Il caricamento è finito da un pezzo, ma la pagina «non risponde».': {'en': 'A site can load in a flash and then freeze up at the very first tap. The culprit is almost always the same: too much JavaScript keeping the browser’s “main thread” busy — the same thread that also has to respond to your clicks. If a piece of code runs for a long time without a break, the interaction sits queued up waiting — and that wait is exactly what INP measures. Loading finished a while ago, but the page “isn’t responding”.'},
    'Le cause tipiche sono note: script di terze parti pesanti (chat, banner, tracker, widget), temi e plugin che caricano librerie enormi anche dove non servono, gestori di eventi che fanno troppo lavoro a ogni clic. Sono cose che nei test di velocità classici, tutti concentrati sul caricamento, non emergevano. INP le porta a galla: misura il momento in cui l’utente prova a usare il sito, non solo quello in cui lo guarda comparire.': {'en': 'The typical causes are well known: heavy third-party scripts (chat widgets, banners, trackers, widgets), themes and plugins that load huge libraries even where they aren’t needed, event handlers that do too much work on every click. These are things that classic speed tests, all focused on loading, never surfaced. INP brings them out into the open: it measures the moment the user tries to use the site, not just the moment they watch it appear.'},
    'Come si risolve INP': {'en': 'How to fix INP'},
    'La strategia è una: alleggerire e spezzare il lavoro del browser. Ridurre il JavaScript inutile e caricare in ritardo ciò che non serve subito; spezzare le operazioni lunghe in pezzi brevi, così tra uno e l’altro il browser può rispondere ai tocchi; tenere sotto controllo gli script di terze parti, che spesso pesano più del sito stesso. Sono interventi tecnici, ma l’effetto lo sente chiunque: la pagina reagisce all’istante.': {'en': 'There’s one strategy: lighten and break up the browser’s workload. Cut unnecessary JavaScript and defer loading what isn’t needed right away; split long operations into short chunks, so the browser can respond to taps in between them; keep third-party scripts in check, since they often weigh more than the site itself. These are technical interventions, but everyone feels the effect: the page reacts instantly.'},
    'Il metodo giusto è misurare prima e dopo, sempre sui dati reali. Si parte identificando le interazioni più lente su smartphone (dove i processori sono più deboli e i problemi si vedono meglio), si interviene sul codice che le rallenta e si verifica che l’INP al 75° percentile scenda sotto la soglia buona. Non è magia: è togliere peso finché la pagina non risponde come dovrebbe.': {'en': 'The right method is to measure before and after, always on real data. You start by identifying the slowest interactions on smartphones (where processors are weaker and problems show up more clearly), fix the code that slows them down, and verify that INP at the 75th percentile drops below the good threshold. It isn’t magic: it’s removing weight until the page responds the way it should.'},
    'Le soglie di INP (Interaction to Next Paint), misurate al 75° percentile sugli utenti reali: buono sotto i 200 ms, da migliorare tra 200 e 500 ms, scadente oltre i 500 ms. INP misura il ritardo tra il tocco e la risposta visibile della pagina — la reattività che l’utente sente davvero. Il freno più comune è il JavaScript che tiene occupato il thread principale del browser.': {'en': 'INP (Interaction to Next Paint) thresholds, measured at the 75th percentile on real users: good under 200 ms, needs improvement between 200 and 500 ms, poor above 500 ms. INP measures the delay between the tap and the page’s visible response — the responsiveness the user actually feels. The most common brake is JavaScript keeping the browser’s main thread busy.'},
    'La reattività è un investimento, non un dettaglio': {'en': 'Responsiveness is an investment, not a detail'},
    'INP non è l’ennesima sigla per far felice Google: è la misura di una frustrazione concreta, quel mezzo secondo in cui il sito «non fa niente» dopo che l’avete toccato. Su mobile, dove ormai avviene la maggior parte delle visite, è la differenza tra un sito che sembra un’app e uno che sembra rotto. E siccome pesa sui Core Web Vitals, tocca anche il posizionamento: reattività e visibilità viaggiano insieme.': {'en': 'INP isn’t just another acronym to keep Google happy: it measures a very concrete frustration, that half-second where the site “does nothing” after you’ve tapped it. On mobile, where most visits happen these days, it’s the difference between a site that feels like an app and one that feels broken. And since it counts toward Core Web Vitals, it also affects rankings: responsiveness and visibility travel together.'},
    'Nei nostri progetti la reattività non è una toppa dell’ultimo minuto: nasce dalle scelte tecniche, meno codice inutile e script di terze parti tenuti a bada, fin dal primo giorno. Un sito veloce a caricarsi ma lento a rispondere è una promessa mantenuta a metà — e INP, finalmente, la mette nero su bianco.': {'en': 'In our projects, responsiveness isn’t a last-minute patch: it comes from technical choices — less unnecessary code and third-party scripts kept in check — from day one. A site that loads fast but responds slowly is a promise kept only halfway — and INP, finally, puts that in black and white.'},
    'La SEO tecnica che parte dalla velocità reale →': {'en': 'Technical SEO that starts from real speed →'},
    'Leggi anche: Core Web Vitals nel 2026, cosa misura Google →': {'en': 'Read also: Core Web Vitals in 2026, what Google measures →'},
    'Leggi anche: immagini e velocità, WebP e lazy-load →': {'en': 'Read also: images and speed, WebP and lazy-load →'},
    'La definizione ufficiale della metrica e delle sue soglie, con la spiegazione del passaggio da FID a INP nel 2024.': {'en': 'The official definition of the metric and its thresholds, explaining the shift from FID to INP in 2024.'},
    'web.dev — ottimizzare l’INP': {'en': 'web.dev — optimizing INP'},
    'La guida pratica per migliorare la reattività: ridurre e spezzare il lavoro del thread principale, gestire i gestori di eventi.': {'en': 'The practical guide to improving responsiveness: reducing and splitting main-thread work, managing event handlers.'},
    'Le tre metriche (LCP, INP, CLS), le soglie e perché contano: l’esperienza reale, non i numeri di laboratorio.': {'en': 'The three metrics (LCP, INP, CLS), their thresholds and why they matter: the real experience, not lab numbers.'},
    'La fonte dei dati «sul campo»: utenti reali di Chrome, su cui Google valuta i Core Web Vitals al 75° percentile.': {'en': 'The source of “field” data: real Chrome users, on whom Google evaluates Core Web Vitals at the 75th percentile.'},
    'Misura gratis i Core Web Vitals del vostro sito →': {'en': 'Measure your site’s Core Web Vitals for free →'},
    'Le tre soglie INP dei Core Web Vitals: buono sotto 200 ms, da migliorare 200–500 ms, scadente oltre 500 ms': {'en': 'The three INP thresholds in Core Web Vitals: good under 200 ms, needs improvement 200–500 ms, poor over 500 ms'},

    # --- autorevolezza-tematica-batte-keyword ---
    'Autorevolezza tematica: perché un blog batte 100 keyword sparse': {'en': 'Topical authority: why a blog beats 100 scattered keywords'},
    'Autorevolezza tematica (topical authority): coprire bene un tema batte cento keyword sparse': {'en': 'Topical authority: covering a subject well beats a hundred scattered keywords'},
    'C’è una vecchia idea di SEO dura a morire: fare una pagina per ogni parola chiave, riempire il sito di articoli scollegati, sperare che qualcuno ranki. Funzionava dieci anni fa. Oggi Google ragiona per temi, non per singole parole, e premia chi dimostra di sapere davvero di un argomento — coprendolo bene, in profondità — invece di chi ha sparso cento pagine sottili su cento parole diverse. Si chiama autorevolezza tematica, o topical authority, ed è la ragione per cui un blog fatto bene batte un elenco di keyword. Vediamo cos’è, perché lo spargersi non paga più e come si costruisce, pagina dopo pagina.': {'en': 'There’s an old SEO idea that refuses to die: make one page for every keyword, fill the site with disconnected articles, and hope something ranks. It worked ten years ago. Today Google thinks in terms of topics, not single words, and rewards whoever genuinely demonstrates knowledge of a subject — covering it well, in depth — over whoever has scattered a hundred thin pages across a hundred different words. It’s called topical authority, and it’s why a well-made blog beats a list of keywords. Let’s look at what it is, why spreading yourself thin no longer pays off, and how it’s built, page by page.'},
    'Cos’è l’autorevolezza tematica': {'en': 'What topical authority actually is'},
    'L’autorevolezza tematica è la reputazione che un sito costruisce su un argomento agli occhi di Google. Non è una metrica ufficiale con un punteggio da guardare: è il risultato di aver coperto un tema in modo ampio e coerente, tanto da diventare un riferimento. Un sito che tratta bene «siti multilingue», con dieci articoli che si tengono e si rimandano — costi, hreflang, export, traduzioni — dice a Google «di questo, qui, ne sappiamo». Una singola pagina isolata sullo stesso tema, no.': {'en': 'Topical authority is the reputation a site builds around a subject in Google’s eyes. It isn’t an official metric with a score to check: it’s the result of having covered a topic broadly and consistently enough to become a reference point. A site that covers “multilingual websites” well, with ten articles that hold together and link to one another — costs, hreflang, export, translations — tells Google “we know this subject, here”. A single isolated page on the same topic doesn’t.'},
    'L’idea di fondo è semplice e molto umana: ci si fida di chi conosce a fondo una materia, non di chi ne sa un pezzetto di tutto. Google prova a imitare questo giudizio. Più il vostro sito dimostra di padroneggiare un tema — rispondendo anche alle domande di contorno, non solo a quella principale — più diventa credibile quando ranka su quel tema. L’autorevolezza tematica è questa credibilità, guadagnata contenuto dopo contenuto.': {'en': 'The underlying idea is simple and very human: we trust someone who knows a subject deeply, not someone who knows a little bit of everything. Google tries to imitate that judgment. The more your site demonstrates mastery of a topic — answering the surrounding questions too, not just the main one — the more credible it becomes when it ranks on that topic. Topical authority is that credibility, earned piece of content by piece of content.'},
    'Perché 100 keyword sparse non funzionano più': {'en': 'Why 100 scattered keywords no longer work'},
    'La tentazione è capire quali parole cerca la gente e fare una pagina per ognuna. Il problema è che pagine nate così sono di solito sottili, ripetitive e scollegate: dieci articoli che dicono poco su dieci temi lontani non costruiscono autorità da nessuna parte. Google li legge per quello che sono — contenuti riempitivi — e li tratta di conseguenza. Peggio: spesso finiscono per farsi concorrenza tra loro sullo stesso motore, la cosiddetta cannibalizzazione.': {'en': 'The temptation is to figure out which words people search for and make one page for each. The problem is that pages born this way are usually thin, repetitive and disconnected: ten articles that say little about ten unrelated topics don’t build authority anywhere. Google reads them for what they are — filler content — and treats them accordingly. Worse: they often end up competing with each other on the same search engine, so-called keyword cannibalization.'},
    'Con il tempo Google si è attrezzato proprio contro questo. I suoi sistemi premiano i contenuti utili, fatti per le persone, e ridimensionano quelli creati «per il motore» — pagine costruite attorno a una keyword ma vuote di sostanza. Spargersi su cento parole senza padroneggiare nessun tema è la ricetta perfetta per non emergere da nessuna parte: tanto lavoro, poca autorità, risultati fragili.': {'en': 'Over time Google has specifically armed itself against this. Its systems reward helpful content made for people, and scale down content created “for the engine” — pages built around a keyword but empty of substance. Spreading yourself across a hundred words without mastering any single topic is the perfect recipe for not standing out anywhere: lots of work, little authority, fragile results.'},
    'Come si costruisce: il modello pillar-cluster': {'en': 'How it’s built: the pillar-cluster model'},
    'Il modo collaudato per costruire autorevolezza tematica si chiama pillar-cluster. Si sceglie un tema portante e gli si dedica una pagina «pilastro», ampia e curata, che lo inquadra tutto; intorno le ruotano gli articoli «satellite», ognuno su una sottodomanda specifica. Il pilastro dà il quadro d’insieme, i satelliti scavano nei dettagli, e tutti si linkano tra loro. Non cento pagine sparse, ma un grappolo coerente che copre un tema a 360 gradi.': {'en': 'The tried-and-tested way to build topical authority is called pillar-cluster. You choose a core subject and dedicate a broad, carefully written “pillar” page to it that frames the whole topic; around it revolve “satellite” articles, each on a specific sub-question. The pillar gives the big picture, the satellites dig into the details, and they all link to one another. Not a hundred scattered pages, but a coherent cluster that covers a topic from every angle.'},
    'Questa architettura fa due cose insieme. Per il lettore, rende facile approfondire: dalla panoramica scende ai dettagli senza uscire dal sito. Per Google, disegna una mappa chiara di competenza: «questo sito, di questo tema, ha coperto tutto». È l’opposto della lista di keyword: meno pagine, ma legate da un filo, che si rinforzano a vicenda invece di farsi concorrenza.': {'en': 'This architecture does two things at once. For the reader, it makes it easy to go deeper: from the overview down to the details without ever leaving the site. For Google, it draws a clear map of expertise: “this site has covered this topic completely”. It’s the opposite of a keyword list: fewer pages, but tied together by a thread, reinforcing each other instead of competing.'},
    'Il modello pillar-cluster che costruisce autorevolezza tematica: al centro una pagina «pilastro» che inquadra tutto il tema, intorno gli articoli «satellite» su ogni sottodomanda, tutti collegati fra loro dai link interni. Un grappolo coerente dice a Google «di questo argomento sappiamo tutto» — molto più di cento pagine sparse che non costruiscono autorità da nessuna parte.': {'en': 'The pillar-cluster model that builds topical authority: at the center, a “pillar” page framing the whole topic; around it, “satellite” articles on each sub-question, all connected by internal links. A coherent cluster tells Google “we know everything about this subject” — far more than a hundred scattered pages that build authority nowhere.'},
    'Link interni e coerenza: il collante': {'en': 'Internal links and consistency: the glue'},
    'Un grappolo di articoli non basta se restano isole. Il collante sono i link interni: ogni satellite rimanda al pilastro e agli altri satelliti pertinenti, con anchor che dicono di cosa parla la pagina di destinazione. Così Google capisce che quelle pagine formano un insieme e non una collezione casuale — e la relevance passa da una all’altra, rafforzando tutto il gruppo. È il tessuto connettivo dell’autorevolezza tematica.': {'en': 'A cluster of articles isn’t enough if they remain isolated islands. The glue is internal links: every satellite links back to the pillar and to other relevant satellites, with anchor text that says what the destination page is about. That way Google understands those pages form a whole, not a random collection — and relevance flows from one to another, strengthening the entire group. This is the connective tissue of topical authority.'},
    'Serve anche coerenza nel tempo. L’autorità tematica non si compra in una settimana: si accumula pubblicando con costanza, aggiornando le pagine che invecchiano, riempiendo i buchi del tema mano a mano che emergono le domande. Uno strumento di analisi on-page vi aiuta a vedere se una pagina è ben collegata al resto del cluster o se è rimasta orfana, tagliata fuori dal grappolo.': {'en': 'Consistency over time matters too. Topical authority can’t be bought in a week: it accumulates by publishing steadily, updating pages as they age, and filling the gaps in the topic as new questions emerge. An on-page analysis tool helps you see whether a page is well connected to the rest of the cluster or has been left orphaned, cut off from the group.'},
    'Analisi SEO on-page gratuita: vedete se la pagina è ben collegata →': {'en': 'Free on-page SEO analysis: see whether the page is well connected →'},
    'Leggi anche: link interni, la SEO gratis che quasi nessuno cura →': {'en': 'Read also: internal links, the free SEO almost nobody looks after →'},
    'Meno pagine, più padronanza': {'en': 'Fewer pages, more mastery'},
    'Il cambio di mentalità è tutto qui: smettere di chiedersi «quante keyword posso coprire» e iniziare a chiedersi «di quale tema voglio diventare un riferimento». La prima domanda porta a un sito largo e piatto; la seconda a un sito profondo e credibile. Google, e sempre più anche i sistemi che riassumono il web, premiano il secondo. La quantità non fa autorità: la fa la padronanza dimostrata.': {'en': 'The shift in mindset comes down to this: stop asking “how many keywords can I cover” and start asking “which subject do I want to become a reference for”. The first question leads to a wide, shallow site; the second to a deep, credible one. Google — and increasingly the systems that summarize the web too — rewards the second. Quantity doesn’t build authority: demonstrated mastery does.'},
    'È l’approccio con cui costruiamo i contenuti dei siti che seguiamo: pochi temi, coperti bene, con una struttura che li tiene insieme. Un blog così non è un magazzino di articoli, è la prova documentata che sapete di cosa parlate. E questa, agli occhi di Google e dei clienti, vale più di cento parole chiave inseguite a caso.': {'en': 'It’s the approach we use to build content for the sites we run: few subjects, covered well, with a structure that holds them together. A blog like this isn’t a warehouse of articles — it’s documented proof that you know what you’re talking about. And in the eyes of Google and of clients, that’s worth more than a hundred keywords chased at random.'},
    'La SEO tecnica che dà struttura ai vostri contenuti →': {'en': 'Technical SEO that gives structure to your content →'},
    'Il documento chiave: Google premia i contenuti fatti per le persone e ridimensiona quelli creati «per il motore».': {'en': 'The key document: Google rewards content made for people and scales down content created “for the engine”.'},
    'Le regole di base per essere trovati: qualità, tecnica e spam. La cornice dentro cui costruire autorità tematica.': {'en': 'The basic rules for being found: quality, technical and spam policies. The framework within which to build topical authority.'},
    'Come Google valuta rilevanza e qualità delle pagine: capire il giudizio del motore aiuta a coprire un tema per bene.': {'en': 'How Google evaluates the relevance and quality of pages: understanding the engine’s judgment helps you cover a topic properly.'},
    'Google Search Central — dati strutturati': {'en': 'Google Search Central — structured data'},
    'Aiutare Google a capire di cosa parla ogni pagina: un tassello della chiarezza che sostiene l’autorevolezza tematica.': {'en': 'Helping Google understand what each page is about: one piece of the clarity that underpins topical authority.'},
    'Analisi SEO on-page gratuita della vostra pagina →': {'en': 'Free on-page SEO analysis of your page →'},
    'Modello pillar-cluster: una pagina pilastro al centro collegata agli articoli satellite del tema': {'en': 'Pillar-cluster model: a central pillar page linked to the topic’s satellite articles'},

    # --- link-interni-seo-gratis ---
    'Link interni: la SEO gratis che quasi nessuno cura': {'en': 'Internal links: the free SEO almost nobody looks after'},
    'Link interni per la SEO: la leva gratuita e sotto controllo che quasi nessuno cura': {'en': 'Internal links for SEO: the free, fully controllable lever almost nobody looks after'},
    'C’è una leva SEO che non costa niente, è interamente sotto il vostro controllo e la maggior parte dei siti la spreca: i link interni, cioè i collegamenti da una pagina all’altra dentro lo stesso sito. Niente budget, niente attese, niente da mendicare a siti esterni — bastano decisioni sensate su cosa collegare a cosa. Eppure quasi nessuno li cura: si scrive un articolo, lo si pubblica e lo si lascia lì, isolato. Vediamo cosa fanno davvero i link interni per la SEO, gli errori più comuni e come usarli per spingere in alto le pagine che contano.': {'en': 'There’s an SEO lever that costs nothing, is entirely under your control, and most sites waste it: internal links — the connections from one page to another within the same site. No budget, no waiting, nothing to beg external sites for — just sensible decisions about what to link to what. And yet almost nobody looks after them: an article gets written, published, and left there, isolated. Let’s look at what internal links really do for SEO, the most common mistakes, and how to use them to push the pages that matter higher.'},
    'Cosa fanno davvero i link interni': {'en': 'What internal links really do'},
    'I link interni fanno tre cose, tutte importanti. La prima: aiutano Google a scoprire le pagine. Il motore si muove seguendo i collegamenti; una pagina che nessuno linka dall’interno è difficile da trovare e da indicizzare — è come una stanza senza porte. La seconda: dicono a Google di cosa parla la pagina di destinazione, attraverso l’anchor, cioè le parole cliccabili del link. «Guida ai Core Web Vitals» spiega molto più di «clicca qui».': {'en': 'Internal links do three things, all important. The first: they help Google discover pages. The engine moves by following links; a page nobody links to internally is hard to find and hard to index — it’s like a room with no doors. The second: they tell Google what the destination page is about, through the anchor text, the clickable words of the link. “Guide to Core Web Vitals” explains far more than “click here”.'},
    'La terza, la più sottovalutata: distribuiscono autorevolezza. Le pagine più forti del sito — la home, gli articoli che ricevono link da fuori — accumulano valore agli occhi di Google, e con i link interni potete convogliare parte di quel valore verso le pagine che volete far salire. Un link interno ben piazzato è un voto che date voi, dalla pagina forte a quella che conta: gratis, e sotto il vostro controllo.': {'en': 'The third, the most underrated: they distribute authority. The strongest pages on the site — the homepage, articles that receive links from outside — accumulate value in Google’s eyes, and with internal links you can channel part of that value toward the pages you want to push up. A well-placed internal link is a vote you cast yourself, from a strong page to one that matters: free, and under your control.'},
    'Il primo errore sono le pagine orfane: articoli e schede che non ricevono nessun link interno. Esistono, ma è come se non esistessero — Google fatica a raggiungerle e non capisce quanto contino. Il secondo errore sono gli anchor vaghi: «clicca qui», «leggi tutto», «questo articolo». Sprecano l’occasione di dire a Google (e all’utente) dove sta portando il link. L’anchor è un cartello: scrivetelo con le parole giuste.': {'en': 'The first mistake is orphan pages: articles and pages that receive no internal links at all. They exist, but it’s as if they didn’t — Google struggles to reach them and doesn’t understand how much they matter. The second mistake is vague anchor text: “click here”, “read more”, “this article”. They waste the chance to tell Google (and the user) where the link is taking them. The anchor is a signpost: write it with the right words.'},
    'Il terzo errore è puntare tutto verso la home. Molti mettono link solo alla pagina principale, che di solito è già la più forte, e lasciano a secco le pagine interne — proprio quelle che avrebbero bisogno di una spinta. Il quarto è la pigrizia: pubblicare senza mai chiedersi «quali altre pagine del sito c’entrano con questa?». I link interni non si fanno da soli; vanno pensati, un articolo alla volta.': {'en': 'The third mistake is pointing everything at the homepage. Many sites only link to the main page, which is usually already the strongest, and leave inner pages high and dry — exactly the ones that would need a boost. The fourth is laziness: publishing without ever asking “which other pages on the site relate to this one?”. Internal links don’t happen by themselves; they need to be thought through, one article at a time.'},
    'Come usarli bene': {'en': 'How to use them well'},
    'Poche regole cambiano tutto. Anchor descrittivi, che contengano le parole con cui la pagina di destinazione vuole essere trovata — mai «clicca qui». Link contestuali, dentro il testo, dove il collegamento ha senso per chi legge, non ammucchiati in fondo. E una direzione precisa: dalle pagine forti verso quelle che volete spingere, così l’autorevolezza scorre dove serve. Ogni volta che pubblicate qualcosa, chiedetevi da quali pagine esistenti dovrebbe ricevere un link.': {'en': 'A few rules change everything. Descriptive anchor text, containing the words the destination page wants to be found for — never “click here”. Contextual links, inside the text, where the connection makes sense to the reader, not piled up at the bottom. And a clear direction: from strong pages toward the ones you want to push, so authority flows where it’s needed. Every time you publish something, ask yourself which existing pages it should receive a link from.'},
    'Vale anche il verso opposto: la pagina nuova deve linkare le pagine pertinenti già presenti, per tenere il lettore dentro il sito e legare i contenuti in un tema coerente. Non serve esagerare — pochi link giusti valgono più di venti a caso — ma nessuna pagina dovrebbe restare un’isola. Un’analisi on-page vi mostra in pochi secondi le pagine orfane e gli anchor da sistemare.': {'en': 'The reverse holds too: the new page should link to relevant pages that already exist, to keep the reader on the site and tie the content into a coherent topic. There’s no need to overdo it — a few well-chosen links are worth more than twenty random ones — but no page should remain an island. An on-page analysis shows you in seconds the orphan pages and the anchors that need fixing.'},
    'Come funzionano i link interni: le pagine forti (home, articoli con link esterni) accumulano autorevolezza e, con un link interno ben piazzato, la convogliano verso le pagine da spingere. La regola d’oro è l’anchor descrittivo — «guida ai Core Web Vitals», non «clicca qui» — e nessuna pagina orfana, tagliata fuori dal resto del sito.': {'en': 'How internal links work: strong pages (homepage, articles with external links) accumulate authority and, with a well-placed internal link, channel it toward the pages you want to push. The golden rule is descriptive anchor text — “guide to Core Web Vitals”, not “click here” — and no orphan pages, cut off from the rest of the site.'},
    'Link interni e architettura del sito': {'en': 'Internal links and site architecture'},
    'I link interni non sono un lavoretto da fare a fine articolo: sono l’ossatura di come il sito è organizzato. Un buon impianto raggruppa le pagine per tema e le collega in modo che, dalla più generale, si scenda naturalmente verso le più specifiche e viceversa. È lo stesso principio che regge l’autorevolezza tematica: un grappolo di pagine legate batte una collezione di isole. I link interni sono i fili di quel grappolo.': {'en': 'Internal links aren’t a chore to tack on at the end of an article: they’re the skeleton of how the site is organized. A good structure groups pages by topic and connects them so that, from the most general, you naturally move down to the most specific and back. It’s the same principle behind topical authority: a cluster of connected pages beats a collection of islands. Internal links are the threads of that cluster.'},
    'C’è anche un guadagno immediato per le persone, non solo per Google: un sito ben collegato è un sito in cui si trova ciò che si cerca. Le visite durano di più, si vedono più pagine, e chi arriva per una domanda scopre le risposte vicine. La SEO e l’esperienza d’uso, qui, coincidono: curare i link interni migliora entrambe, senza spendere un euro in più.': {'en': 'There’s an immediate benefit for people too, not just for Google: a well-connected site is one where visitors find what they’re looking for. Visits last longer, more pages get seen, and someone arriving with one question discovers nearby answers. SEO and user experience coincide here: looking after internal links improves both, without spending an extra cent.'},
    'Analisi SEO on-page gratuita della vostra pagina →': {'en': 'Free on-page SEO analysis of your page →'},
    'La spinta che avete già in casa': {'en': 'The boost you already have at home'},
    'I link interni sono la SEO più democratica che esista: non dipendono dal budget né dalla benevolenza di altri siti, solo dall’attenzione. Eppure restano il capitolo più trascurato, forse proprio perché sono gratis e nessuno li vende. Curarli è una delle poche cose che potete fare oggi, sulle pagine che avete già, per far salire le posizioni senza scrivere una riga di codice nuova.': {'en': 'Internal links are the most democratic SEO there is: they don’t depend on budget or on other sites’ goodwill, only on attention. And yet they remain the most neglected chapter, perhaps precisely because they’re free and nobody sells them. Looking after them is one of the few things you can do today, on the pages you already have, to move up in rankings without writing a single new line of code.'},
    'Nei siti che costruiamo i link interni non sono un pensiero dell’ultimo minuto: nascono dall’architettura, dal modo in cui i contenuti sono raggruppati e collegati fin dall’inizio. È la spinta che avete già in casa — basta ricordarsi di usarla.': {'en': 'In the sites we build, internal links aren’t a last-minute afterthought: they come from the architecture, from how content is grouped and connected from the very start. It’s the boost you already have at home — you just need to remember to use it.'},
    'La SEO tecnica che parte da un’architettura ben collegata →': {'en': 'Technical SEO that starts from a well-connected architecture →'},
    'Google Search Central — rendere i link esplorabili': {'en': 'Google Search Central — making links crawlable'},
    'Come Google segue i link e perché un collegamento ben fatto (anchor incluso) aiuta a scoprire e capire le pagine.': {'en': 'How Google follows links and why a well-made link (anchor text included) helps it discover and understand pages.'},
    'Google Search Central — guida SEO di base': {'en': 'Google Search Central — SEO starter guide'},
    'La guida ufficiale per chi parte: struttura del sito, link interni e anchor descrittivi tra i fondamentali.': {'en': 'The official guide for beginners: site structure, internal links and descriptive anchor text among the fundamentals.'},
    'Le regole di base per essere trovati su Google: una buona rete di link interni è parte della salute tecnica del sito.': {'en': 'The basic rules for being found on Google: a good internal-link network is part of a site’s technical health.'},
    'Web Almanac — HTTP Archive': {'en': 'Web Almanac — HTTP Archive'},
    'Il rapporto annuale sullo stato del web da milioni di siti reali: dati su struttura, link e salute delle pagine.': {'en': 'The annual report on the state of the web drawn from millions of real sites: data on structure, links and page health.'},
    'Analisi SEO on-page gratuita: vedete i vostri link interni →': {'en': 'Free on-page SEO analysis: see your internal links →'},
    'Link interni: dalle pagine forti verso le pagine da spingere, con anchor descrittivi invece di «clicca qui»': {'en': 'Internal links: from strong pages toward the ones you want to push, with descriptive anchors instead of “click here”'},

    # --- immagini-velocita-webp-lazy-load ---
    'Immagini e velocità: WebP, lazy-load e Core Web Vitals': {'en': 'Images and speed: WebP, lazy-load and Core Web Vitals'},
    'Ottimizzare le immagini del sito: WebP, lazy-load e dimensioni giuste per la velocità': {'en': 'Optimizing website images: WebP, lazy-load and the right sizes for speed'},
    'Se il vostro sito è lento, con ogni probabilità la colpa più grossa ce l’hanno le immagini. Su gran parte delle pagine sono il contenuto che pesa di più, molto più del testo o del codice: una sola foto caricata a piena risoluzione può pesare quanto decine di pagine scritte. La buona notizia è che le immagini sono anche il punto dove ottimizzare rende di più e costa meno: il formato giusto, il caricamento pigro e le dimensioni corrette bastano a trasformare una pagina lenta in una svelta. Vediamo come ottimizzare le immagini del sito con WebP, lazy-load e un occhio ai Core Web Vitals.': {'en': 'If your site is slow, chances are images carry most of the blame. On most pages they’re the heaviest content by far, much more than text or code: a single photo loaded at full resolution can weigh as much as dozens of written pages. The good news is that images are also the point where optimizing pays off the most and costs the least: the right format, lazy loading and correct sizing are enough to turn a slow page into a fast one. Let’s look at how to optimize a site’s images with WebP, lazy-load and an eye on Core Web Vitals.'},
    'Perché le immagini pesano così tanto': {'en': 'Why images weigh so much'},
    'Aprite una pagina qualsiasi e, quasi sempre, la parte più pesante da scaricare sono le immagini. I rapporti sullo stato del web lo confermano da anni: sono in cima alla classifica dei byte trasferiti, spesso più di tutto il resto messo insieme. Il motivo è banale — una foto ricca di dettagli contiene un’enorme quantità di informazione — ma le conseguenze no: ogni megabyte in più è tempo di attesa, soprattutto per chi naviga da smartphone con una rete lenta.': {'en': 'Open any page and, almost always, the heaviest thing to download is the images. State-of-the-web reports have confirmed this for years: they’re at the top of the ranking for bytes transferred, often more than everything else combined. The reason is simple — a detail-rich photo contains an enormous amount of information — but the consequences aren’t: every extra megabyte is waiting time, especially for someone browsing from a smartphone on a slow network.'},
    'Il guaio è che molte immagini sono più pesanti del necessario, per pura disattenzione. Foto caricate a 4000 pixel di larghezza e poi mostrate in un riquadro da 400; formati vecchi e ingombranti dove ne basterebbe uno moderno; nessuna compressione. È peso morto: informazione che l’utente non vedrà mai, ma che il suo telefono deve comunque scaricare. Ottimizzare le immagini vuol dire togliere questo peso inutile, senza che si veda la differenza.': {'en': 'The trouble is that many images are heavier than they need to be, out of pure oversight. Photos uploaded at 4000 pixels wide and then shown in a 400-pixel box; old, bulky formats where a modern one would do; no compression. It’s dead weight: information the user will never see, but that their phone still has to download. Optimizing images means removing that unnecessary weight without any visible difference.'},
    'WebP (e AVIF): il formato giusto': {'en': 'WebP (and AVIF): the right format'},
    'Il primo intervento è cambiare formato. I vecchi JPEG e PNG funzionano, ma pesano: i formati moderni come WebP — e il più recente AVIF — offrono la stessa qualità visiva occupando molto meno spazio, spesso il 25-35% in meno rispetto a un JPEG equivalente, a volte molto di più. Per l’occhio non cambia nulla; per il tempo di caricamento è una differenza enorme. Oggi WebP è supportato da tutti i browser diffusi: non c’è più ragione di spedire file inutilmente grandi.': {'en': 'The first step is changing format. Old JPEGs and PNGs work, but they’re heavy: modern formats like WebP — and the more recent AVIF — offer the same visual quality while taking up much less space, often 25-35% less than an equivalent JPEG, sometimes a lot more. To the eye, nothing changes; for loading time, it’s a huge difference. Today WebP is supported by every major browser: there’s no longer a reason to ship needlessly large files.'},
    'Il bello è che non serve rifare le foto: si convertono quelle esistenti, idealmente in modo automatico quando vengono caricate, servendo il formato moderno a chi lo supporta. È uno degli interventi con il miglior rapporto tra fatica e risultato: si tocca il file, non il design, e la pagina si alleggerisce di colpo. La compressione, dosata bene, fa il resto senza intaccare la nitidezza percepita.': {'en': 'The nice part is that you don’t need to redo the photos: you convert the existing ones, ideally automatically on upload, serving the modern format to whoever supports it. It’s one of the interventions with the best ratio of effort to result: you touch the file, not the design, and the page instantly gets lighter. Well-tuned compression does the rest without denting the perceived sharpness.'},
    'Misura gratis peso della pagina e velocità del vostro sito →': {'en': 'Measure your page weight and site speed for free →'},
    'Lazy-load: caricare solo ciò che serve': {'en': 'Lazy-load: loading only what’s needed'},
    'La seconda mossa è non caricare tutto subito. Quando aprite una pagina lunga, le immagini in fondo — quelle che vedrete solo scorrendo, se scorrerete — non servono nel primo istante. Il lazy-load («caricamento pigro») le rinvia: il browser scarica prima ciò che è visibile e carica il resto solo quando l’utente si avvicina. Il risultato è una pagina che appare pronta molto prima, perché non aspetta immagini che nessuno sta ancora guardando.': {'en': 'The second move is not loading everything at once. When you open a long page, the images further down — the ones you’ll only see if you scroll, and only if you do — aren’t needed in the first instant. Lazy-load defers them: the browser downloads what’s visible first and loads the rest only as the user gets close to it. The result is a page that appears ready much sooner, because it doesn’t wait for images nobody is looking at yet.'},
    'Oggi il lazy-load è quasi gratis da attivare: basta un attributo standard sull’immagine, `loading="lazy"`, e i browser fanno il resto. Attenzione a una sola cosa: non va messo sull’immagine più importante in cima alla pagina, quella che l’utente vede subito — rinviarla peggiorerebbe la velocità percepita invece di migliorarla. Il lazy-load è per ciò che sta sotto la piega, non per il protagonista.': {'en': 'Today lazy-load is almost free to turn on: just a standard attribute on the image, `loading="lazy"`, and browsers do the rest. Watch out for one thing: it shouldn’t go on the most important image at the top of the page, the one the user sees right away — deferring it would make perceived speed worse instead of better. Lazy-load is for what’s below the fold, not for the star of the page.'},
    'Dimensioni giuste e Core Web Vitals': {'en': 'The right sizes and Core Web Vitals'},
    'Terzo pilastro: servire ogni immagine nella misura in cui verrà mostrata. Non ha senso mandare una foto da 3000 pixel a uno schermo che ne mostrerà 600. Le tecniche per farlo — immagini responsive che adattano la risoluzione al dispositivo — evitano di scaricare pixel che nessuno vedrà. E vanno sempre indicate larghezza e altezza dell’immagine, così il browser riserva lo spazio in anticipo e la pagina non «salta» mentre carica: quel salto ha persino una metrica, il CLS dei Core Web Vitals.': {'en': 'The third pillar: serve every image at the size it will actually be shown at. There’s no point sending a 3000-pixel photo to a screen that will display 600. The techniques for this — responsive images that adapt resolution to the device — avoid downloading pixels nobody will see. And you should always specify the image’s width and height, so the browser reserves the space in advance and the page doesn’t “jump” while loading: that jump even has its own metric, the CLS in Core Web Vitals.'},
    ...
    'Le tre leve per ottimizzare le immagini di un sito: il formato moderno (WebP o AVIF al posto di JPEG/PNG, fino al 25-35% in meno di peso), il lazy-load per ciò che sta sotto la piega (mai per l’immagine principale in cima), e le dimensioni giuste servite al dispositivo — con larghezza e altezza dichiarate per non far «saltare» la pagina. Insieme migliorano LCP e CLS, due dei tre Core Web Vitals.': {'en': 'The three levers for optimizing a site’s images: the modern format (WebP or AVIF instead of JPEG/PNG, up to 25-35% less weight), lazy-load for what’s below the fold (never for the main image at the top), and the right sizes served to the device — with width and height declared so the page doesn’t “jump”. Together they improve LCP and CLS, two of the three Core Web Vitals.'},
    'Leggere, non pesare': {'en': 'Light, not heavy'},
    'Ottimizzare le immagini non è un vezzo da tecnici: è il modo più rapido e concreto di rendere un sito veloce, e quindi più gradito ai visitatori e a Google. Formato moderno, caricamento pigro, dimensioni giuste: tre interventi che non toccano il design ma cambiano l’esperienza, soprattutto su mobile e su reti lente — cioè per la maggioranza delle persone che oggi vi visitano.': {'en': 'Optimizing images isn’t some technical whim: it’s the fastest, most concrete way to make a site fast, and therefore more welcome to visitors and to Google. Modern format, lazy loading, correct sizing: three interventions that don’t touch the design but change the experience, especially on mobile and slow networks — that is, for the majority of people visiting you today.'},
    'Nei siti che costruiamo le immagini vengono trattate così di serie: convertite nei formati moderni, servite nella misura giusta, con il lazy-load dove serve. Non è un extra da vendere a parte, è il minimo perché una pagina piena di foto resti leggera. Un sito bello ma pesante non è un bel sito: è una pagina che i visitatori non aspettano di vedere caricare.': {'en': 'In the sites we build, images are treated this way by default: converted to modern formats, served at the right size, with lazy-load where it’s needed. It isn’t an extra to sell separately, it’s the minimum for a page full of photos to stay light. A site that’s beautiful but heavy isn’t a good site: it’s a page visitors won’t wait to see load.'},
    'Restyling e migrazione: rimettere in forma un sito lento →': {'en': 'Redesign and migration: getting a slow site back into shape →'},
    'web.dev — Learn Images (Google)': {'en': 'web.dev — Learn Images (Google)'},
    'Il corso ufficiale sulle immagini per il web: formati, compressione, immagini responsive. Pratico e aggiornato.': {'en': 'The official course on images for the web: formats, compression, responsive images. Practical and up to date.'},
    'web.dev — servire immagini in WebP': {'en': 'web.dev — serving images in WebP'},
    'Perché e come usare WebP: la stessa qualità visiva con file molto più leggeri dei vecchi JPEG e PNG.': {'en': 'Why and how to use WebP: the same visual quality with files much lighter than old JPEGs and PNGs.'},
    'MDN — Lazy loading': {'en': 'MDN — Lazy loading'},
    'La guida di riferimento al caricamento pigro: come funziona l’attributo loading="lazy" e quando (non) usarlo.': {'en': 'The reference guide to lazy loading: how the loading="lazy" attribute works and when (not) to use it.'},
    'La metrica dei Core Web Vitals più legata alle immagini: spesso è la foto in cima a decidere il vostro LCP.': {'en': 'The Core Web Vitals metric most tied to images: often it’s the photo at the top that decides your LCP.'},
}
CHROME.update(CHROME_BLOG_BATCH9)

CHROME_BLOG_BATCH10 = {
    'SEO locale a Roma: come emergere nella capitale dei servizi': {'en': 'Local SEO in Rome: how to stand out in the capital of services'},
    'Uno studio legale ai Parioli, un fisioterapista a San Giovanni, un B&B a pochi passi dal Colosseo: a Roma ognuno di loro compete con altri venti nel raggio di un chilometro. E quando qualcuno cerca «commercialista vicino a me» o «hotel centro Roma» dal telefono, non scorre dieci pagine di risultati — guarda i primi tre nella mappa e sceglie lì. La SEO locale a Roma è la disciplina che decide chi finisce in quei tre posti. Non è magia né questione di budget: è un lavoro fatto di segnali precisi che quasi nessuno cura fino in fondo. Vediamo come funziona davvero nella capitale dei servizi, cosa pesa nel ranking e da dove partire.': {'en': 'A law firm in Parioli, a physiotherapist in San Giovanni, a B&B a stone’s throw from the Colosseum: in Rome each of them competes with another twenty within a one-kilometre radius. And when someone searches «accountant near me» or «hotel Rome centre» from their phone, they don’t scroll through ten pages of results — they look at the first three on the map and choose there. Local SEO in Rome is the discipline that decides who ends up in those three spots. It’s not magic nor a matter of budget: it’s work made of precise signals that almost nobody looks after all the way. Let’s see how it really works in the capital of services, what weighs in the ranking and where to start.'},
    'Perché a Roma la SEO locale è una gara di servizi': {'en': 'Why in Rome local SEO is a contest of services'},
    'Roma non è la città della manifattura: è la capitale dei servizi, delle professioni e del turismo. Nella provincia risultano oltre 444.000 imprese registrate — di cui più di 190.000 nei soli servizi, secondo la Camera di Commercio di Roma — e questo cambia le regole del gioco online. Qui il sito non è una brochure: è la reception, il primo preventivo, la prima impressione. E chi vende un servizio si gioca tutto sulla fiducia e sulla vicinanza, esattamente le due cose che la SEO locale mette in campo.': {'en': 'Rome isn’t the city of manufacturing: it’s the capital of services, of the professions and of tourism. The province has over 444,000 registered businesses — of which more than 190,000 in services alone, according to the Rome Chamber of Commerce — and this changes the rules of the online game. Here the website isn’t a brochure: it’s the reception desk, the first quote, the first impression. And whoever sells a service stakes everything on trust and proximity, exactly the two things local SEO puts into play.'},
    'A questo si aggiunge il turismo: Roma ha registrato 51,4 milioni di presenze nel 2024, un record storico. Per ogni B&B, ristorante o guida, comparire quando un turista cerca dal telefono «dove mangiare vicino a Trastevere» vale più di dieci campagne. Farsi trovare per «avvocato Roma» in senso generico serve a poco se non si compare quando qualcuno, a due fermate di metro, cerca proprio in quel momento. La SEO locale non punta al primo posto nazionale: punta a essere il più rilevante per chi è vicino, adesso.': {'en': 'On top of this comes tourism: Rome recorded 51.4 million overnight stays in 2024, an all-time record. For every B&B, restaurant or guide, appearing when a tourist searches from their phone «where to eat near Trastevere» is worth more than ten campaigns. Being found for «lawyer Rome» in a generic sense does little if you don’t show up when someone, two metro stops away, is searching right at that moment. Local SEO doesn’t aim for first place nationwide: it aims to be the most relevant to whoever is nearby, now.'},
    'Il local pack: i tre posti che a Roma valgono oro': {'en': 'The local pack: the three spots that are worth gold in Rome'},
    'Il campo di battaglia ha un nome preciso: il «local pack», quel blocco con la mappa e tre attività che Google mostra in cima ai risultati a intento locale. Sotto ci sono i link classici, ma l’occhio — soprattutto da mobile — cade lì. In una città affollata come Roma, entrare in quei tre riquadri vale più di dieci posizioni organiche: è la vetrina che il cliente vede prima di tutto il resto.': {'en': 'The battlefield has a precise name: the «local pack», that block with the map and three businesses that Google shows at the top of results with local intent. Below it are the classic links, but the eye — especially on mobile — falls there. In a city as crowded as Rome, getting into those three boxes is worth more than ten organic positions: it’s the storefront the customer sees before anything else.'},
    'Google è insolitamente esplicito su come sceglie chi mostrare. Nella sua guida ufficiale al ranking locale indica tre fattori — rilevanza, distanza e prominenza — e vale la pena conoscerli perché su tutti e tre si può lavorare. La distanza da chi cerca non la controllate, ma la potete assecondare con un indirizzo esatto e una zona di servizio dichiarata; la rilevanza e la prominenza, invece, si costruiscono.': {'en': 'Google is unusually explicit about how it chooses who to show. In its official guide to local ranking it points to three factors — relevance, distance and prominence — and they’re worth knowing because you can work on all three. You don’t control the distance from whoever is searching, but you can help it along with an exact address and a declared service area; relevance and prominence, on the other hand, are built.'},
    'La scheda Google e le recensioni: la vetrina prima del sito': {'en': 'The Google profile and reviews: the storefront before the website'},
    'E poi ci sono le recensioni, che pesano su fiducia e ranking insieme. Secondo l’indagine annuale di BrightLocal sui consumatori, la quasi totalità delle persone legge le recensioni prima di scegliere un’attività locale — e a Roma, con un pubblico anche internazionale, contano pure quelle in inglese. Non significa inventarle, sarebbe un boomerang oltre che una violazione: significa chiederle con metodo a chi è stato bene.': {'en': 'And then there are reviews, which weigh on trust and ranking together. According to BrightLocal’s annual consumer survey, almost everyone reads reviews before choosing a local business — and in Rome, with an international audience too, the ones in English count as well. It doesn’t mean inventing them, that would be a boomerang as well as a violation: it means asking for them methodically from those who had a good experience.'},
    'Il sito conta ancora: dati strutturati e contenuti romani': {'en': 'The website still matters: structured data and Rome-specific content'},
    'La scheda Google non vive da sola: si appoggia al vostro sito, e un sito curato rafforza tutto il resto. Il primo mattone sono i dati strutturati — quel blocco di codice, invisibile al visitatore, che dice a Google «questa è un’attività locale, ecco nome, indirizzo, orari e zona». È il tipo LocalBusiness di schema.org, e Google lo legge per capire e mostrare meglio la vostra scheda. La regola d’oro è la coerenza: nome, indirizzo e telefono identici ovunque compaiano, sul sito e sulle directory.': {'en': 'The Google profile doesn’t live alone: it leans on your website, and a well-kept site reinforces everything else. The first brick is structured data — that block of code, invisible to the visitor, that tells Google «this is a local business, here are its name, address, hours and area». It’s the LocalBusiness type from schema.org, and Google reads it to understand and better display your profile. The golden rule is consistency: name, address and phone identical wherever they appear, on the site and on directories.'},
    'Poi vengono i contenuti che parlano davvero del territorio. Non «keyword Roma» ripetute a forza, ma pagine che rispondono a domande locali reali: i quartieri che servite — Prati, l’Eur, i Parioli —, i casi seguiti in città, i tempi di intervento in provincia. È lavoro di SEO tecnica e di contenuto insieme, ed è esattamente quello che consegniamo di serie. Prima di aggiungere una riga, però, conviene misurare i segnali che il vostro sito già manda a Google.': {'en': 'Then come contents that really speak of the territory. Not «Rome keywords» repeated by force, but pages that answer real local questions: the neighbourhoods you serve — Prati, the EUR, Parioli —, the cases followed in the city, the response times across the province. It’s technical SEO and content work together, and it’s exactly what we deliver as standard. Before adding a single line, though, it’s worth measuring the signals your site already sends Google.'},
    'L’ordine giusto è controintuitivo: prima la scheda Google (completa, verificata, con recensioni vere), poi il sito (dati strutturati, dati NAP coerenti, contenuti locali), infine la prominenza (citazioni e link autorevoli, che arrivano col tempo). Saltare il primo passo per rincorrere il terzo è l’errore più comune, e il più costoso. A Roma, dove i concorrenti curano già almeno la scheda, la partita si gioca sui dettagli che gli altri trascurano.': {'en': 'The right order is counter-intuitive: first the Google profile (complete, verified, with genuine reviews), then the site (structured data, consistent NAP data, local content), and finally prominence (citations and authoritative links, which come with time). Skipping the first step to chase the third is the most common mistake, and the most expensive. In Rome, where competitors already look after at least the profile, the game is played on the details the others neglect.'},
    'Questo lavoro lo facciamo dove i clienti sono: a Roma abbiamo un ufficio vero, in Via Flaminia, e il primo incontro — da voi o da noi — non si paga. Ma il metodo è lo stesso in tutta la provincia: analizziamo la scheda e il sito attuali, vi diciamo cosa manca nero su bianco, e lavoriamo per farvi entrare in quella mappa. La SEO locale la costruiamo dalla base tecnica, non con trucchi.': {'en': 'This work we do where the clients are: in Rome we have a real office, on Via Flaminia, and the first meeting — at your place or ours — is free. But the method is the same across the whole province: we analyse the current profile and site, we tell you what’s missing in black and white, and we work to get you into that map. Local SEO we build from the technical base, not with tricks.'},
    'Realizzazione siti web a Roma: come lavoriamo in città →': {'en': 'Websites in Rome: how we work in the city →'},
    'Leggi anche: SEO locale a Torino, tra industria ed export →': {'en': 'Read also: local SEO in Turin, between industry and export →'},
    'Come il markup LocalBusiness aiuta Google a capire e mostrare un’attività locale sul territorio.': {'en': 'How the LocalBusiness markup helps Google understand and display a local business across the territory.'},
    'L’istituto nazionale di statistica: dati ufficiali su imprese, servizi e turismo dei territori italiani, Roma compresa.': {'en': 'The national statistics institute: official data on businesses, services and tourism in Italian territories, Rome included.'},
    'SEO locale a Roma: la mappa con i primi tre risultati che un cliente vede cercando «vicino a me» nella capitale': {'en': 'Local SEO in Rome: the map with the first three results a customer sees when searching «near me» in the capital'},
    'I tre fattori della SEO locale a Roma secondo Google: rilevanza, distanza e prominenza, che decidono il local pack': {'en': 'The three factors of local SEO in Rome according to Google: relevance, distance and prominence, which decide the local pack'},
    'Una torneria in Barriera di Milano, un fornitore di componentistica a Moncalieri, uno studio di design in Vanchiglia: a Torino il prodotto serio non manca mai, e spesso il cliente è un buyer tecnico che cerca un fornitore locale dal telefono, tra un turno e l’altro. La SEO locale a Torino è ciò che decide se, quando qualcuno cerca «lavorazioni meccaniche Torino» o «agenzia web Torino», comparite voi o il concorrente a due isolati di distanza. Non è una gara di parole d’ordine: è un lavoro di segnali precisi. Vediamo come funziona in una città di manifattura ed export, e da dove partire.': {'en': 'A machine shop in Barriera di Milano, a components supplier in Moncalieri, a design studio in Vanchiglia: in Turin serious product is never in short supply, and the customer is often a technical buyer looking for a local supplier from their phone, between one shift and the next. Local SEO in Turin is what decides whether, when someone searches «machining Turin» or «web agency Turin», you show up or the competitor two blocks away does. It’s not a contest of buzzwords: it’s work made of precise signals. Let’s see how it works in a city of manufacturing and export, and where to start.'},
    'Perché a Torino la SEO locale parla alla manifattura': {'en': 'Why in Turin local SEO speaks to manufacturing'},
    'Torino non vive di brochure: vive di manifattura, automotive, aerospazio e design. L’area conta oltre 221.000 imprese con più di 800.000 addetti, uno dei tessuti industriali più densi d’Italia (Camera di Commercio di Torino e Unione Industriali). Solo nella filiera della componentistica automotive, di cui Torino è il cuore storico, operano più di 2.000 imprese. In un contesto così, il cliente non è quasi mai l’impulso di un turista: è un responsabile acquisti che confronta fornitori, e che vi giudica anche da come vi trova e da quanto in fretta si apre il vostro sito.': {'en': 'Turin doesn’t live on brochures: it lives on manufacturing, automotive, aerospace and design. The area has over 221,000 businesses with more than 800,000 employees, one of the densest industrial fabrics in Italy (Turin Chamber of Commerce and Unione Industriali). In the automotive components supply chain alone, of which Turin is the historic heart, more than 2,000 businesses operate. In a context like this, the customer is almost never a tourist’s impulse: it’s a purchasing manager comparing suppliers, who judges you also by how they find you and how fast your site opens.'},
    'Questo cambia il senso della SEO locale a Torino. La ricerca «vicino a me» qui vale per il ristorante e per il negozio, ma la partita più ricca è un’altra: farsi trovare, in zona e non solo, per la lavorazione specifica, il componente, il servizio tecnico. Comparire per «fornitore Torino» in senso vago non basta; bisogna essere rilevanti per la ricerca precisa di chi cerca esattamente quello che fate, quando lo cerca.': {'en': 'This changes the meaning of local SEO in Turin. The «near me» search here matters for the restaurant and the shop, but the richer game is another: being found, locally and beyond, for the specific machining, the component, the technical service. Showing up for «supplier Turin» in a vague sense isn’t enough; you need to be relevant to the precise search of whoever is looking for exactly what you do, when they’re looking for it.'},
    'Il local pack e i tre fattori di Google': {'en': 'The local pack and Google’s three factors'},
    'Anche a Torino il cuore della ricerca locale è il «local pack»: il blocco con la mappa e tre attività che Google mostra in cima ai risultati a intento locale. Da mobile è la prima cosa che l’occhio incontra, e stare in quei tre riquadri vale più di dieci posizioni organiche. Per un’officina o uno studio, è la differenza tra ricevere la richiesta e restare invisibili.': {'en': 'In Turin too the heart of local search is the «local pack»: the block with the map and three businesses that Google shows at the top of results with local intent. On mobile it’s the first thing the eye meets, and being in those three boxes is worth more than ten organic positions. For a workshop or a studio, it’s the difference between receiving the enquiry and staying invisible.'},
    'Google spiega come sceglie chi mostrare: nella sua guida ufficiale al ranking locale indica tre fattori — rilevanza, distanza e prominenza. La rilevanza dipende da quanto la vostra scheda corrisponde alla ricerca; la distanza da dove siete rispetto a chi cerca; la prominenza da quanto siete conosciuti, recensioni comprese. Sono tre leve concrete, e per un’azienda torinese la rilevanza — categoria giusta, servizi descritti bene — è spesso quella più trascurata e più redditizia.': {'en': 'Google explains how it chooses who to show: in its official guide to local ranking it points to three factors — relevance, distance and prominence. Relevance depends on how well your profile matches the search; distance on where you are relative to whoever is searching; prominence on how well known you are, reviews included. They’re three concrete levers, and for a Turin company relevance — the right category, services well described — is often the most neglected and most profitable one.'},
    'I tre fattori con cui Google decide il local pack: rilevanza (quanto la scheda corrisponde alla ricerca), distanza (quanto siete vicini a chi cerca) e prominenza (quanto siete conosciuti). Per l’industria torinese, la rilevanza — categoria e servizi descritti bene — è spesso la leva più trascurata. Fonte: Google, guida ufficiale al ranking locale.': {'en': 'The three factors with which Google decides the local pack: relevance (how well the profile matches the search), distance (how close you are to whoever is searching) and prominence (how well known you are). For Turin’s industry, relevance — category and services well described — is often the most neglected lever. Source: Google, official guide to local ranking.'},
    'La scheda Google, curata come un catalogo': {'en': 'The Google profile, curated like a catalogue'},
    'Il motore della SEO locale è la scheda Google (Google Business Profile): compare nella mappa con nome, orari, foto, telefono e recensioni, e per molte ricerche il cliente decide guardando solo quella. Per un’azienda tecnica vale la pena trattarla come si tratta un catalogo: categoria precisa, servizi elencati, foto vere dell’officina o dei prodotti, orari corretti. Una scheda vaga o abbandonata dice al buyer esattamente ciò che non volete dica.': {'en': 'The engine of local SEO is the Google profile (Google Business Profile): it appears on the map with name, hours, photos, phone and reviews, and for many searches the customer decides looking only at that. For a technical company it’s worth treating it the way you treat a catalogue: precise category, listed services, real photos of the workshop or the products, correct hours. A vague or abandoned profile tells the buyer exactly what you don’t want it to say.'},
    'Le recensioni pesano su fiducia e ranking insieme: secondo l’indagine annuale di BrightLocal, la quasi totalità delle persone le legge prima di scegliere. Anche nel B2B contano più di quanto si creda — un buyer che valuta un nuovo fornitore le guarda. Chiederle a un cliente soddisfatto, dopo una commessa andata bene, è tra le mosse a costo zero con il ritorno più alto.': {'en': 'Reviews weigh on trust and ranking together: according to BrightLocal’s annual survey, almost everyone reads them before choosing. In B2B too they count more than you’d think — a buyer evaluating a new supplier looks at them. Asking a satisfied client for one, after a job well done, is among the zero-cost moves with the highest return.'},
    'Il sito: dati strutturati, velocità e catalogo trovabile': {'en': 'The website: structured data, speed and a findable catalogue'},
    'A Torino il sito non è un vezzo, è un pezzo di ingegneria — e sulla SEO locale conta due volte. Primo: i dati strutturati LocalBusiness di schema.org dicono a Google, in modo esplicito, dove siete e cosa fate, con nome, indirizzo e telefono coerenti ovunque. Secondo: la velocità. Un catalogo tecnico che si apre in sei secondi dal telefono, mentre il buyer di Stoccarda ne aspetta meno di uno, è traffico perso; e la lentezza pesa anche sul posizionamento.': {'en': 'In Turin the site isn’t a whim, it’s a piece of engineering — and for local SEO it counts twice. First: the LocalBusiness structured data from schema.org tells Google, explicitly, where you are and what you do, with name, address and phone consistent everywhere. Second: speed. A technical catalogue that opens in six seconds on the phone, while the buyer in Stuttgart waits less than one, is lost traffic; and slowness weighs on ranking too.'},
    'Poi ci sono i contenuti locali e internazionali insieme. Molte imprese torinesi vendono in mezza Europa: la SEO locale «in zona» convive con una SEO internazionale fatta bene, versioni in altre lingue tradotte da madrelingua e con hreflang corretto. Prima di aggiungere pagine, però, conviene misurare i segnali che il vostro sito già manda: struttura, dati strutturati, velocità reale.': {'en': 'Then there’s local and international content together. Many Turin companies sell across half of Europe: «local» local SEO coexists with well-done international SEO, versions in other languages translated by native speakers and with correct hreflang. Before adding pages, though, it’s worth measuring the signals your site already sends: structure, structured data, real speed.'},
    'L’ordine è sempre lo stesso: prima la scheda Google (completa, verificata, con recensioni vere), poi il sito (dati strutturati, velocità, contenuti), infine la prominenza. Per un’azienda che esporta si aggiunge un livello: rendere trovabile anche chi vi cerca dall’estero, con un sito pronto per i mercati in cui vendete. La SEO locale e quella per l’export non sono in contrasto — sono lo stesso lavoro tecnico, esteso alle lingue giuste.': {'en': 'The order is always the same: first the Google profile (complete, verified, with genuine reviews), then the site (structured data, speed, content), and finally prominence. For a company that exports, one level is added: making yourself findable also by whoever searches for you from abroad, with a site ready for the markets you sell in. Local SEO and export SEO aren’t in conflict — they’re the same technical work, extended to the right languages.'},
    'Questo lavoro lo facciamo dove i clienti sono: a Torino abbiamo un ufficio vero e il primo incontro — da voi in azienda o da noi — non si paga. Analizziamo la scheda e il sito attuali, guardiamo la velocità del catalogo da mobile, e vi diciamo cosa manca nero su bianco. Poi lavoriamo per farvi trovare, in città e sui mercati che vi interessano.': {'en': 'This work we do where the clients are: in Turin we have a real office and the first meeting — at your company or ours — is free. We analyse the current profile and site, we look at the catalogue’s speed on mobile, and we tell you what’s missing in black and white. Then we work to get you found, in the city and in the markets that interest you.'},
    'Realizzazione siti web a Torino: come lavoriamo in città →': {'en': 'Websites in Turin: how we work in the city →'},
    'Un sito pronto a vendere all’estero: la guida →': {'en': 'A site ready to sell abroad: the guide →'},
    'Come il markup LocalBusiness aiuta Google a capire e mostrare un’attività sul territorio.': {'en': 'How the LocalBusiness markup helps Google understand and display a business across the territory.'},
    'L’indagine annuale sui consumatori: quasi tutti leggono le recensioni prima di scegliere, B2B compreso.': {'en': 'The annual consumer survey: almost everyone reads reviews before choosing, B2B included.'},
    'L’istituto nazionale di statistica: dati ufficiali sul tessuto di imprese e sull’industria dei territori italiani, Torino compresa.': {'en': 'The national statistics institute: official data on the business fabric and industry of Italian territories, Turin included.'},
    'SEO locale a Torino: la mappa con i primi tre risultati per chi cerca un fornitore o un servizio nella città della manifattura': {'en': 'Local SEO in Turin: the map with the first three results for whoever is looking for a supplier or a service in the manufacturing city'},
    'I tre fattori della SEO locale a Torino secondo Google: rilevanza, distanza e prominenza, che decidono il local pack': {'en': 'The three factors of local SEO in Turin according to Google: relevance, distance and prominence, which decide the local pack'},
    'Napoli e il turismo: un sito multilingue che fa prenotare': {'en': 'Naples and tourism: a multilingual website that gets bookings'},
    'Un hotel nel centro storico che vive di prenotazioni dirette, un B&B ai Quartieri Spagnoli, un ristorante che il turista americano trova dal telefono a mezzogiorno: a Napoli il richiamo c’è ed è fortissimo — 14 milioni di presenze turistiche nel 2024, prima destinazione del Mezzogiorno. Ma il turista che vi cerca è spesso straniero, legge le recensioni in inglese e prenota online prima ancora di scrivervi. Un sito turismo a Napoli che apre le camere in sei secondi, o che esiste solo in italiano, è una prenotazione regalata a un portale. Vediamo perché un sito multilingue fatto bene fa prenotare diretto, e come si costruisce.': {'en': 'A hotel in the old town that lives on direct bookings, a B&B in the Quartieri Spagnoli, a restaurant the American tourist finds from their phone at noon: in Naples the draw is there and it’s very strong — 14 million overnight stays in 2024, the leading destination of southern Italy. But the tourist looking for you is often foreign, reads reviews in English and books online before even writing to you. A Naples tourism website that opens the rooms in six seconds, or that exists only in Italian, is a booking handed to a portal. Let’s see why a well-built multilingual website gets direct bookings, and how it’s built.'},
    'Napoli, il turismo e un pubblico che arriva da fuori': {'en': 'Naples, tourism and an audience arriving from outside'},
    'Il turismo a Napoli è cresciuto di quasi la metà in tre anni, trainato anche dal porto: 1,83 milioni di crocieristi nel 2024, secondo scalo crocieristico d’Italia (Autorità di Sistema Portuale del Mar Tirreno Centrale). È un pubblico in gran parte internazionale, che prima di prenotare fa una cosa sola: cerca online, legge le recensioni, confronta le foto. Se il vostro hotel o ristorante non compare — o compare con un sito solo in italiano che il turista di Boston non capisce — la prenotazione va altrove.': {'en': 'Tourism in Naples has grown by almost half in three years, driven in part by the port: 1.83 million cruise passengers in 2024, Italy’s second cruise port (Central Tyrrhenian Sea Port Authority). It’s a largely international audience that, before booking, does one thing only: it searches online, reads reviews, compares photos. If your hotel or restaurant doesn’t appear — or appears with a site only in Italian that the tourist from Boston doesn’t understand — the booking goes elsewhere.'},
    'Qui sta il punto: a Napoli il sito turistico lavora per forza in più lingue. Non è un vezzo internazionale, è il minimo per intercettare chi vi cerca nella sua lingua. E fa una differenza economica concreta, perché la prenotazione diretta — senza commissione del portale — vale molto più di quella intermediata. Un sito multilingue che fa prenotare diretto è, letteralmente, margine che resta a voi.': {'en': 'Here’s the point: in Naples the tourism site necessarily works in more than one language. It’s not an international affectation, it’s the minimum for intercepting whoever is looking for you in their own language. And it makes a concrete economic difference, because a direct booking — with no portal commission — is worth far more than an intermediated one. A multilingual website that gets direct bookings is, literally, margin that stays with you.'},
    'Perché il turista prenota nella sua lingua': {'en': 'Why the tourist books in their own language'},
    'Le persone comprano nella lingua che capiscono. È un dato ormai classico della ricerca di CSA Research («Can’t Read, Won’t Buy»): la grande maggioranza dei consumatori preferisce acquistare — e prenotare — quando le informazioni sono nella propria lingua, e molti evitano del tutto i siti solo in inglese o solo nella lingua locale. Per un turista che sta scegliendo dove dormire a Napoli, un sito nella sua lingua non è un lusso: è la ragione per cui si fida e clicca «prenota».': {'en': 'People buy in the language they understand. It’s by now a classic finding of CSA Research («Can’t Read, Won’t Buy»): the great majority of consumers prefer to buy — and to book — when the information is in their own language, and many avoid altogether sites only in English or only in the local language. For a tourist choosing where to sleep in Naples, a site in their own language isn’t a luxury: it’s the reason they trust it and click «book».'},
    'E non basta tradurre alla buona. Una traduzione automatica raffazzonata, con errori e frasi innaturali, ottiene l’effetto opposto: comunica trascuratezza proprio a chi sta per affidarvi la sua vacanza. Un sito turismo a Napoli credibile ha versioni scritte da chi la lingua la parla davvero — inglese prima di tutto, poi le lingue dei mercati che vi portano più ospiti — con testi che suonano nativi, non tradotti a macchina.': {'en': 'And translating any old way isn’t enough. A slapdash machine translation, with errors and unnatural phrasing, achieves the opposite effect: it signals carelessness to the very person about to entrust you with their holiday. A credible Naples tourism site has versions written by someone who really speaks the language — English first of all, then the languages of the markets that bring you the most guests — with text that sounds native, not machine-translated.'},
    'Traduzione madrelingua o AI: la differenza che il cliente sente →': {'en': 'Native translation or AI: the difference the customer feels →'},
    'Un sito in più lingue non è un sito italiano con la bandierina. Perché funzioni davvero su Google serve la parte tecnica giusta: l’attributo hreflang, che dice al motore quale versione mostrare a chi cerca in inglese, tedesco o francese, così il turista americano riceve la pagina in inglese e non quella in italiano. Fatto male, hreflang crea doppioni e confusione; fatto bene, mette la versione giusta davanti alla persona giusta.': {'en': 'A site in several languages isn’t an Italian site with a little flag. For it to really work on Google you need the right technical part: the hreflang attribute, which tells the engine which version to show whoever searches in English, German or French, so the American tourist gets the page in English and not the one in Italian. Done badly, hreflang creates duplicates and confusion; done well, it puts the right version in front of the right person.'},
    'A questo si aggiungono le regole per i siti internazionali che Google stesso documenta: URL chiari per ogni lingua, contenuti realmente tradotti (non solo il menu), coerenza tra le versioni. È lavoro invisibile al visitatore ma decisivo per il posizionamento: un sito turistico a Napoli ben strutturato compare quando un olandese cerca «hotel Naples old town», non solo quando un italiano cerca «hotel Napoli centro».': {'en': 'To this are added the rules for international sites that Google itself documents: clear URLs for each language, genuinely translated content (not just the menu), consistency between versions. It’s work invisible to the visitor but decisive for ranking: a well-structured Naples tourism site appears when a Dutch person searches «hotel Naples old town», not only when an Italian searches «hotel Napoli centro».'},
    'Il percorso di una prenotazione diretta a Napoli: il turista cerca nella sua lingua, hreflang gli serve la versione giusta, una traduzione madrelingua costruisce fiducia e la prenotazione diretta — senza commissione del portale — resta margine per voi. Un sito solo in italiano, o tradotto a macchina, spezza la catena al primo anello.': {'en': 'The path of a direct booking in Naples: the tourist searches in their own language, hreflang serves them the right version, a native translation builds trust, and the direct booking — with no portal commission — stays as margin for you. A site only in Italian, or machine-translated, breaks the chain at the first link.'},
    'Le recensioni: la riprova sociale in ogni lingua': {'en': 'Reviews: social proof in every language'},
    'Nel turismo la decisione passa quasi sempre dalle recensioni. La quasi totalità dei viaggiatori le legge prima di prenotare, e a Napoli molte sono in inglese o in altre lingue: il vostro sito e la vostra scheda Google devono raccoglierle e mostrarle, non nasconderle. Una scheda Google Business Profile curata, con foto vere e recensioni recenti, spesso convince prima ancora che il turista apra il sito.': {'en': 'In tourism the decision almost always goes through reviews. Nearly all travellers read them before booking, and in Naples many are in English or other languages: your site and your Google profile must collect and show them, not hide them. A well-kept Google Business Profile, with real photos and recent reviews, often convinces before the tourist even opens the site.'},
    'La riprova sociale, però, va trattata con onestà: recensioni vere, richieste con metodo a chi è stato bene, mai inventate. Nel turismo una recensione falsa smascherata è un danno permanente, perché gira su piattaforme internazionali che non dimenticano. La fiducia si costruisce mostrando ciò che gli ospiti dicono davvero, nella lingua in cui lo dicono.': {'en': 'Social proof, though, must be handled honestly: genuine reviews, requested methodically from those who had a good experience, never invented. In tourism a fake review that gets exposed is permanent damage, because it circulates on international platforms that don’t forget. Trust is built by showing what guests really say, in the language they say it.'},
    'Leggi anche: recensioni e riprova sociale, senza inventare nulla →': {'en': 'Read also: reviews and social proof, without inventing anything →'},
    'Realizzazione siti web a Napoli: turismo, porto e aerospazio →': {'en': 'Websites in Naples: tourism, port and aerospace →'},
    'Da dove partire, per far prenotare diretto': {'en': 'Where to start, to get direct bookings'},
    'L’ordine ha senso: prima un sito veloce e leggibile da mobile (è lì che il turista sceglie), poi le lingue che contano davvero per il vostro pubblico — inglese sempre, le altre in base a chi vi porta più ospiti —, tradotte da madrelingua e con hreflang corretto. Infine la scheda Google curata e le recensioni. Ogni anello aggiunge prenotazioni dirette; saltarne uno le regala ai portali.': {'en': 'The order makes sense: first a fast, mobile-readable site (that’s where the tourist chooses), then the languages that really matter for your audience — English always, the others depending on who brings you the most guests —, translated by native speakers and with correct hreflang. Finally the well-kept Google profile and the reviews. Each link adds direct bookings; skipping one hands them to the portals.'},
    'Noi partiamo dai numeri: quanto carica oggi il vostro sito, come si comporta la versione inglese, cosa vede Google quando un turista cerca dall’estero. Lavoriamo in tutta Italia e a Napoli ci incontriamo in videochiamata o veniamo noi da voi, su appuntamento. Un sito turismo a Napoli fatto bene non è una spesa: è la reception che lavora anche di notte, in tutte le lingue dei vostri ospiti.': {'en': 'We start from the numbers: how fast your site loads today, how the English version behaves, what Google sees when a tourist searches from abroad. We work across the whole of Italy and in Naples we meet by video call or, by appointment, we come to you. A well-built Naples tourism site isn’t an expense: it’s the reception desk that works at night too, in all the languages of your guests.'},
    'Siti multilingue: come li costruiamo, lingua per lingua →': {'en': 'Multilingual websites: how we build them, language by language →'},
    'Leggi anche: hreflang per un sito multilingue, senza mal di testa →': {'en': 'Read also: hreflang for a multilingual website, without the headache →'},
    'La ricerca di riferimento: la maggioranza dei consumatori preferisce comprare e prenotare nella propria lingua.': {'en': 'The reference research: the majority of consumers prefer to buy and book in their own language.'},
    'Google — gestire i siti multi-regionali e multilingue': {'en': 'Google — managing multi-regional and multilingual sites'},
    'Le regole ufficiali per un sito internazionale: URL, contenuti tradotti e coerenza tra le versioni.': {'en': 'The official rules for an international site: URLs, translated content and consistency between versions.'},
    'Come dire a Google quale versione linguistica mostrare a ogni utente, senza creare doppioni.': {'en': 'How to tell Google which language version to show each user, without creating duplicates.'},
    'L’indagine sui consumatori: quasi tutti leggono le recensioni prima di scegliere, nel turismo più che mai.': {'en': 'The consumer survey: almost everyone reads reviews before choosing, in tourism more than ever.'},
    'Siti multilingue tradotti da madrelingua, con SEO internazionale corretta →': {'en': 'Multilingual websites translated by native speakers, with correct international SEO →'},
    'Un sito turismo a Napoli multilingue che fa prenotare diretto: la scheda di un hotel letta in più lingue dai turisti stranieri': {'en': 'A multilingual Naples tourism site that gets direct bookings: a hotel’s listing read in several languages by foreign tourists'},
    'Come un sito turismo multilingue a Napoli fa prenotare: hreflang serve la lingua giusta, la traduzione madrelingua crea fiducia, la prenotazione diretta resta margine': {'en': 'How a multilingual Naples tourism site gets bookings: hreflang serves the right language, native translation builds trust, the direct booking stays as margin'},
    'Traduzione madrelingua o AI: la differenza che il cliente sente': {'en': 'Native translation or AI: the difference the customer feels'},
    'La traduzione automatica ha fatto passi da gigante: oggi capire un testo in una lingua che non conoscete è questione di un clic, e per molti usi va benissimo. Proprio per questo la domanda giusta non è «AI sì o AI no», ma un’altra: per il vostro sito — quello che deve vendere, convincere, rappresentarvi — quando conta ancora una traduzione madrelingua? La differenza c’è, e il cliente la sente, ma non è dove molti credono. Vediamo con onestà cosa fa bene la traduzione automatica, dove serve davvero la mano di un madrelingua, e come scegliere senza sprecare soldi né rovinare la reputazione.': {'en': 'Machine translation has come on in leaps and bounds: today understanding a text in a language you don’t know is a matter of one click, and for many uses it’s perfectly fine. Precisely for this reason the right question isn’t «AI yes or AI no», but another: for your website — the one that has to sell, convince, represent you — when does a native translation still matter? The difference is there, and the customer feels it, but it’s not where many people think. Let’s look honestly at what machine translation does well, where the hand of a native speaker really is needed, and how to choose without wasting money or ruining your reputation.'},
    'Cosa fa bene, davvero, la traduzione automatica': {'en': 'What machine translation really does well'},
    'Cominciamo dall’onestà: la traduzione automatica è migliorata enormemente. Per capire il senso di un testo, per contenuti tecnici molto standardizzati, per volumi enormi dove una revisione umana sarebbe impossibile, oggi fa un lavoro che dieci anni fa era impensabile. Liquidarla come «sempre sbagliata» è falso e non aiuta nessuno. Per un manuale interno, una descrizione di prodotto molto ripetitiva, una prima bozza da rifinire, è uno strumento serio.': {'en': 'Let’s start from honesty: machine translation has improved enormously. To grasp the sense of a text, for highly standardized technical content, for enormous volumes where human review would be impossible, today it does work that ten years ago was unthinkable. Dismissing it as «always wrong» is false and helps no one. For an internal manual, a very repetitive product description, a first draft to refine, it’s a serious tool.'},
    'Il punto non è demonizzarla, ma capirne il limite. La macchina traduce le parole e, sempre meglio, anche la frase; quello che ancora le sfugge è ciò che sta intorno alle parole: il tono, l’intenzione, il riferimento culturale, la battuta che funziona in una lingua e cade nell’altra. Sul sito che deve vendere, spesso è proprio quello a fare la differenza tra un testo corretto e un testo che convince.': {'en': 'The point isn’t to demonize it, but to understand its limit. The machine translates the words and, ever better, the sentence too; what still escapes it is what surrounds the words: the tone, the intent, the cultural reference, the joke that works in one language and falls flat in the other. On the site that has to sell, that’s often exactly what makes the difference between a correct text and a text that convinces.'},
    'Dove serve la mano di un madrelingua': {'en': 'Where the hand of a native speaker is needed'},
    'La sfumatura umana conta dove il testo deve fare qualcosa oltre che informare. Nel marketing: uno slogan tradotto alla lettera può risultare piatto, goffo o, nei casi peggiori, involontariamente comico o offensivo nella cultura d’arrivo. Nel tono di voce: un sito che in italiano è caldo e diretto può diventare, tradotto a macchina, freddo e impersonale — e il visitatore lo percepisce, anche senza saper dire perché.': {'en': 'The human nuance counts where the text has to do something beyond informing. In marketing: a slogan translated literally can come across as flat, clumsy or, in the worst cases, unintentionally comic or offensive in the target culture. In tone of voice: a site that in Italian is warm and direct can become, machine-translated, cold and impersonal — and the visitor perceives it, even without being able to say why.'},
    'Conta poi nella cultura locale: modi di dire, unità di misura, esempi, riferimenti che un madrelingua adatta senza pensarci e che la macchina lascia intatti, tradendo la provenienza «tradotta» del testo. È la differenza tra un sito che sembra scritto per quel pubblico e uno che sembra scritto altrove e spedito lì. Per un turista che prenota, per un buyer che sceglie un fornitore, quella sensazione di «autenticità» pesa più di quanto si creda.': {'en': 'It counts, too, in local culture: idioms, units of measure, examples, references that a native speaker adapts without thinking and that the machine leaves untouched, betraying the «translated» origin of the text. It’s the difference between a site that seems written for that audience and one that seems written elsewhere and shipped there. For a tourist who books, for a buyer who chooses a supplier, that sense of «authenticity» weighs more than you’d think.'},
    'Non «AI contro umano», ma il testo giusto al posto giusto: per contenuti tecnici standardizzati e grandi volumi la traduzione automatica è uno strumento serio; per marketing, tono di voce e riferimenti culturali — cioè le pagine che devono vendere e convincere — la mano di un madrelingua fa la differenza che il cliente sente.': {'en': 'Not «AI versus human», but the right text in the right place: for standardized technical content and large volumes machine translation is a serious tool; for marketing, tone of voice and cultural references — that is, the pages that have to sell and convince — the hand of a native speaker makes the difference the customer feels.'},
    'L’errore più caro: la traduzione «a macchina» lasciata lì': {'en': 'The most expensive mistake: machine translation left as it is'},
    'Il problema non è usare l’AI per partire: è pubblicarne il risultato grezzo senza che nessuno lo legga. Un sito con traduzioni palesemente automatiche — articoli storti, false amiche, frasi che nessun madrelingua direbbe mai — comunica trascuratezza proprio nel momento in cui vi state presentando a un cliente nuovo. E lo fa in modo subdolo: voi, che quella lingua non la parlate, non ve ne accorgete; il vostro cliente sì, alla prima riga.': {'en': 'The problem isn’t using AI to get started: it’s publishing the raw result without anyone reading it. A site with obviously automatic translations — awkward phrasing, false friends, sentences no native speaker would ever say — signals carelessness at the very moment you’re introducing yourself to a new customer. And it does so insidiously: you, who don’t speak that language, don’t notice; your customer does, on the very first line.'},
    'C’è anche un costo che non si vede: la fiducia persa non torna. Un visitatore che percepisce un sito «tradotto male» dubita del resto — della serietà, della qualità, della sicurezza dei pagamenti. Nel dubbio, chiude. Per questo un testo destinato a rappresentarvi all’estero va almeno letto e sistemato da un madrelingua: non per snobismo, ma perché è lì che si decide se vi scelgono.': {'en': 'There’s also a cost you don’t see: lost trust doesn’t come back. A visitor who perceives a «badly translated» site doubts the rest — the seriousness, the quality, the security of payments. In doubt, they close the tab. That’s why a text meant to represent you abroad should at least be read and fixed by a native speaker: not out of snobbery, but because that’s where it’s decided whether they choose you.'},
    'Prova gratis come «suona» il tuo testo a un madrelingua →': {'en': 'Try for free how your text «sounds» to a native speaker →'},
    'Leggi anche: il ROI della localizzazione, quanto rende tradurre davvero →': {'en': 'Read also: the ROI of localization, how much translating really pays →'},
    'Come scegliere, senza sprecare né rischiare': {'en': 'How to choose, without wasting or risking'},
    'La scelta pratica non è tutto-o-niente. Un approccio sensato è per livelli: contenuti a bassa posta e alto volume — schede molto tecniche, archivi, documentazione — possono partire da una buona traduzione automatica; le pagine che vendono e convincono — home, servizi, landing, storie — meritano una traduzione o una revisione madrelingua. Così spendete dove rende e risparmiate dove non serve, senza mettere a rischio la faccia che mostrate al mercato.': {'en': 'The practical choice isn’t all-or-nothing. A sensible approach is by tiers: low-stakes, high-volume content — very technical listings, archives, documentation — can start from a good machine translation; the pages that sell and convince — home, services, landing pages, stories — deserve a native translation or review. That way you spend where it pays and save where it doesn’t, without putting at risk the face you show the market.'},
    'È l’approccio con cui lavoriamo sui siti multilingue: la tecnologia dove aiuta, la mano di un madrelingua dove conta. Non traduciamo con un plugin e via; le lingue dei vostri clienti le scriviamo perché suonino native, con hreflang e SEO internazionale corretti. Perché un sito in un’altra lingua non deve solo essere capito: deve convincere qualcuno a scegliervi.': {'en': 'It’s the approach we work with on multilingual sites: technology where it helps, the hand of a native speaker where it counts. We don’t translate with a plugin and be done with it; the languages of your customers we write so they sound native, with correct hreflang and international SEO. Because a site in another language mustn’t just be understood: it has to convince someone to choose you.'},
    'Siti multilingue: tradotti da madrelingua, non da un plugin →': {'en': 'Multilingual websites: translated by native speakers, not by a plugin →'},
    'Leggi anche: Napoli e il turismo, un sito multilingue che fa prenotare →': {'en': 'Read also: Naples and tourism, a multilingual website that gets bookings →'},
    'La ricerca di riferimento sul valore della lingua: i consumatori preferiscono comprare quando i contenuti sono nella loro lingua.': {'en': 'The reference research on the value of language: consumers prefer to buy when content is in their language.'},
    'Il lato tecnico della localizzazione: dire a Google quale versione linguistica mostrare a ogni utente.': {'en': 'The technical side of localization: telling Google which language version to show each user.'},
    'Le regole ufficiali per un sito internazionale: contenuti realmente tradotti e coerenza tra le versioni.': {'en': 'The official rules for an international site: genuinely translated content and consistency between versions.'},
    'Senti come suona il tuo testo a un madrelingua: provalo gratis →': {'en': 'Hear how your text sounds to a native speaker: try it free →'},
    'Traduzione madrelingua di un sito o AI: la differenza di sfumatura, tono e cultura che il cliente sente': {'en': 'Native translation of a website or AI: the difference in nuance, tone and culture that the customer feels'},
    'Quando basta la traduzione automatica e quando serve un madrelingua: contenuti tecnici e volumi vs marketing, tono e cultura': {'en': 'When machine translation is enough and when a native speaker is needed: technical content and volumes vs marketing, tone and culture'},
    'ROI della localizzazione: quanto rende tradurre davvero il sito': {'en': 'Localization ROI: how much translating your site really pays'},
    '«Tradurre il sito conviene?» è la domanda che ogni azienda che guarda all’estero prima o poi si fa. E la risposta seria non è «sì, sempre» né «no, costa troppo»: è «dipende, e si può stimare». Il ROI della localizzazione — cioè quanto rende, in proporzione a quanto costa, tradurre e adattare il sito per un mercato — non è un atto di fede, è un conto che si può impostare prima di spendere un euro. Vediamo come si ragiona: quali numeri guardare, dove sta il ritorno che spesso non si vede, e come capire se aprire una certa lingua conviene davvero.': {'en': '«Is it worth translating the site?» is the question every company looking abroad sooner or later asks itself. And the serious answer is neither «yes, always» nor «no, it costs too much»: it’s «it depends, and it can be estimated». The ROI of localization — that is, how much translating and adapting the site for a market pays, in proportion to what it costs — isn’t an act of faith, it’s a calculation you can set up before spending a euro. Let’s see how to reason about it: which numbers to look at, where the return that often goes unseen lies, and how to tell whether opening a given language really pays.'},
    'Localizzare non è tradurre: due parole diverse': {'en': 'Localizing isn’t translating: two different words'},
    'Prima di parlare di ritorno, una distinzione che cambia i conti. Tradurre è trasformare le parole da una lingua all’altra. Localizzare è adattare il sito a un mercato: la lingua, sì, ma anche la valuta, i metodi di pagamento attesi, gli esempi, i riferimenti culturali, e la SEO in quella lingua perché la gente vi trovi. Un sito «tradotto» ma non localizzato spesso non rende, perché è capito ma non convince e — peggio — non viene trovato da chi cerca nella sua lingua.': {'en': 'Before talking about return, a distinction that changes the sums. Translating is turning words from one language into another. Localizing is adapting the site to a market: the language, yes, but also the currency, the expected payment methods, the examples, the cultural references, and SEO in that language so people find you. A site that’s «translated» but not localized often doesn’t pay, because it’s understood but doesn’t convince and — worse — isn’t found by whoever searches in their own language.'},
    'Questa differenza è il primo pezzo del ROI. Il costo di una localizzazione fatta bene è più alto di quello di una traduzione secca; ma è il ritorno a essere di un altro ordine, perché un sito localizzato entra davvero nel mercato invece di limitarsi a esistere in un’altra lingua. Confrontare il prezzo di due cose diverse è il modo più rapido per prendere la decisione sbagliata.': {'en': 'This difference is the first piece of the ROI. The cost of a well-done localization is higher than that of a plain translation; but it’s the return that’s of another order, because a localized site really enters the market instead of merely existing in another language. Comparing the price of two different things is the fastest way to make the wrong decision.'},
    'I numeri del ritorno: mercato, ricerca, conversione': {'en': 'The numbers of the return: market, search, conversion'},
    'Il ritorno della localizzazione si costruisce su tre leve. La prima è il mercato raggiungibile: aprire una lingua vuol dire poter parlare a un pubblico che prima non vi capiva. La ricerca di CSA Research lo dice da anni: la grande maggioranza dei consumatori preferisce comprare quando le informazioni sono nella propria lingua, e una quota rilevante non compra affatto su un sito che non la parla. Ogni lingua che aprite, fatta bene, sposta in avanti il confine delle persone che potete convertire.': {'en': 'The return of localization is built on three levers. The first is the reachable market: opening a language means being able to speak to an audience that couldn’t understand you before. CSA Research has said it for years: the great majority of consumers prefer to buy when the information is in their own language, and a significant share doesn’t buy at all on a site that doesn’t speak it. Every language you open, done well, pushes forward the boundary of the people you can convert.'},
    'La seconda leva è la visibilità: un sito localizzato, con SEO internazionale e hreflang corretti, compare nelle ricerche in quella lingua — traffico che senza localizzazione semplicemente non arriva. La terza è la conversione: chi legge nella propria lingua si fida di più e acquista di più. Il commercio elettronico transfrontaliero, del resto, è una quota crescente delle vendite online in Europa (Eurostat). Tre leve che si moltiplicano tra loro, non si sommano.': {'en': 'The second lever is visibility: a localized site, with correct international SEO and hreflang, appears in searches in that language — traffic that without localization simply doesn’t arrive. The third is conversion: whoever reads in their own language trusts more and buys more. Cross-border e-commerce, after all, is a growing share of online sales in Europe (Eurostat). Three levers that multiply each other, they don’t add up.'},
    'Il ROI della localizzazione, in chiaro: da una parte il costo dell’adattamento (una tantum più manutenzione), dall’altra tre leve che si moltiplicano — mercato raggiungibile, visibilità nelle ricerche in quella lingua e conversione più alta di chi legge nella propria lingua. Il ritorno arriva quando le tre leve, insieme, superano il costo: si può stimare prima di spendere.': {'en': 'The ROI of localization, laid bare: on one side the cost of adaptation (one-off plus maintenance), on the other three levers that multiply — reachable market, visibility in searches in that language and higher conversion from those who read in their own language. The return comes when the three levers, together, exceed the cost: it can be estimated before spending.'},
    'Come stimare il ROI prima di spendere': {'en': 'How to estimate the ROI before spending'},
    'Il conto si imposta al contrario: non «quanto costa tradurre», ma «quanto deve rendere per valere la pena». Si parte dal costo della localizzazione di quel mercato (una tantum più manutenzione), si stima il pubblico raggiungibile e un tasso di conversione prudente, e si guarda dopo quanti mesi il ritorno atteso copre la spesa. Se il mercato è grande e il vostro margine è buono, il pareggio arriva in fretta; se è piccolo o la concorrenza locale è fortissima, forse quella lingua aspetta.': {'en': 'You set up the calculation the other way round: not «how much does it cost to translate», but «how much does it have to return to be worth it». You start from the cost of localizing that market (one-off plus maintenance), you estimate the reachable audience and a prudent conversion rate, and you look at after how many months the expected return covers the outlay. If the market is large and your margin is good, break-even comes quickly; if it’s small or local competition is fierce, perhaps that language can wait.'},
    'Non serve un modello da consulenti per farsi un’idea: bastano poche ipotesi oneste — quante persone in più raggiungete, quanto vale un cliente, quanto costa aprire la lingua. Per questo abbiamo messo online un calcolatore gratuito del ROI della localizzazione: inserite i vostri numeri e vedete se, e in quanto tempo, tradurre davvero conviene. Meglio un conto approssimativo fatto prima che un rimpianto preciso fatto dopo.': {'en': 'You don’t need a consultants’ model to get an idea: a few honest assumptions are enough — how many more people you reach, how much a customer is worth, how much opening the language costs. That’s why we’ve put online a free localization ROI calculator: enter your numbers and see whether, and in how long, translating really pays. Better an approximate calculation done beforehand than a precise regret afterwards.'},
    'Calcola gratis il ROI della localizzazione del tuo sito →': {'en': 'Calculate the ROI of your site’s localization for free →'},
    'Leggi anche: traduzione madrelingua o AI, la differenza che il cliente sente →': {'en': 'Read also: native translation or AI, the difference the customer feels →'},
    'L’errore che azzera il ritorno': {'en': 'The mistake that zeroes out the return'},
    'C’è un modo sicuro per rovinare il ROI: localizzare a metà. Tradurre la home ma lasciare il checkout in italiano; aprire una lingua ma non curarne la SEO, così nessuno vi trova; tradurre a macchina senza revisione, così chi arriva non si fida e chiude. In tutti questi casi avete pagato il costo senza raccoglierne il ritorno — la peggiore combinazione possibile. La localizzazione rende quando è completa lungo tutto il percorso, dalla prima ricerca al pagamento.': {'en': 'There’s a sure way to ruin the ROI: localizing halfway. Translating the home but leaving the checkout in Italian; opening a language but not looking after its SEO, so nobody finds you; machine-translating without review, so whoever arrives doesn’t trust it and closes the tab. In all these cases you’ve paid the cost without reaping the return — the worst possible combination. Localization pays when it’s complete along the whole path, from the first search to the payment.'},
    'Per questo trattiamo la localizzazione come un investimento da progettare, non come un plugin da attivare: scegliamo con voi le lingue che rendono, le traduciamo con madrelingua dove conta, curiamo hreflang e SEO internazionale, e teniamo coerente tutto il percorso d’acquisto. Un sito pronto per l’export non è un sito italiano con le bandierine: è un sito che, in ogni lingua, porta il cliente fino in fondo.': {'en': 'That’s why we treat localization as an investment to design, not a plugin to switch on: we choose with you the languages that pay, we translate them with native speakers where it counts, we look after hreflang and international SEO, and we keep the whole purchase path consistent. A site ready for export isn’t an Italian site with little flags: it’s a site that, in every language, takes the customer all the way through.'},
    'Un sito pronto per i mercati esteri: il servizio export-ready →': {'en': 'A site ready for foreign markets: the export-ready service →'},
    'Leggi anche: un sito pronto a vendere all’estero →': {'en': 'Read also: a site ready to sell abroad →'},
    'La ricerca di riferimento: la maggioranza dei consumatori preferisce comprare nella propria lingua, molti non comprano affatto senza.': {'en': 'The reference research: the majority of consumers prefer to buy in their own language, many don’t buy at all without it.'},
    'I dati ufficiali UE sul commercio elettronico, comprese le vendite transfrontaliere: il mercato che la localizzazione apre.': {'en': 'The official EU data on e-commerce, cross-border sales included: the market that localization opens.'},
    'Le regole per un sito internazionale che viene trovato: la visibilità è una delle leve del ritorno.': {'en': 'The rules for an international site that gets found: visibility is one of the levers of the return.'},
    'L’istituto nazionale di statistica: dati ufficiali su imprese ed esportazioni italiane, utili per dimensionare un mercato.': {'en': 'The national statistics institute: official data on Italian businesses and exports, useful for sizing a market.'},
    'Stima il ROI della localizzazione del tuo sito: calcolatore gratuito →': {'en': 'Estimate your site’s localization ROI: free calculator →'},
    'ROI della localizzazione di un sito: il ritorno di tradurre davvero, tra costo, mercato raggiungibile e conversione': {'en': 'A site’s localization ROI: the return of really translating, between cost, reachable market and conversion'},
    'Come si costruisce il ROI della localizzazione: costo dell’adattamento contro mercato raggiungibile, visibilità nella nuova lingua e conversione più alta': {'en': 'How localization ROI is built: cost of adaptation against reachable market, visibility in the new language and higher conversion'},
}
CHROME.update(CHROME_BLOG_BATCH10)

CHROME_BLOG_BATCH10_EXCERPTS = {
    'A Roma il cliente vi cerca «vicino a me» prima di alzare il telefono. Come funziona la SEO locale nella capitale dei servizi, cosa pesa davvero nel ranking e da dove partire.': {'en': 'In Rome the customer looks for you «near me» before picking up the phone. How local SEO works in the capital of services, what really weighs in the ranking and where to start.'},
    'A Torino il cliente è spesso un buyer tecnico che valuta un fornitore anche da come lo trova online. Come funziona la SEO locale in una città di manifattura e come emergere tra le imprese che esportano.': {'en': 'In Turin the customer is often a technical buyer who judges a supplier also by how they find it online. How local SEO works in a manufacturing city and how to stand out among the companies that export.'},
    'A Napoli il turismo è esploso e il pubblico è internazionale: legge le recensioni e prenota online, in inglese. Perché un sito multilingue fatto bene fa prenotare diretto, e come costruirlo.': {'en': 'In Naples tourism has exploded and the audience is international: it reads reviews and books online, in English. Why a well-built multilingual website gets direct bookings, and how to build it.'},
    'La traduzione automatica ha fatto progressi reali. Ma per il sito che deve vendere e convincere, quando conta ancora la mano di un madrelingua? Una guida onesta ed equilibrata.': {'en': 'Machine translation has made real progress. But for the site that has to sell and convince, when does the hand of a native speaker still matter? An honest, balanced guide.'},
    'Tradurre il sito è un costo o un investimento? Come si ragiona sul ROI della localizzazione, quali numeri guardare e come stimare se aprire una lingua conviene davvero.': {'en': 'Is translating the site a cost or an investment? How to reason about localization ROI, which numbers to look at and how to estimate whether opening a language really pays.'},
}
CHROME.update(CHROME_BLOG_BATCH10_EXCERPTS)

# Batch 10 — stringhe senza «Italian hint» che il conveyor non segnala (titolo Torino,
# H2 «Da dove partire», etichette fonti Istat/CSA, data): aggiunte a mano dopo scan lookup.
CHROME_BLOG_BATCH10_TAIL = {
    '24 LUG 2026': {'en': '24 JUL 2026'},
    'Da dove partire, a Roma e in provincia': {'en': 'Where to start, in Rome and across the province'},
    'Istat — statistiche su imprese e territorio': {'en': 'Istat — statistics on businesses and territory'},
    'SEO locale a Torino: farsi trovare tra industria ed export': {'en': 'Local SEO in Turin: getting found between industry and export'},
    'Da dove partire, a Torino e verso l’estero': {'en': 'Where to start, in Turin and toward foreign markets'},
    'Istat — statistiche su imprese e industria': {'en': 'Istat — statistics on businesses and industry'},
    'CSA Research — Can’t Read, Won’t Buy →': {'en': 'CSA Research — Can’t Read, Won’t Buy →'},
    'Multilingue fatto bene: hreflang e SEO internazionale': {'en': 'Multilingual done right: hreflang and international SEO'},
    'CSA Research — Can’t Read, Won’t Buy': {'en': 'CSA Research — Can’t Read, Won’t Buy'},
    'Istat — statistiche su imprese ed export': {'en': 'Istat — statistics on businesses and exports'},
}
CHROME.update(CHROME_BLOG_BATCH10_TAIL)

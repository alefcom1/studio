...
function remarka_checkup_copy( string $locale ): array {
	$decks = array(
		'it' => array(
			...
			'ai_insight_label' => "Il parere dell'AI",
			'ai_insight_note'  => 'Lettura sintetica generata da un\'intelligenza artificiale sui vostri sette punteggi — un parere, non una certificazione.',
		),
		'en' => array(
			...
			'ai_insight_label' => "The AI's take",
			'ai_insight_note'  => 'A short reading generated by an AI from your seven scores — an opinion, not a certification.',
		),
		'ru' => array(
			...
			'ai_insight_label' => 'Мнение ИИ',
			'ai_insight_note'  => 'Краткое резюме, сгенерированное ИИ по вашим семи оценкам, — мнение, не сертификат.',
		),
	);
...
function remarka_checkup_render_html( array $data, string $locale ): string {
	...
	<div class="page">
		...
		<?php if ( ! empty( $data['ai_insight'] ) ) : ?>
			<p class="mono muted" style="margin-top:10px"><?php echo esc_html( $copy['ai_insight_label'] ); ?></p>
			<p class="box"><?php echo esc_html( $data['ai_insight'] ); ?></p>
			<p class="muted" style="font-size:10px"><?php echo esc_html( $copy['ai_insight_note'] ); ?></p>
		<?php endif; ?>

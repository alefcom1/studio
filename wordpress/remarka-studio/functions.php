...
function remarka_case_study_schema(): void {
	$cases = array(
		...
		'remarka-ai' => array(
			'name'        => 'Remarka AI — piattaforma di traduzione AI di documenti',
			'live_url'    => 'https://ai.perevod4.ru',
			'category'    => 'BusinessApplication',
			'description' => 'Piattaforma SaaS di traduzione AI di documenti (DOCX, XLSX, PDF) sviluppata dal gruppo Remarka: pipeline OCR, glossario automatico, memoria di traduzione, motore di QA ed export multiformato.',
			'shots'       => array( 'ai-home-it-1440.webp' ),
			'crumb'       => 'Remarka AI',
		),
		...
		'pere-rf' => array(
			'type'        => 'WebSite',
			'name'        => 'пере.рф — bureau di traduzioni',
			'live_url'    => 'https://пере.рф',
			'description' => 'Sito del bureau di traduzioni пере.рф, portato dal gruppo Remarka in prima pagina su Yandex e Google per le principali query di settore grazie a SEO tecnica e a un dominio cirillico di due lettere.',
			'shots'       => array( 'pererf-home-1440.webp' ),
			'crumb'       => 'пере.рф',
		),
		'perevod4-catalogo' => array(
			'type'        => 'WebSite',
			'name'        => 'perevod4.ru — catalogo dei bureau di traduzioni',
			'live_url'    => 'https://perevod4.ru',
			'description' => 'Catalogo che indicizza oltre 200 bureau di traduzioni russi, costruito dal gruppo Remarka: SEO e architettura testate su un intero settore, non su una demo.',
			'shots'       => array( 'perevod4-catalog-1440.webp' ),
			'crumb'       => 'perevod4.ru',
		),
		'moscowtrans-techperevod' => array(
			'type'        => 'WebSite',
			'name'        => 'moscowtrans.ru · techperevod.com',
			'live_url'    => 'https://moscowtrans.ru',
			'description' => 'Due siti d\'agenzia di traduzioni ridisegnati dal gruppo Remarka nel 2026: restyling che mantiene il posizionamento SEO, migliora le performance e ha fatto crescere le conversioni di oltre il 300%.',
			'shots'       => array( 'moscowtrans-home-1440.webp', 'techperevod-home-1440.webp' ),
			'crumb'       => 'moscowtrans.ru · techperevod.com',
		),
		'ukrinitsy' => array(
			'type'        => 'WebSite',
			'name'        => 'ukrinitsy.ru — guest house',
			'live_url'    => 'https://ukrinitsy.ru',
			'description' => 'Sito vetrina di una guest house sul Mar Nero, sviluppato dal gruppo Remarka con un modulo di prenotazione proprio (senza commissioni) e un pianificatore d\'itinerario con guida alla zona.',
			'shots'       => array( 'ukrinitsy-booking-1440.webp' ),
			'crumb'       => 'ukrinitsy.ru',
		),
		'gioco' => array(
			'type'        => 'VideoGame',
			'name'        => 'L\'Impero delle Traduzioni',
			'live_url'    => 'https://traduzione.tech/gioco/',
			'description' => 'Gioco browser sviluppato dal gruppo Remarka: un simulatore di bureau di traduzioni — gamification al servizio del marketing, dentro il sito dell\'agenzia.',
			'shots'       => array( 'gioco-play-1440.webp' ),
			'crumb'       => "L'Impero delle Traduzioni",
		),
		'test-traduttori' => array(
			'type'        => 'WebApplication',
			'name'        => 'Sistema di test dei traduttori',
			'live_url'    => 'https://moscowtrans.ru/test-perevodchika',
			'category'    => 'BusinessApplication',
			'description' => 'Sistema web di test progressivo dei traduttori sviluppato dal gruppo Remarka: valutazione automatica e selezione degli esecutori per i progetti del gruppo.',
			'shots'       => array( 'tester-exam-1440.webp' ),
			'crumb'       => 'Test dei traduttori',
		),
	);

 ...
 * Description: Placeholder onesto per lo strumento Check GDPR e cookie (non ancora implementato).
 * Viewport Width: 1400
 */
?>
...
<p class="has-grigio-color has-text-color has-medium-font-size" style="max-width:100%">Проверяем баннер cookie, уведомления и согласия: чего не хватает, чтобы соответствовать требованиям итальянского регулятора Garante.</p>
<!-- /wp:paragraph -->
</section>
<!-- /wp:group -->

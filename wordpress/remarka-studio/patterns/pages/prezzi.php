...
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-mono" style="margin-top:10px;font-size:12px;color:var(--sr-grigio)">100% DEI PREVENTIVI 2025 CHIUSI AL PREZZO FIRMATO</p></div>
<!-- /wp:html -->
</section>
<!-- /wp:group -->
...
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="margin-top:12px;max-width:70ch">Le forbici di mercato vengono dai listini pubblici delle web agency italiane (2026). Le nostre cifre sono quelle del contratto.</p>
<!-- /wp:paragraph -->
<!-- wp:html -->
<div class="sr-market-table" style="margin-top:40px"><table><thead><tr><th>Prodotto</th><th>Prezzo di mercato</th><th class="sr-market-table__uscol">Prezzo Remarka</th><th>Tempi di mercato</th><th class="sr-market-table__uscol">Tempi Remarka</th></tr></thead><tbody><tr><td class="sr-market-table__prod">Sito vetrina</td><td>€ 1.000–3.000</td><td class="sr-market-table__us sr-market-table__us--lancio">{{listino}}€ 1.900–2.800{{/listino}}{{lancio}}<s class="sr-lancio-listino">€ 1.900–2.800</s><span class="sr-lancio-price">€ 950–1.400</span>{{/lancio}}</td><td>2–4 settimane</td><td class="sr-market-table__us">2 settimane</td></tr><tr><td class="sr-market-table__prod">Sito aziendale</td><td>€ 2.500–8.000</td><td class="sr-market-table__us sr-market-table__us--lancio">{{listino}}€ 3.900–5.800{{/listino}}{{lancio}}<s class="sr-lancio-listino">€ 3.900–5.800</s><span class="sr-lancio-price">€ 1.950–2.900</span>{{/lancio}}</td><td>6–10 settimane</td><td class="sr-market-table__us">3 settimane</td></tr><tr><td class="sr-market-table__prod">E-commerce</td><td>€ 6.000–25.000</td><td class="sr-market-table__us sr-market-table__us--lancio">{{listino}}€ 7.500–14.000{{/listino}}{{lancio}}<s class="sr-lancio-listino">€ 7.500–14.000</s><span class="sr-lancio-price">€ 3.750–7.000</span>{{/lancio}}</td><td>8–14 settimane</td><td class="sr-market-table__us">6 settimane</td></tr></tbody></table></div>
<!-- /wp:html -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"small"} -->
<p class="has-grigio-color has-text-color has-small-font-size" style="margin-top:20px">Forbici di mercato dai listini pubblici delle web agency italiane, 2026. Analisi completa con le fonti nel nostro blog: <a href="/blog/quanto-costa-sito-aziendale-italia/">«Quanto costa un sito aziendale in Italia»</a>.</p>
<!-- /wp:paragraph -->
</section>
<!-- /wp:group -->
...
<!-- /wp:paragraph -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="margin-bottom:24px">Tre voci, sempre le stesse. Le trovate esplicitate riga per riga nel preventivo.</p>
<!-- /wp:paragraph -->
<!-- wp:html -->
<div class="sr-list-rows"><div><span class="sr-mono">a</span><span><strong>Contenuti:</strong> pagine e schede oltre quelle incluse, servizi fotografici, testi da scrivere ex novo.</span></div><div><span class="sr-mono">b</span><span><strong>Lingue:</strong> ogni lingua oltre quelle comprese, tradotta da madrelingua del gruppo Remarka.</span></div><div><span class="sr-mono">c</span><span><strong>Integrazioni:</strong> gestionale, CRM, listini, sistemi di prenotazione o pagamento particolari.</span></div></div>
<!-- /wp:html -->
</section>
<!-- /wp:group -->
<!-- wp:shortcode -->
...
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="margin-top:12px">Descriveteci il progetto: ricevete prezzo e data di consegna, entrambi vincolanti.</p>
<!-- /wp:paragraph -->

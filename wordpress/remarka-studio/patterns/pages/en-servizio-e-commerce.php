<?php
/**
 * Title: Pagina — Servizio: E-commerce
 * Slug: remarka-studio/en-servizio-e-commerce
 * Categories: remarka-pagine
 * Description: Pagina completa del servizio E-commerce: hero, per chi è, cosa include, mini caso, prezzo, FAQ, CTA.
 * Viewport Width: 1400
 */
?>
...
<p class="sr-eyebrow">Service / E-commerce</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(38px, 4.6vw, 64px)"}}} -->
<h1 class="wp-block-heading" style="font-size:clamp(38px, 4.6vw, 64px)">The online store that doesn’t lose customers at checkout<span class="sr-accent-dot">.</span></h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="max-width:640px;margin-top:24px">E-commerce website with a fast catalog, one-step checkout and built-in e-invoicing: designed for businesses that sell, not just get browsed.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/en/case-studies/">See the case studies</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
...
<div class="sr-stat" style="max-width:260px"><span class="sr-stat__num" style="color:var(--sr-oltremare)">1.4 s</span><p style="margin-top:16px;font-size:15.5px;color:var(--sr-grigio)">Average load time (LCP) across e-commerce sites delivered in 2025.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">An e-commerce website for businesses serious about selling, not just displaying<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"62%"} -->
<div class="wp-block-column" style="flex-basis:62%"><!-- wp:html -->
<div class="sr-list-rows"><div><span class="sr-mono">a</span><span>Businesses selling online that lose customers right at checkout.</span></div><div><span class="sr-mono">b</span><span>Brick-and-mortar stores ready to open an e-commerce channel without improvising.</span></div><div><span class="sr-mono">c</span><span>Anyone who needs automatic e-invoicing, not a plugin to chase after.</span></div></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Everything spelled out in the quote<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
<!-- wp:html -->
<div class="sr-checklist"><div><span class="sr-mono">✓</span><span>Unlimited product catalog with variants</span></div><div><span class="sr-mono">✓</span><span>One-step checkout</span></div><div><span class="sr-mono">✓</span><span>Card, PayPal, and bank transfer payments</span></div><div><span class="sr-mono">✓</span><span>E-invoicing via SDI (Italian exchange system), built in</span></div><div><span class="sr-mono">✓</span><span>Inventory and shipping management</span></div><div><span class="sr-mono">✓</span><span>Technical SEO for product pages</span></div><div><span class="sr-mono">✓</span><span>PageSpeed 90+ guaranteed by contract</span></div><div><span class="sr-mono">✓</span><span>12 months of support and monthly measurements</span></div></div>
<!-- /wp:html -->
<!-- wp:html -->
...
<p class="has-base-font-size" style="margin-top:16px;font-size:16px">A brochure site for a small guest house: photos, contacts and a booking request within reach. Bookings grew 450% after launch.</p>
<!-- /wp:paragraph -->
<!-- wp:html -->
<div class="sr-teaser-stats" style="display:flex;flex-wrap:wrap;gap:16px 28px;margin-top:20px"><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">+450%</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">bookings after launch</p></div><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">18</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">bookings in a season, from the site</p></div></div>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-mono" style="font-size:11px;letter-spacing:0.06em;color:var(--sr-grigio);margin-top:16px">REMARKA GROUP PROJECT — VERIFIABLE ON UKRINITSY.RU</p>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-card-link" style="margin-top:16px"><a href="/en/case-studies/#ukrinitsy">Read the full case study →</a></p>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<p class="has-grigio-color has-text-color has-base-font-size" style="margin-top:14px;max-width:60ch">Fixed price locked in the quote, delivery in 6 weeks. E-invoicing, payment in three installments.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
...
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Do you handle e-invoicing too?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Yes, every order automatically generates an SDI-compliant electronic invoice.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Can I sell abroad as well?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Yes, the catalog supports multiple languages and multiple currencies on request.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Do the domain and customer data stay ours?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Always. Domain, order database, and code are registered in your name from day one.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:group -->
</section>
<!-- /wp:group -->
<!-- wp:shortcode -->
[remarka_cluster slug="e-commerce"]
<!-- /wp:shortcode -->

<?php
/**
 * Title: Pagina — Servizio: Siti aziendali
 * Slug: remarka-studio/servizio-siti-aziendali
 * Categories: remarka-pagine
 * Description: Pagina completa del servizio Siti aziendali: hero, per chi è, cosa include, mini caso, prezzo, FAQ, CTA.
 * Viewport Width: 1400
 */
?>
...
<p class="sr-eyebrow">Servizio / Siti aziendali</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(38px, 4.6vw, 64px)"}}} -->
<h1 class="wp-block-heading" style="font-size:clamp(38px, 4.6vw, 64px)">Il sito aziendale che carica in un secondo<span class="sr-accent-dot">.</span></h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="max-width:640px;margin-top:24px">Un sito web aziendale di quindici pagine, due lingue e un CMS per aggiornarlo da soli. Progettato per trasformare le visite in richieste di preventivo.</p>
<!-- /wp:paragraph -->
...
<div class="sr-stat" style="max-width:260px"><span class="sr-stat__num" style="color:var(--sr-oltremare)">1,1 s</span><p style="margin-top:16px;font-size:15.5px;color:var(--sr-grigio)">Caricamento medio (LCP) dei siti aziendali consegnati nel 2025.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Un sito web aziendale per chi vive di richieste, non di clic<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"62%"} -->
<div class="wp-block-column" style="flex-basis:62%"><!-- wp:html -->
<div class="sr-list-rows"><div><span class="sr-mono">a</span><span>PMI manifatturiere con cataloghi tecnici e clienti B2B che confrontano fornitori.</span></div><div><span class="sr-mono">b</span><span>Studi professionali e società di servizi che vivono di reputazione e primo contatto.</span></div><div><span class="sr-mono">c</span><span>Aziende con clienti esteri: la versione inglese o tedesca è tradotta da madrelingua, inclusa.</span></div></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:heading -->
<!-- wp:html -->
<div class="sr-checklist"><div><span class="sr-mono">✓</span><span>Fino a 15 pagine, struttura studiata sul funnel</span></div><div><span class="sr-mono">✓</span><span>Due lingue incluse, tradotte da madrelingua</span></div><div><span class="sr-mono">✓</span><span>CMS: testi e foto li aggiornate da soli</span></div><div><span class="sr-mono">✓</span><span>SEO tecnica completa e dati strutturati</span></div><div><span class="sr-mono">✓</span><span>GDPR: banner, informative e consensi a norma</span></div><div><span class="sr-mono">✓</span><span>PageSpeed 90+ garantito da contratto</span></div><div><span class="sr-mono">✓</span><span>Modulo contatti con notifiche immediate</span></div><div><span class="sr-mono">✓</span><span>12 mesi di assistenza e misurazioni mensili</span></div></div>
<!-- /wp:html -->
<!-- wp:html -->
...
<!-- /wp:paragraph -->
<!-- wp:html -->
<div class="sr-teaser-stats" style="display:flex;flex-wrap:wrap;gap:16px 28px;margin-top:20px"><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">20/mese</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">ordini generati dal sito</p></div><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">40+</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">combinazioni linguistiche coperte</p></div></div>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-mono" style="font-size:11px;letter-spacing:0.06em;color:var(--sr-grigio);margin-top:16px">PROGETTO DEL GRUPPO REMARKA — VERIFICABILE SU TRADUZIONE.TECH</p>
<!-- /wp:html -->
<!-- wp:html -->
...
<!-- /wp:paragraph -->
<!-- wp:html -->
<div class="sr-list-rows"><div><span class="sr-mono">a</span><span>Numero di pagine e schede prodotto oltre le 15 incluse.</span></div><div><span class="sr-mono">b</span><span>Lingue aggiuntive oltre le due comprese.</span></div><div><span class="sr-mono">c</span><span>Integrazioni con gestionale, CRM o listini esterni.</span></div></div>
<!-- /wp:html -->
<!-- wp:html -->
...
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Possiamo tenere i testi attuali?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Sì. Li revisioniamo gratuitamente in fase di analisi e vi diciamo cosa conviene riscrivere, e perché.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Il dominio resta nostro?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Sempre. Dominio, hosting e codice sono intestati a voi dal primo giorno. Nessun vincolo con lo studio.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">E dopo i 12 mesi di assistenza?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Canone annuale facoltativo, con lo stesso perimetro. Oppure il sito resta a voi così com’è: è vostro.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:group -->
</section>
<!-- /wp:group -->
<!-- wp:shortcode -->
[remarka_cluster slug="siti-aziendali"]
<!-- /wp:shortcode -->

<?php
/**
 * Title: Pagina — Città: Bergamo
 * Slug: remarka-studio/citta-bergamo
 * Categories: remarka-pagine
 * Description: Landing locale «realizzazione siti web bergamo»: servizi, caso, prezzi, recensioni, FAQ.
 * Viewport Width: 1400
 */
?>
...
<p class="sr-eyebrow">BERGAMO E PROVINCIA</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(38px,4.6vw,64px)"}}} -->
<h1 class="wp-block-heading" style="font-size:clamp(38px,4.6vw,64px)">Realizzazione siti web a Bergamo<span class="sr-accent-dot">.</span></h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size">Siti progressivi per PMI di Bergamo e provincia: PageSpeed 90+ garantito da contratto, consegna a data fissa, prezzo chiuso. Versione in tedesco tradotta da madrelingua per chi lavora con l’estero.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:buttons -->
<!-- wp:html -->
<div class="sr-stat"><span class="sr-stat__num sr-counter" style="color:var(--sr-oltremare)">6</span><p style="margin-top:16px;font-weight:500">progetti consegnati a Bergamo e provincia dal 2024</p></div>
<!-- /wp:html -->
</section>
<!-- /wp:group -->
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Realizzazione siti web a Bergamo, e non solo<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
<!-- wp:html -->
...
<p class="sr-eyebrow">Dietro la garanzia «madrelingua per profilo»</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">La piattaforma che testa i traduttori</h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"base"} -->
<p class="has-grigio-color has-text-color has-base-font-size" style="margin-top:12px">Oltre 400 traduttori testati — e solo l'8% supera la selezione. Ogni traduttore che lavora sui vostri testi è dentro quell'8%: la qualità decisa da un sistema, non a intuito.</p>
<!-- /wp:paragraph -->
<!-- wp:html -->
<p class="sr-card-link" style="margin-top:20px"><a href="/casi-studio/#test-traduttori">Leggi il caso completo →</a></p>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Quanto costa un sito web a Bergamo<span class="sr-accent-dot">?</span></h2>
<!-- /wp:heading -->
<!-- wp:html -->
...
<p class="sr-eyebrow">Come lavoriamo con Bergamo</p>
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Vicini quanto serve<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="margin-top:16px;max-width:70ch">Un’ora dal nostro studio di Milano: primo incontro in azienda senza costi, da Bergamo città alle valli. Per il resto: ambiente di prova online e avanzamento visibile ogni venerdì.</p>
<!-- /wp:paragraph -->
</section>
<!-- /wp:group -->
<!-- wp:group {"tagName":"section","className":"sr-section sr-section--bianco","layout":{"type":"constrained","contentSize":"1240px"}} -->
<section class="wp-block-group is-layout-constrained sr-section sr-section--bianco"><!-- wp:paragraph {"className":"sr-eyebrow"} -->
<p class="sr-eyebrow">Dicono di noi, da Bergamo e dintorni</p>
<!-- /wp:paragraph -->
<!-- wp:heading -->
...
<div class="wp-block-group is-layout-grid" style="--sr-grid-min:260px"><div class="sr-card"><p class="sr-mono" style="color:var(--sr-oltremare)">★★★★★</p><p style="margin-top:14px;font-size:15.5px;line-height:1.6">«I clienti di Bressanone e Merano finalmente trovano tutto in tedesco. Le richieste sono triplicate.»</p><p class="sr-mono" style="margin-top:16px;font-size:13px;color:var(--sr-grigio)">Titolare — impianti idraulici, Bergamo</p></div><div class="sr-card"><p class="sr-mono" style="color:var(--sr-oltremare)">★★★★★</p><p style="margin-top:14px;font-size:15.5px;line-height:1.6">«Sito consegnato il giorno scritto nel contratto. Non ci credevamo, è successo.»</p><p class="sr-mono" style="margin-top:16px;font-size:13px;color:var(--sr-grigio)">Luca R. — carpenteria metallica, Dalmine</p></div><div class="sr-card"><p class="sr-mono" style="color:var(--sr-oltremare)">★★★★★</p><p style="margin-top:14px;font-size:15.5px;line-height:1.6">«Il modulo contatti ci avvisa su WhatsApp: rispondiamo ai preventivi prima dei concorrenti.»</p><p class="sr-mono" style="margin-top:16px;font-size:13px;color:var(--sr-grigio)">Sara V. — serramenti, Treviglio</p></div></div>
<!-- /wp:group -->
</section>
<!-- /wp:group -->
<!-- wp:group {"tagName":"section","className":"sr-section","layout":{"type":"constrained","contentSize":"1240px"}} -->
<section class="wp-block-group is-layout-constrained sr-section"><!-- wp:paragraph {"className":"sr-eyebrow"} -->
<p class="sr-eyebrow">Domande da Bergamo</p>
<!-- /wp:paragraph -->
<!-- wp:details -->
<details class="wp-block-details"><summary>Quanto costa un sito web a Bergamo?</summary><!-- wp:paragraph -->
...
<!-- /wp:details -->
<!-- wp:details -->
<details class="wp-block-details"><summary>Fate siti in tedesco per chi lavora con l’estero?</summary><!-- wp:paragraph -->
<p>Sì, ed è la nostra specialità: le traduzioni le fanno madrelingua del gruppo Remarka (nel settore dal 2001), selezionati da una piattaforma di test interna che scarta il 92% dei candidati — la stessa che tiene la qualità di tutti i nostri progetti multilingue.</p>
<!-- /wp:paragraph --></details>
<!-- /wp:details -->
<!-- wp:details -->
<details class="wp-block-details"><summary>Il primo incontro è davvero gratuito?</summary><!-- wp:paragraph -->
<p>Sì: veniamo noi in azienda, analizziamo il sito attuale e vi lasciamo un report scritto con le priorità. Il preventivo arriva entro 24 ore.</p>
<!-- /wp:paragraph --></details>
<!-- /wp:details -->
</section>
<!-- /wp:group -->
...
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="margin-top:12px">Primo incontro gratuito, da voi in azienda. Preventivo chiuso entro 24 ore.</p>
<!-- /wp:paragraph -->

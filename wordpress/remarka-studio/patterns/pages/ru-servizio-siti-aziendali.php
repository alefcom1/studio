 ...
 * Slug: remarka-studio/ru-servizio-siti-aziendali
...
<p class="sr-eyebrow">Услуга / Корпоративные сайты</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(38px, 4.6vw, 64px)"}}} -->
<h1 class="wp-block-heading" style="font-size:clamp(38px, 4.6vw, 64px)">Корпоративный сайт, который загружается за секунду<span class="sr-accent-dot">.</span></h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="max-width:640px;margin-top:24px">Пятнадцать страниц, два языка, CMS для самостоятельного обновления. Спроектирован так, чтобы превращать визиты в заявки на расчёт стоимости.</p>
<!-- /wp:paragraph -->
...
<div class="sr-stat" style="max-width:260px"><span class="sr-stat__num" style="color:var(--sr-oltremare)">1,1 с</span><p style="margin-top:16px;font-size:15.5px;color:var(--sr-grigio)">Средняя загрузка (LCP) корпоративных сайтов, сданных в 2025 году.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Для тех, кто живёт заявками, а не кликами<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"62%"} -->
<div class="wp-block-column" style="flex-basis:62%"><!-- wp:html -->
<div class="sr-list-rows"><div><span class="sr-mono">a</span><span>Производственные компании малого и среднего бизнеса с техническими каталогами и B2B-клиентами, которые сравнивают поставщиков.</span></div><div><span class="sr-mono">b</span><span>Профессиональные бюро и сервисные компании, которые живут репутацией и первым контактом.</span></div><div><span class="sr-mono">c</span><span>Компании с зарубежными клиентами: английская или немецкая версия в переводе носителя — включена в цену.</span></div></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<p class="has-base-font-size" style="margin-top:16px;font-size:16px">Корпоративный сайт на итальянском и немецком для монтажной компании с клиентами в Южном Тироле. Втрое больше заявок с формы за первый квартал.</p>
<!-- /wp:paragraph -->
<!-- wp:html -->
<p class="sr-card-link" style="margin-top:16px"><a href="/ru/kejsy/tecnoidraulica/">Читать полный кейс →</a></p>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"45%"} -->
...
<!-- /wp:html -->
<!-- wp:html -->
<div class="sr-barra-row"><span class="sr-eyebrow" style="margin:0">До</span><span class="sr-barra-row__val">29</span></div><div class="sr-barra" style="height:8px" data-sr-target="29%" data-sr-delay="0" role="img" aria-label="До: 29 из 100"><div class="sr-barra__fill sr-barra__fill--muted"></div></div>
<!-- /wp:html -->
<!-- wp:html -->
<div class="sr-barra-row"><span class="sr-eyebrow" style="margin:0">После</span><span class="sr-barra-row__val sr-barra-row__val--verde">94</span></div><div class="sr-barra" style="height:8px" data-sr-target="94%" data-sr-delay="150" role="img" aria-label="После: 94 из 100"><div class="sr-barra__fill"></div></div>
<!-- /wp:html -->
<!-- wp:html -->
...
<p class="has-grigio-color has-text-color has-base-font-size" style="margin-top:14px;max-width:60ch">Цена фиксируется в смете, сдача за 5–7 недель. Электронный счёт-фактура, оплата тремя платежами.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
...
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Можно оставить наши нынешние тексты?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Да. На этапе анализа мы бесплатно их вычитываем и говорим, что стоит переписать — и почему.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Домен останется нашим?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Всегда. Домен, хостинг и код оформлены на вас с первого дня. Никакой привязки к студии.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">А после 12 месяцев поддержки?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Необязательная годовая подписка с тем же объёмом работ. Или сайт просто остаётся у вас как есть: он ваш.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:group -->
</section>

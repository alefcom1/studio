 ...
 * Slug: remarka-studio/ru-servizio-seo-tecnica
...
<p class="sr-eyebrow">Услуга / Техническая SEO</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(38px, 4.6vw, 64px)"}}} -->
<h1 class="wp-block-heading" style="font-size:clamp(38px, 4.6vw, 64px)">Структура и данные в порядке — ещё до того, как писать тексты<span class="sr-accent-dot">.</span></h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="max-width:640px;margin-top:24px">Core Web Vitals, структурированные данные и корректный sitemap: техническая часть SEO — та, которую одним копирайтингом не решить.</p>
<!-- /wp:paragraph -->
...
<div class="sr-stat" style="max-width:260px"><span class="sr-stat__num" style="color:var(--sr-oltremare)">90+</span><p style="margin-top:16px;font-size:15.5px;color:var(--sr-grigio)">Оценка Core Web Vitals, гарантированная договором.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Для тех, у кого хороший контент и слабая видимость<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"62%"} -->
<div class="wp-block-column" style="flex-basis:62%"><!-- wp:html -->
<div class="sr-list-rows"><div><span class="sr-mono">a</span><span>Сайты с хорошим контентом, но слабой видимостью в Google.</span></div><div><span class="sr-mono">b</span><span>Те, кто уже вложился в копирайтинг, но не увидел результата в выдаче.</span></div><div><span class="sr-mono">c</span><span>Бизнесы на тесных локальных рынках, где важна каждая позиция.</span></div></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:html -->
<!-- wp:html -->
[sr_shot file="pererf-home-1440.webp" alt="Сайт пере.рф — кейс технической SEO на кириллическом домене" caption="пере.рф — главная страница" mobile="0"]
<!-- /wp:html -->
</div>
<!-- /wp:group -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:html -->
<div class="sr-teaser-stats" style="display:flex;flex-wrap:wrap;gap:16px 28px;margin-top:20px"><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">№ 1</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">в Яндексе по «нотариальный перевод»</p></div><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">9–10 тыс./мес.</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">посетителей, в топе больше 1 000 дней</p></div></div>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-mono" style="font-size:11px;letter-spacing:0.06em;color:var(--sr-grigio);margin-top:16px">ПРОЕКТ ГРУППЫ REMARKA — МОЖНО ПРОВЕРИТЬ НА ПЕРЕ.РФ</p>
<!-- /wp:html -->
<!-- wp:html -->
...
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Как быстро видны результаты?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Технические улучшения — сразу; рост позиций в Google занимает в среднем 6–10 недель.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Вы пишете и тексты?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Услуга техническая; тексты по запросу пишут наши копирайтеры-партнёры.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Делаете локальную SEO?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Да, при необходимости включаем оптимизацию карточки Google Business Profile.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:group -->
</section>

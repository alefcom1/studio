...
<!-- /wp:group -->
<!-- wp:html -->
<div style="margin-top:24px;display:flex;flex-direction:column;gap:8px;align-items:flex-start"><p class="sr-card-link" style="margin-top:12px"><a href="/servizi/restyling-migrazione/">Vogliamo intervenire noi: scopri il restyling tecnico →</a></p><p class="sr-card-link" style="margin-top:12px"><a href="/blog/sito-lento-cause-costi/">Approfondisci: le 7 cause reali di un sito lento →</a></p><p class="sr-card-link" style="margin-top:12px"><a href="/blog/hosting-sito-web-italia/">Guida: hosting in Italia o in cloud, cosa cambia per velocità e GDPR →</a></p></div>
<!-- /wp:html -->
</section>
<!-- /wp:group -->

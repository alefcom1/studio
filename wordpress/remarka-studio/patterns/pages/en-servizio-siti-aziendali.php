...
<p class="has-base-font-size" style="margin-top:16px;font-size:16px">A business website for a translation agency with more than twenty years of history: fast quotes, clear services for the Italian B2B client. Live since 2022, it brings the agency around 20 orders a month.</p>
<!-- /wp:paragraph -->
<!-- wp:html -->
<div class="sr-teaser-stats" style="display:flex;flex-wrap:wrap;gap:16px 28px;margin-top:20px"><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">20/month</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">orders generated by the site</p></div><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">40+</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">language combinations covered</p></div></div>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-mono" style="font-size:11px;letter-spacing:0.06em;color:var(--sr-grigio);margin-top:16px">REMARKA GROUP PROJECT — VERIFIABLE ON TRADUZIONE.TECH</p>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-card-link" style="margin-top:16px"><a href="/en/case-studies/#att-traduzione-tech">Read the full case study →</a></p>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>

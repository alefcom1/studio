...
<div class="sr-stat"><span class="sr-stat__num" style="font-size:clamp(30px,3vw,40px);color:var(--sr-oltremare)">20/month</span><p style="margin-top:8px;font-size:14px;color:var(--sr-grigio)">orders generated by the site</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div class="sr-stat" style="margin-top:24px"><span class="sr-stat__num" style="font-size:clamp(30px,3vw,40px);color:var(--sr-oltremare)">40+</span><p style="margin-top:8px;font-size:14px;color:var(--sr-grigio)">language combinations covered</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-mono" style="font-size:11px;letter-spacing:0.06em;color:var(--sr-grigio);margin-top:20px">REMARKA GROUP PROJECT — VERIFIABLE ON TRADUZIONE.TECH</p>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>

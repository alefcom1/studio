 ...
 * Slug: remarka-studio/en-servizio-siti-aziendali
...
<p class="sr-eyebrow">Service / Business websites</p>
<!-- /wp:paragraph -->
...
<div class="sr-stat" style="max-width:260px"><span class="sr-stat__num" style="color:var(--sr-oltremare)">1.1 s</span><p style="margin-top:16px;font-size:15.5px;color:var(--sr-grigio)">Average load time (LCP) across business websites delivered in 2025.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<div class="sr-list-rows"><div><span class="sr-mono">a</span><span>Manufacturing SMBs with technical catalogs and B2B clients who compare suppliers.</span></div><div><span class="sr-mono">b</span><span>Professional firms and service companies that live on reputation and first contact.</span></div><div><span class="sr-mono">c</span><span>Companies with customers abroad: the English or German version is translated by native speakers, included.</span></div></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<p class="has-base-font-size" style="margin-top:16px;font-size:16px">Business website in Italian and German for an installer with clients in South Tyrol. Three times more inquiries from the contact form in the first quarter.</p>
<!-- /wp:paragraph -->
<!-- wp:html -->
<p class="sr-card-link" style="margin-top:16px"><a href="/en/case-studies/tecnoidraulica/">Read a full case study →</a></p>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"45%"} -->
...
<!-- /wp:html -->
<!-- wp:html -->
<div class="sr-barra-row"><span class="sr-eyebrow" style="margin:0">Before</span><span class="sr-barra-row__val">29</span></div><div class="sr-barra" style="height:8px" data-sr-target="29%" data-sr-delay="0" role="img" aria-label="Before: 29 out of 100"><div class="sr-barra__fill sr-barra__fill--muted"></div></div>
<!-- /wp:html -->
<!-- wp:html -->
<div class="sr-barra-row"><span class="sr-eyebrow" style="margin:0">After</span><span class="sr-barra-row__val sr-barra-row__val--verde">94</span></div><div class="sr-barra" style="height:8px" data-sr-target="94%" data-sr-delay="150" role="img" aria-label="After: 94 out of 100"><div class="sr-barra__fill"></div></div>
<!-- /wp:html -->
<!-- wp:html -->
...
<p class="has-grigio-color has-text-color has-base-font-size" style="margin-top:14px;max-width:60ch">Fixed price locked in the quote, delivery in 5–7 weeks. E-invoicing, payment in three installments.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
...
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Can we keep our current copy?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Yes. We review it free of charge during the analysis phase and tell you what is worth rewriting, and why.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Does the domain stay ours?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Always. Domain, hosting, and code are registered in your name from day one. No lock-in with the studio.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">What happens after the 12 months of support?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">An optional annual plan, with the same scope. Or the site stays with you as is: it is yours.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:group -->
</section>

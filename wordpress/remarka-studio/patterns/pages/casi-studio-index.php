 ...
 * Description: Elenco dei casi studio in griglia 2×2 con metriche chiave e barre prima/dopo.
 * Viewport Width: 1400
 */
?>
...
<h1 class="wp-block-heading" style="font-size:clamp(38px,4.6vw,64px)">Risultati misurati, non promessi<span class="sr-accent-dot">.</span></h1>
<!-- /wp:heading -->
</section>
<!-- /wp:group -->
<!-- wp:group {"tagName":"section","className":"sr-section","layout":{"type":"constrained","contentSize":"1240px"}} -->
<section class="wp-block-group is-layout-constrained sr-section"><!-- wp:group {"className":"","layout":{"type":"grid","minimumColumnWidth":"280px"}} -->
...
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-card-link" style="margin-top:16px"><a href="/casi-studio/arredamenti-colombo/">Leggi il caso →</a></p>
<!-- /wp:html -->
</div>
<!-- /wp:group -->
...
<!-- /wp:group -->
<!-- wp:paragraph {"className":"sr-mono"} -->
<p class="sr-mono" style="margin-top:40px;font-size:12px;color:var(--sr-grigio)">Punteggi Google PageSpeed su mobile — report disponibili su richiesta</p>
<!-- /wp:paragraph -->
</section>
<!-- /wp:group -->

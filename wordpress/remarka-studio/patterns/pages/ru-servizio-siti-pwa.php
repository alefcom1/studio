...
<p class="has-base-font-size" style="margin-top:16px;font-size:16px">Каталог открывается мгновенно и доступен даже офлайн в шоуруме: +41% заявок на расчёт стоимости за полгода.</p>
<!-- /wp:paragraph -->
<!-- wp:html -->
...
<p class="has-grigio-color has-text-color has-base-font-size" style="margin-top:14px;max-width:60ch">Цена фиксируется в смете, сдача за 5–8 недель. Электронный счёт-фактура, оплата тремя платежами.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->

...
<p class="has-grigio-color has-text-color has-medium-font-size" style="max-width:100%">Оцениваем, сколько вашему бизнесу может принести перевод сайта на английский или немецкий.</p>
<!-- /wp:paragraph -->
</section>
<!-- /wp:group -->
...
<p class="sr-eyebrow">Скоро</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">Этот инструмент в разработке. А пока запросите бесплатный анализ: ответим в течение одного рабочего дня.</p>
<!-- /wp:paragraph -->
<!-- wp:buttons {"style":{"spacing":{"blockGap":"14px","margin":{"top":"20px"}}}} -->
<div class="wp-block-buttons" style="margin-top:20px"><!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/ru/#contatti">Запросить бесплатный анализ</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>

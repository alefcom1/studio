 ...
 * Slug: remarka-studio/servizio-e-commerce
...
<p class="sr-eyebrow">Servizio / E-commerce</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(38px, 4.6vw, 64px)"}}} -->
<h1 class="wp-block-heading" style="font-size:clamp(38px, 4.6vw, 64px)">Il negozio online che non perde clienti nel checkout<span class="sr-accent-dot">.</span></h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="max-width:640px;margin-top:24px">Realizzazione siti e-commerce con catalogo veloce, checkout in un passaggio e fatturazione elettronica integrata: pensata per chi vende, non solo per chi naviga.</p>
<!-- /wp:paragraph -->
...
<div class="sr-stat" style="max-width:260px"><span class="sr-stat__num" style="color:var(--sr-oltremare)">1,4 s</span><p style="margin-top:16px;font-size:15.5px;color:var(--sr-grigio)">Caricamento medio (LCP) degli e-commerce consegnati nel 2025.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Realizzazione siti e-commerce per chi vende sul serio, non solo espone<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"62%"} -->
<div class="wp-block-column" style="flex-basis:62%"><!-- wp:html -->
<div class="sr-list-rows"><div><span class="sr-mono">a</span><span>Attività che vendono online ma perdono clienti proprio nel checkout.</span></div><div><span class="sr-mono">b</span><span>Negozi fisici pronti ad aprire un canale e-commerce senza improvvisare.</span></div><div><span class="sr-mono">c</span><span>Chi ha bisogno di fatturazione elettronica automatica, non di un plugin da rincorrere.</span></div></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:html -->
<div class="sr-teaser-stats" style="display:flex;flex-wrap:wrap;gap:16px 28px;margin-top:20px"><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">+450%</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">prenotazioni dopo il lancio</p></div><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">18</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">prenotazioni in una stagione, dal sito</p></div></div>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-mono" style="font-size:11px;letter-spacing:0.06em;color:var(--sr-grigio);margin-top:16px">PROGETTO DEL GRUPPO REMARKA — VERIFICABILE SU UKRINITSY.RU</p>
<!-- /wp:html -->
<!-- wp:html -->
...
<p class="has-grigio-color has-text-color has-base-font-size" style="margin-top:14px;max-width:60ch">Prezzo chiuso nel preventivo, consegna in 6 settimane. Fattura elettronica, pagamento in tre tranche.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
...
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Gestite anche la fatturazione elettronica?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Sì, ogni ordine genera automaticamente una fattura elettronica conforme SDI.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Posso vendere anche all’estero?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Sì, il catalogo supporta più lingue e più valute su richiesta.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Il dominio e i dati dei clienti restano nostri?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Sempre. Dominio, database ordini e codice sono intestati a voi dal primo giorno.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:group -->
</section>

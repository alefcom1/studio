...
<!-- /wp:group -->
<!-- wp:html -->
<div style="margin-top:24px;display:flex;flex-direction:column;gap:8px;align-items:flex-start"><p class="sr-card-link" style="margin-top:12px"><a href="/en/services/technical-seo/">We’ll prepare it for you: it’s part of our technical SEO service →</a></p><p class="sr-card-link" style="margin-top:12px"><a href="/en/tools/eeat-signals/">Also measure your site’s E-E-A-T trust signals →</a></p></div>
<!-- /wp:html -->
</section>
<!-- /wp:group -->

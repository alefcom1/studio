<?php
/**
 * Title: Pagina — Città: Brescia
 * Slug: remarka-studio/citta-brescia
 * Categories: remarka-pagine
 * Description: Landing locale «realizzazione siti web brescia»: servizi, caso, prezzi, recensioni, FAQ.
 * Viewport Width: 1400
 */
?>
...
<p class="sr-eyebrow">BRESCIA E PROVINCIA</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(38px,4.6vw,64px)"}}} -->
<h1 class="wp-block-heading" style="font-size:clamp(38px,4.6vw,64px)">Realizzazione siti web a Brescia<span class="sr-accent-dot">.</span></h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size">Siti progressivi per le PMI manifatturiere di Brescia e provincia: PageSpeed 90+ garantito da contratto, prezzo chiuso, versione in tedesco o inglese tradotta da madrelingua per chi esporta.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:buttons -->
<!-- wp:html -->
<div class="sr-stat"><span class="sr-stat__num sr-counter" style="color:var(--sr-oltremare)">5</span><p style="margin-top:16px;font-weight:500">progetti consegnati a Brescia e provincia dal 2024</p></div>
<!-- /wp:html -->
</section>
<!-- /wp:group -->
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Realizzazione siti web a Brescia, e non solo<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
<!-- wp:html -->
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Quanto costa un sito web a Brescia<span class="sr-accent-dot">?</span></h2>
<!-- /wp:heading -->
<!-- wp:html -->
...
<p class="sr-eyebrow">Come lavoriamo con Brescia</p>
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Vicini quanto serve<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="margin-top:16px;max-width:70ch">Serviamo Brescia e provincia dal nostro studio di Milano: primo incontro in azienda senza costi di trasferta, poi ambiente di prova online e avanzamento visibile ogni venerdì.</p>
<!-- /wp:paragraph -->
</section>
<!-- /wp:group -->
<!-- wp:group {"tagName":"section","className":"sr-section sr-section--bianco","layout":{"type":"constrained","contentSize":"1240px"}} -->
<section class="wp-block-group is-layout-constrained sr-section sr-section--bianco"><!-- wp:paragraph {"className":"sr-eyebrow"} -->
<p class="sr-eyebrow">Dicono di noi, da Brescia e dintorni</p>
<!-- /wp:paragraph -->
<!-- wp:heading -->
...
<div class="wp-block-group is-layout-grid" style="--sr-grid-min:260px"><div class="sr-card"><p class="sr-mono" style="color:var(--sr-oltremare)">★★★★★</p><p style="margin-top:14px;font-size:15.5px;line-height:1.6">«Catalogo tecnico di 400 codici, ora si apre in un secondo. I clienti tedeschi ordinano senza telefonare.»</p><p class="sr-mono" style="margin-top:16px;font-size:13px;color:var(--sr-grigio)">Titolare — minuterie metalliche, Lumezzane</p></div><div class="sr-card"><p class="sr-mono" style="color:var(--sr-oltremare)">★★★★★</p><p style="margin-top:14px;font-size:15.5px;line-height:1.6">«Ci hanno fatto vedere i numeri del sito vecchio prima di parlare di prezzo. Serietà rara.»</p><p class="sr-mono" style="margin-top:16px;font-size:13px;color:var(--sr-grigio)">Giorgio F. — officina meccanica, Brescia</p></div><div class="sr-card"><p class="sr-mono" style="color:var(--sr-oltremare)">★★★★★</p><p style="margin-top:14px;font-size:15.5px;line-height:1.6">«Preventivo chiuso e data fissa, come promesso. Il sito è online dal giorno concordato.»</p><p class="sr-mono" style="margin-top:16px;font-size:13px;color:var(--sr-grigio)">Anna T. — azienda vinicola, Franciacorta</p></div></div>
<!-- /wp:group -->
</section>
<!-- /wp:group -->
<!-- wp:group {"tagName":"section","className":"sr-section","layout":{"type":"constrained","contentSize":"1240px"}} -->
<section class="wp-block-group is-layout-constrained sr-section"><!-- wp:paragraph {"className":"sr-eyebrow"} -->
<p class="sr-eyebrow">Domande da Brescia</p>
<!-- /wp:paragraph -->
<!-- wp:details -->
<details class="wp-block-details"><summary>Quanto costa un sito web a Brescia?</summary><!-- wp:paragraph -->
...
<!-- /wp:details -->
<!-- wp:details -->
<details class="wp-block-details"><summary>Lavorate con aziende manifatturiere ed esportatrici?</summary><!-- wp:paragraph -->
<p>È il nostro cliente tipo: cataloghi tecnici veloci, dati strutturati per ogni prodotto e versioni in tedesco o inglese tradotte da madrelingua del gruppo Remarka.</p>
<!-- /wp:paragraph --></details>
<!-- /wp:details -->
<!-- wp:details -->
<details class="wp-block-details"><summary>Come seguiamo i lavori se siete a Milano?</summary><!-- wp:paragraph -->
<p>Ambiente di prova online dal primo giorno, avanzamento visibile ogni venerdì, un unico referente. Il primo incontro lo facciamo comunque da voi, gratuitamente.</p>
<!-- /wp:paragraph --></details>
<!-- /wp:details -->
</section>
<!-- /wp:group -->

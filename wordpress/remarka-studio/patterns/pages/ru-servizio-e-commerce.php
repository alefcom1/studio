 ...
 * Slug: remarka-studio/ru-servizio-e-commerce
...
<p class="sr-eyebrow">Услуга / Интернет-магазины</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(38px, 4.6vw, 64px)"}}} -->
<h1 class="wp-block-heading" style="font-size:clamp(38px, 4.6vw, 64px)">Интернет-магазин, который не теряет клиентов на оформлении заказа<span class="sr-accent-dot">.</span></h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="max-width:640px;margin-top:24px">Быстрый каталог, оформление заказа в один шаг, встроенные электронные счета-фактуры: для тех, кто продаёт, а не просто показывает товар.</p>
<!-- /wp:paragraph -->
...
<div class="sr-stat" style="max-width:260px"><span class="sr-stat__num" style="color:var(--sr-oltremare)">1,4 с</span><p style="margin-top:16px;font-size:15.5px;color:var(--sr-grigio)">Средняя загрузка (LCP) интернет-магазинов, сданных в 2025 году.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Для тех, кто продаёт всерьёз, а не просто выставляет витрину<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"62%"} -->
<div class="wp-block-column" style="flex-basis:62%"><!-- wp:html -->
<div class="sr-list-rows"><div><span class="sr-mono">a</span><span>Компании, которые продают онлайн, но теряют клиентов именно на оформлении заказа.</span></div><div><span class="sr-mono">b</span><span>Офлайн-магазины, готовые открыть онлайн-канал без импровизаций.</span></div><div><span class="sr-mono">c</span><span>Те, кому нужны автоматические электронные счета-фактуры, а не плагин, за которым придётся следить.</span></div></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:html -->
<!-- wp:html -->
[sr_shot file="ukrinitsy-mobile-390.webp" alt="Сайт-визитка гостевого дома ukrinitsy.ru, мобильная версия" caption="ukrinitsy.ru — первый экран, мобильный" mobile="1"]
<!-- /wp:html -->
</div>
<!-- /wp:group -->
</div>
...
<p class="has-base-font-size" style="margin-top:16px;font-size:16px">Сайт-визитка для небольшого гостевого дома: фото, контакты и бронирование под рукой. После запуска бронирований стало на 450% больше.</p>
<!-- /wp:paragraph -->
<!-- wp:html -->
<div class="sr-teaser-stats" style="display:flex;flex-wrap:wrap;gap:16px 28px;margin-top:20px"><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">+450%</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">бронирований после запуска</p></div><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">18</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">броней за сезон, с сайта</p></div></div>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-mono" style="font-size:11px;letter-spacing:0.06em;color:var(--sr-grigio);margin-top:16px">ПРОЕКТ ГРУППЫ REMARKA — МОЖНО ПРОВЕРИТЬ НА UKRINITSY.RU</p>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-card-link" style="margin-top:16px"><a href="/ru/kejsy/#ukrinitsy">Читать полный кейс →</a></p>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:html -->
<!-- wp:html -->
<div class="sr-stat__num" style="font-size:clamp(36px,4vw,52px)">{{listino}}660 000–1 230 000 ₽ · € 7 500–14 000{{/listino}}{{lancio}}<s class="sr-lancio-listino">660 000–1 230 000 ₽</s> <span class="sr-lancio-price">330 000–615 000 ₽ · € 3 750–7 000</span>{{/lancio}}</div>
<!-- /wp:html -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"base"} -->
<p class="has-grigio-color has-text-color has-base-font-size" style="margin-top:14px;max-width:60ch">Цена фиксируется в смете, сдача за 6 недель. Электронный счёт-фактура, оплата тремя платежами.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
...
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Вы берёте на себя и электронные счета-фактуры?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Да, по каждому заказу автоматически формируется электронный счёт-фактура через SDI, в соответствии с требованиями.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Могу ли я продавать и за рубеж?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Да, каталог поддерживает несколько языков, а по запросу — и несколько валют.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Домен и данные клиентов останутся нашими?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Всегда. Домен, база заказов и код оформлены на вас с первого дня.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:group -->
</section>

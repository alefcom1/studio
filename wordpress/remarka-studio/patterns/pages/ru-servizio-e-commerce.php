...
<p class="has-base-font-size" style="margin-top:16px;font-size:16px">Каталог вин, переведённый на три языка, и оформление заказа в один шаг: прямые продажи с сайта выросли на 63% за год.</p>
<!-- /wp:paragraph -->
<!-- wp:html -->
<p class="sr-card-link" style="margin-top:16px"><a href="/ru/kejsy/cantina-serralta/">Читать полный кейс →</a></p>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"45%"} -->
...
<!-- /wp:html -->
<!-- wp:html -->
<div class="sr-barra-row"><span class="sr-eyebrow" style="margin:0">До</span><span class="sr-barra-row__val">41</span></div><div class="sr-barra" style="height:8px" data-sr-target="41%" data-sr-delay="0" role="img" aria-label="До: 41 из 100"><div class="sr-barra__fill sr-barra__fill--muted"></div></div>
<!-- /wp:html -->
<!-- wp:html -->
<div class="sr-barra-row"><span class="sr-eyebrow" style="margin:0">После</span><span class="sr-barra-row__val sr-barra-row__val--verde">97</span></div><div class="sr-barra" style="height:8px" data-sr-target="97%" data-sr-delay="150" role="img" aria-label="После: 97 из 100"><div class="sr-barra__fill"></div></div>
<!-- /wp:html -->
<!-- wp:html -->

...
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-card-link" style="margin-top:4px"><a href="/strumenti/suona-madrelingua/">Il vostro sito è pronto per i clienti esteri? Sentite come suona in un’altra lingua, gratis →</a></p>
<!-- /wp:html -->
</section>
<!-- /wp:group -->
<!-- wp:group {"tagName":"section","className":"sr-section sr-section--bianco","layout":{"type":"constrained","contentSize":"1240px"}} -->
...
<p class="has-grigio-color has-text-color has-base-font-size">Niente «team locale» inventato, niente indirizzo di comodo: un unico referente, la stessa data in contratto e lo stesso prezzo chiuso, dal centro storico a Mestre a Marghera.</p>
<!-- /wp:paragraph -->
<!-- wp:html -->

...
<!-- /wp:html -->
<!-- wp:html -->
<div class="sr-barra-row"><span class="sr-eyebrow" style="margin:0">Prima</span><span class="sr-barra-row__val">34</span></div><div class="sr-barra" style="height:10px" data-sr-target="34%" data-sr-delay="0" role="img" aria-label="Prima: 34 su 100"><div class="sr-barra__fill sr-barra__fill--muted"></div></div>
<!-- /wp:html -->
<!-- wp:html -->

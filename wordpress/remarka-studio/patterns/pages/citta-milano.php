...
<p class="sr-eyebrow">Web agency Milano</p>
<!-- /wp:paragraph -->
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Web agency Milano: sei servizi, una garanzia<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
<!-- wp:html -->
...
<p class="sr-eyebrow">La stessa ingegneria, per un cliente italiano</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":3} -->

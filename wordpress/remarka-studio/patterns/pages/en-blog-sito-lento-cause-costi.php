 ...
 * Slug: remarka-studio/en-blog-sito-lento-cause-costi
...
<!-- /wp:heading -->
<!-- wp:html -->
<figure class="wp-block-image size-large" style="margin:8px 0 8px"><img src="/wp-content/themes/remarka-studio/assets/img/blog/sito-lento-cover.svg" alt="A slow website: the seven real causes and what it costs to fix them" width="1200" height="630" loading="lazy" style="max-width:100%;height:auto;display:block;border:1px solid var(--sr-bordo)"/></figure>
<!-- /wp:html -->
</section>
<!-- /wp:group -->
<!-- wp:group {"tagName":"section","className":"sr-section","layout":{"type":"constrained","contentSize":"1440px"}} -->
<section class="wp-block-group is-layout-constrained sr-section"><!-- wp:paragraph {"fontSize":"base"} -->
<p class="has-base-font-size" style="font-size:18px;line-height:1.75;max-width:75ch">Four seconds of load time on mobile sounds like a technical detail. It isn’t: it’s the reason your campaigns bring visits that leave before reading the first line. After dozens of audits on Italian SMB websites, the causes of slowness are almost always the same seven — and not all of them are expensive to fix. Here they are, in order of frequency, with the order of magnitude of the fix.</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"style":{"typography":{"fontSize":"clamp(24px,2.6vw,32px)"}}} -->
<h2 class="wp-block-heading" style="font-size:clamp(24px,2.6vw,32px)">The seven causes, most frequent first<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
<!-- wp:html -->
...
<!-- /wp:html -->
<!-- wp:html -->
<figure class="wp-block-image size-large" style="margin:36px 0 8px"><img src="/wp-content/themes/remarka-studio/assets/img/blog/sito-lento-7cause.svg" alt="The seven causes of a slow website, from the most frequent, with a low, medium or high fix cost" width="1200" height="600" loading="lazy" style="max-width:100%;height:auto;display:block;border:1px solid var(--sr-bordo)"/><figcaption class="sr-mono" style="margin-top:12px;font-size:12.5px;letter-spacing:0.04em;color:var(--sr-grigio);max-width:75ch">The seven most frequent causes of a slow website and the cost to fix them: nearly all are low-cost, only an old technical base needs deeper work. Source: dozens of audits on Italian SMB websites (Studio Remarka).</figcaption></figure>
<!-- /wp:html -->
<!-- wp:heading {"style":{"typography":{"fontSize":"clamp(24px,2.6vw,32px)"}}} -->

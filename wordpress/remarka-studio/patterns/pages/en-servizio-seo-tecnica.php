...
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-card-link" style="margin-top:12px"><a href="/en/tools/seo-audit/">Analyze the on-page SEO of your page →</a></p><p class="sr-card-link" style="margin-top:12px"><a href="/en/tools/ai-readiness/">Check if your website is ready for AI →</a></p>
<!-- /wp:html -->
<!-- wp:html -->

...
<div class="sr-stat" style="max-width:260px"><span class="sr-stat__num" style="color:var(--sr-oltremare)">90+</span><p style="margin-top:16px;font-size:15.5px;color:var(--sr-grigio)">Punteggio Core Web Vitals garantito da contratto.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<div class="sr-list-rows"><div><span class="sr-mono">a</span><span>Siti con buoni contenuti ma scarsa visibilità su Google.</span></div><div><span class="sr-mono">b</span><span>Chi ha già investito in copywriting senza vedere risultati in classifica.</span></div><div><span class="sr-mono">c</span><span>Attività che competono in mercati locali affollati, dove ogni posizione conta.</span></div></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:html -->
<div class="sr-teaser-stats" style="display:flex;flex-wrap:wrap;gap:16px 28px;margin-top:20px"><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">№ 1</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">su Yandex per «traduzione notarile»</p></div><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">9–10 mila/mese</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">visitatori, in vetta da oltre 1.000 giorni</p></div></div>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-mono" style="font-size:11px;letter-spacing:0.06em;color:var(--sr-grigio);margin-top:16px">PROGETTO DEL GRUPPO REMARKA — VERIFICABILE SU ПЕРЕ.РФ</p>
<!-- /wp:html -->
<!-- wp:html -->

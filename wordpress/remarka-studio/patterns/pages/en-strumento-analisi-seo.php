 ...
 * Slug: remarka-studio/en-strumento-analisi-seo
...
<p class="sr-eyebrow">Free tool /02</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(34px,4vw,52px)"}}} -->
<h1 class="wp-block-heading" style="font-size:clamp(34px,4vw,52px)">On-page SEO analysis: what Google sees on your page<span class="sr-accent-dot">.</span></h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="max-width:100%">Title, content structure and missing data on the page that matters most to your business. Your Google SEO score and concrete fixes, explained in plain English. No sign-up.</p>
<!-- /wp:paragraph -->
</section>
<!-- /wp:group -->
...
<div class="sr-tool-widget sr-card" data-sr-tool="seo" data-sr-locale="en"
     data-label-suffix=" — on-page SEO"
     data-verdict-good="Great: the on-page SEO basics are in place."
     data-verdict-mid="Average SEO: there are concrete fixes to make."
     data-verdict-poor="Weak on-page SEO: it’s the priority to fix."
     data-audits-empty="No significant SEO issues found."
     data-err="We couldn’t complete the analysis. Please try again in a few minutes.">
  <form data-sr-tool-form>
    <div class="sr-tool-row"><input type="text" placeholder="www.tuosito.it" class="sr-text-input" required /><button type="submit" class="wp-block-button__link" style="padding:17px 30px">Analyze the SEO</button></div>
  </form>
  <p class="sr-tool-pending sr-mono" data-sr-tool-pending hidden>Google analysis in progress<span class="sr-blink">…</span></p>
...
<div class="wp-block-group is-layout-grid" style="--sr-grid-min:240px"><div class="sr-step"><p class="sr-mono" style="color:var(--sr-oltremare)">01</p><p style="font-weight:500;margin-top:8px">Pick the right page</p><p style="font-size:14.5px;color:var(--sr-grigio);margin-top:8px">Not necessarily the homepage: the page that needs to rank — a service, a product page, an article.</p></div><div class="sr-step"><p class="sr-mono" style="color:var(--sr-oltremare)">02</p><p style="font-weight:500;margin-top:8px">Google analyzes it</p><p style="font-size:14.5px;color:var(--sr-grigio);margin-top:8px">We use Lighthouse’s SEO category via the PageSpeed API: titles, meta descriptions, tags, links and structure.</p></div><div class="sr-step"><p class="sr-mono" style="color:var(--sr-oltremare)">03</p><p style="font-weight:500;margin-top:8px">See what to fix</p><p style="font-size:14.5px;color:var(--sr-grigio);margin-top:8px">A 0–100 score and the list of on-page elements to fix, in priority order.</p></div></div>
<!-- /wp:group -->
</section>
<!-- /wp:group -->
<!-- wp:group {"tagName":"section","className":"sr-section","layout":{"type":"constrained","contentSize":"1240px"}} -->
...
<!-- /wp:paragraph -->
<!-- wp:details -->
<details class="wp-block-details"><summary>Will this analysis get my site ranking?</summary><!-- wp:paragraph -->
<p>Not on its own: it checks the technical on-page basics (titles, structure, data). Rankings also depend on content and authority, which take time to build.</p>
<!-- /wp:paragraph --></details>
<!-- /wp:details -->
<!-- wp:details -->
<details class="wp-block-details"><summary>How is this different from content analysis?</summary><!-- wp:paragraph -->
<p>Here we check the technical side of the page — the part Google reads. Copy quality is a separate job, one we do with partner copywriters.</p>
<!-- /wp:paragraph --></details>
<!-- /wp:details -->
<!-- wp:details -->
<details class="wp-block-details"><summary>Does it analyze the whole website?</summary><!-- wp:paragraph -->
...
<!-- /wp:group -->
<!-- wp:html -->
<div style="margin-top:24px;display:flex;flex-direction:column;gap:8px;align-items:flex-start"><p class="sr-card-link" style="margin-top:12px"><a href="/en/services/technical-seo/">Want us to fix it for you? See our technical SEO service →</a></p><p class="sr-card-link" style="margin-top:12px"><a href="/en/blog/core-web-vitals-2026/">Read more: Core Web Vitals in 2026 →</a></p><p class="sr-card-link" style="margin-top:12px"><a href="/en/tools/eeat-signals/">Also check your E-E-A-T trust signals →</a></p></div>
<!-- /wp:html -->
</section>
<!-- /wp:group -->
...
<h2 class="wp-block-heading">Want us to handle your technical SEO<span class="sr-accent-dot">?</span></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="margin-top:12px">A full audit, structured data and Core Web Vitals sorted: PageSpeed 90+ guaranteed by contract.</p>
<!-- /wp:paragraph -->

<?php
/**
 * Title: Pagina — Servizio: Siti multilingue
 * Slug: remarka-studio/ru-servizio-siti-multilingue
 * Categories: remarka-pagine
 * Description: Pagina completa del servizio Siti multilingue: hero, per chi è, cosa include, mini caso, prezzo, FAQ, CTA.
 * Viewport Width: 1400
 */
?>
...
<p class="sr-eyebrow">Услуга / Многоязычные сайты</p>
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"clamp(38px, 4.6vw, 64px)"}}} -->
<h1 class="wp-block-heading" style="font-size:clamp(38px, 4.6vw, 64px)">Четыре языка в переводе носителей, а не плагина<span class="sr-accent-dot">.</span></h1>
<!-- /wp:heading -->
<!-- wp:paragraph {"textColor":"grigio","fontSize":"medium"} -->
<p class="has-grigio-color has-text-color has-medium-font-size" style="max-width:640px;margin-top:24px">Этим ремеслом группа Remarka живёт с 2001 года: профессиональный перевод, не машинный, с корректной многоязычной SEO с первого дня.</p>
<!-- /wp:paragraph -->
...
<div class="sr-stat" style="max-width:260px"><span class="sr-stat__num" style="color:var(--sr-oltremare)">4</span><p style="margin-top:16px;font-size:15.5px;color:var(--sr-grigio)">Языка с переводчиками-носителями: итальянский, английский, немецкий, французский.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Для тех, кто продаёт за границу, а не только по-итальянски<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"62%"} -->
<div class="wp-block-column" style="flex-basis:62%"><!-- wp:html -->
<div class="sr-list-rows"><div><span class="sr-mono">a</span><span>Компании, которые экспортируют или принимают иностранных клиентов.</span></div><div><span class="sr-mono">b</span><span>Туристический бизнес с международными гостями.</span></div><div><span class="sr-mono">c</span><span>Те, кто до сих пор обходился машинным переводом сомнительного качества — и клиенты это заметили.</span></div></div>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:html -->
<!-- wp:html -->
[sr_shot file="tester-exam-1440.webp" alt="Платформа тестирования и оценки переводчиков группы Remarka" caption="Платформа теста переводчиков — экран оценки" mobile="0"]
<!-- /wp:html -->
</div>
<!-- /wp:group -->
</div>
...
<h2 class="wp-block-heading" style="font-size:clamp(26px,3vw,34px)">Система тестирования переводчиков<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
<!-- wp:html -->
<p class="sr-mono" style="font-size:12.5px;color:var(--sr-grigio);margin-top:6px">moscowtrans.ru/test-perevodchika</p>
<!-- /wp:html -->
<!-- wp:paragraph {"fontSize":"base"} -->
<p class="has-base-font-size" style="margin-top:16px;font-size:16px">Платформа тестирования и оценки переводчиков — та самая система, что стоит за гарантией «редакторы-носители по профилю» на каждом многоязычном сайте, который мы сдаём.</p>
<!-- /wp:paragraph -->
<!-- wp:html -->
<div class="sr-teaser-stats" style="display:flex;flex-wrap:wrap;gap:16px 28px;margin-top:20px"><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">400+</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">переводчиков протестировано</p></div><div><span class="sr-stat__num" style="font-size:clamp(22px,2.4vw,28px);color:var(--sr-oltremare)">8%</span><p style="margin-top:4px;font-size:13px;color:var(--sr-grigio)">проходят отбор</p></div></div>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-mono" style="font-size:11px;letter-spacing:0.06em;color:var(--sr-grigio);margin-top:16px">ПРОЕКТ ГРУППЫ REMARKA — ИСПОЛЬЗУЕТСЯ ВО ВСЕХ ПРОЕКТАХ</p>
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-card-link" style="margin-top:16px"><a href="/ru/kejsy/#test-traduttori">Читать полный кейс →</a></p>
<!-- /wp:html -->
</div>
<!-- /wp:column -->
</div>
...
<!-- /wp:html -->
<!-- wp:html -->
<p class="sr-card-link" style="margin-top:12px"><a href="/ru/instrumenty/roi-lokalizacii/">Рассчитать ROI локализации →</a></p><p class="sr-card-link" style="margin-top:12px"><a href="/ru/instrumenty/zvuchit-kak-u-nositelya/">Проверьте, звучат ли ваши тексты как у носителя →</a></p>
<!-- /wp:html -->
<!-- wp:html -->
...
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Переводы машинные?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Нет, их выполняют переводчики-носители из группы Remarka, а не автоматические плагины.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">Можно добавить язык позже?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Да, многоязычная структура рассчитана на новые языки без переделки сайта.</p></div>
<!-- /wp:html -->
<!-- wp:html -->
<div style="border-top:1px solid var(--sr-inchiostro);padding-top:20px"><h3 class="wp-block-heading" style="font-size:18px">SEO работает на всех языках?</h3><p style="margin-top:10px;font-size:15px;color:var(--sr-grigio)">Да, у каждого языка свои URL и теги hreflang, чтобы Google индексировал его корректно.</p></div>
<!-- /wp:html -->
</div>
<!-- /wp:group -->
</section>

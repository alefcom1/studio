...
/**
 * Title: Three numbers
 * Slug: remarka-studio/en-tre-numeri
 * Categories: remarka
 * Description: Three stat blocks with a large animated number, caption and description.
 * Viewport Width: 1400
 */
?>
...
<!-- wp:paragraph {"style":{"typography":{"fontWeight":"500"},"spacing":{"margin":{"top":"16px"}}}} -->
<p style="margin-top:16px;font-weight:500">Native languages in every project</p>
<!-- /wp:paragraph -->

<?php
/**
 * Title: Контакты — WhatsApp и форма
 * Slug: remarka-studio/ru-contatti
 * Categories: remarka
 * Description: Шапка, канал WhatsApp, часы работы и область под форму (плагин форм).
 * Viewport Width: 1400
 */
?>
...
<p class="sr-eyebrow">Контакты</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading">Обсудим ваш проект<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://api.whatsapp.com/send?phone=79182630013&amp;text=" target="_blank" rel="noopener noreferrer">WhatsApp — +7 918 263 00 13</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-grigio-color has-text-color has-small-font-size">Отвечаем в течение рабочего дня. Данные остаются в ЕС — согласно политике конфиденциальности.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></section>

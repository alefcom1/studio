...
<!-- wp:heading -->
<h2 class="wp-block-heading">Ogni lingua ha il suo redattore madrelingua<span class="sr-accent-dot">.</span></h2>
<!-- /wp:heading -->
...
<div class="sr-langs__group">
<p class="sr-langs__market">Nord America</p>
<ul class="sr-langs__codes"><li class="sr-langs__code">EN-US</li></ul>
</div>
<div class="sr-langs__group">
<p class="sr-langs__market">CSI e Caucaso</p>
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/servizi/siti-multilingue/">Scopri i siti multilingue →</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></section>
<!-- /wp:group -->

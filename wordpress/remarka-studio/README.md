...
3. Внешний вид → Настроить:
   ...
   - меню: Servizi · Casi studio · Prezzi · Strumenti · Blog · Preventivo in 24 ore
     (последний пункт со словом «Preventivo» в названии сам становится
     синей кнопкой — класс вешается автоматически, ничего вручную ставить не нужно);
   - раздел **Remarka — Contatti** → указать номер WhatsApp Business
     (используется в футере для кнопки-пузыря и в паттерне «Contatti»).
